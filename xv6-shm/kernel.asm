...
80100049:	e8 ef 4a 00 00       	call   80104b3d <initlock>
...
801000bd:	e8 9c 4a 00 00       	call   80104b5e <acquire>
...
80100104:	e8 b7 4a 00 00       	call   80104bc0 <release>
        return b;
...
8010011f:	e8 67 47 00 00       	call   8010488b <sleep>
      goto loop;
...
8010017c:	e8 3f 4a 00 00       	call   80104bc0 <release>
      return b;
...
80100198:	c7 04 24 a3 83 10 80 	movl   $0x801083a3,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 b4 83 10 80 	movl   $0x801083b4,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 bb 83 10 80 	movl   $0x801083bb,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
8010023c:	e8 1d 49 00 00       	call   80104b5e <acquire>
...
8010029d:	e8 c5 46 00 00       	call   80104967 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
801002a9:	e8 12 49 00 00       	call   80104bc0 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 9e 47 00 00       	call   80104b5e <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 c2 83 10 80 	movl   $0x801083c2,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec cb 83 10 80 	movl   $0x801083cb,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 88 46 00 00       	call   80104bc0 <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 d2 83 10 80 	movl   $0x801083d2,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 e1 83 10 80 	movl   $0x801083e1,(%esp)
...
8010058f:	e8 7b 46 00 00       	call   80104c0f <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 e3 83 10 80 	movl   $0x801083e3,(%esp)
...
801006b2:	e8 ca 47 00 00       	call   80104e81 <memmove>
    pos -= 80;
...
801006e1:	e8 cc 46 00 00       	call   80104db2 <memset>
  }
...
80100776:	e8 1e 60 00 00       	call   80106799 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 12 60 00 00       	call   80106799 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 06 60 00 00       	call   80106799 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 f9 5f 00 00       	call   80106799 <uartputc>
  cgaputc(c);
...
801007ba:	e8 9f 43 00 00       	call   80104b5e <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 82 00 00 00       	jmp    8010086c <consoleintr+0xbf>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 1e 42 00 00       	call   80104a0d <procdump>
      break;
...
801008f3:	e8 6f 40 00 00       	call   80104967 <wakeup>
        }
      }
      break;
...
80100914:	e8 a7 42 00 00       	call   80104bc0 <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 20 42 00 00       	call   80104b5e <acquire>
  while(n > 0){
...
80100959:	e8 62 42 00 00       	call   80104bc0 <release>
        ilock(ip);
...
80100982:	e8 04 3f 00 00       	call   8010488b <sleep>
...
801009fe:	e8 bd 41 00 00       	call   80104bc0 <release>
  ilock(ip);
...
80100a32:	e8 27 41 00 00       	call   80104b5e <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 4f 41 00 00       	call   80104bc0 <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 e7 83 10 	movl   $0x801083e7,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100a96:	e8 a2 40 00 00       	call   80104b3d <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 ef 83 10 	movl   $0x801083ef,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 a0 dd 10 80 	movl   $0x8010dda0,(%esp)
80100aaa:	e8 8e 40 00 00       	call   80104b3d <initlock>
...
80100ad4:	e8 87 2f 00 00       	call   80103a60 <picenable>
...
80100b64:	e9 64 03 00 00       	jmp    80100ecd <exec+0x3de>
  ...
  if((pgdir = setupkvm()) == 0)
80100b69:	e8 bf 6f 00 00       	call   80107b2d <setupkvm>
...
80100c0a:	e8 ec 72 00 00       	call   80107efb <allocuvm>
...
80100c48:	e8 c3 71 00 00       	call   80107e10 <loaduvm>
...
80100cb1:	e8 45 72 00 00       	call   80107efb <allocuvm>
...
80100cd6:	e8 50 74 00 00       	call   8010812b <clearpteu>
  sp = sz;
...
80100d0c:	e8 0b 43 00 00       	call   8010501c <strlen>
...
80100d35:	e8 e2 42 00 00       	call   8010501c <strlen>
...
80100d65:	e8 86 75 00 00       	call   801082f0 <copyout>
...
80100e0c:	e8 df 74 00 00       	call   801082f0 <copyout>
...
80100e64:	e8 69 41 00 00       	call   80104fd2 <safestrcpy>
...
80100eb6:	e8 63 6d 00 00       	call   80107c1e <switchuvm>
  freevm(oldpgdir);
80100ebb:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ebe:	89 04 24             	mov    %eax,(%esp)
80100ec1:	e8 cb 71 00 00       	call   80108091 <freevm>
  return 0;
...
80100ed9:	e8 b3 71 00 00       	call   80108091 <freevm>
  if(ip)
...
80100efc:	c7 44 24 04 f5 83 10 	movl   $0x801083f5,0x4(%esp)
80100f03:	80 
80100f04:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100f0b:	e8 2d 3c 00 00       	call   80104b3d <initlock>
}
80100f10:	c9                   	leave  
80100f11:	c3                   	ret    
...
80100f1f:	e8 3a 3c 00 00       	call   80104b5e <acquire>
...
80100f48:	e8 73 3c 00 00       	call   80104bc0 <release>
      return f;
...
80100f66:	e8 55 3c 00 00       	call   80104bc0 <release>
  return 0;
...
80100f7f:	e8 da 3b 00 00       	call   80104b5e <acquire>
  if(f->ref < 1)
...
80100f8c:	7f 0c                	jg     80100f9a <filedup+0x28>
    panic("filedup");
80100f8e:	c7 04 24 fc 83 10 80 	movl   $0x801083fc,(%esp)
...
80100fb0:	e8 0b 3c 00 00       	call   80104bc0 <release>
  return f;
...
80100fc7:	e8 92 3b 00 00       	call   80104b5e <acquire>
  if(f->ref < 1)
...
80100fd4:	7f 0c                	jg     80100fe2 <fileclose+0x28>
    panic("fileclose");
80100fd6:	c7 04 24 04 84 10 80 	movl   $0x80108404,(%esp)
...
80101002:	e8 b9 3b 00 00       	call   80104bc0 <release>
...
8010104c:	e8 6f 3b 00 00       	call   80104bc0 <release>
...
8010106a:	e8 a1 2c 00 00       	call   80103d10 <pipeclose>
...
8010111b:	e8 71 2d 00 00       	call   80103e91 <piperead>
...
8010118b:	eb 0c                	jmp    80101199 <fileread+0xba>
  ...
  panic("fileread");
8010118d:	c7 04 24 0e 84 10 80 	movl   $0x8010840e,(%esp)
...
801011d8:	e8 c5 2b 00 00       	call   80103da2 <pipewrite>
...
80101299:	c7 04 24 17 84 10 80 	movl   $0x80108417,(%esp)
...
801012c9:	eb 0c                	jmp    801012d7 <filewrite+0x13c>
  ...
  panic("filewrite");
801012cb:	c7 04 24 27 84 10 80 	movl   $0x80108427,(%esp)
...
80101311:	e8 6b 3b 00 00       	call   80104e81 <memmove>
  brelse(bp);
...
80101357:	e8 56 3a 00 00       	call   80104db2 <memset>
  log_write(bp);
...
801014b4:	c7 04 24 31 84 10 80 	movl   $0x80108431,(%esp)
...
80101546:	c7 04 24 47 84 10 80 	movl   $0x80108447,(%esp)
...
80101596:	c7 44 24 04 5a 84 10 	movl   $0x8010845a,0x4(%esp)
8010159d:	80 
8010159e:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801015a5:	e8 93 35 00 00       	call   80104b3d <initlock>
}
801015aa:	c9                   	leave  
801015ab:	c3                   	ret    
...
80101627:	e8 86 37 00 00       	call   80104db2 <memset>
      dip->type = type;
...
8010167d:	c7 04 24 61 84 10 80 	movl   $0x80108461,(%esp)
...
80101726:	e8 56 37 00 00       	call   80104e81 <memmove>
  log_write(bp);
...
80101750:	e8 09 34 00 00       	call   80104b5e <acquire>
...
8010179a:	e8 21 34 00 00       	call   80104bc0 <release>
      return ip;
...
801017cd:	c7 04 24 73 84 10 80 	movl   $0x80108473,(%esp)
...
8010180b:	e8 b0 33 00 00       	call   80104bc0 <release>
...
80101822:	e8 37 33 00 00       	call   80104b5e <acquire>
  ip->ref++;
...
8010183d:	e8 7e 33 00 00       	call   80104bc0 <release>
  return ip;
...
8010185b:	7f 0c                	jg     80101869 <ilock+0x22>
    panic("ilock");
8010185d:	c7 04 24 83 84 10 80 	movl   $0x80108483,(%esp)
80101864:	e8 d1 ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
80101869:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101870:	e8 e9 32 00 00       	call   80104b5e <acquire>
...
80101885:	e8 01 30 00 00       	call   8010488b <sleep>
...
801018af:	e8 0c 33 00 00       	call   80104bc0 <release>
...
8010195a:	e8 22 35 00 00       	call   80104e81 <memmove>
    brelse(bp);
...
80101985:	75 0c                	jne    80101993 <ilock+0x14c>
      panic("ilock: no type");
80101987:	c7 04 24 89 84 10 80 	movl   $0x80108489,(%esp)
...
801019b6:	7f 0c                	jg     801019c4 <iunlock+0x2f>
    panic("iunlock");
801019b8:	c7 04 24 98 84 10 80 	movl   $0x80108498,(%esp)
801019bf:	e8 76 eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019c4:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801019cb:	e8 8e 31 00 00       	call   80104b5e <acquire>
  ip->flags &= ~I_BUSY;
...
801019e7:	e8 7b 2f 00 00       	call   80104967 <wakeup>
  release(&icache.lock);
801019ec:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801019f3:	e8 c8 31 00 00       	call   80104bc0 <release>
}
801019f8:	c9                   	leave  
801019f9:	c3                   	ret    
...
80101a07:	e8 52 31 00 00       	call   80104b5e <acquire>
...
80101a43:	74 0c                	je     80101a51 <iput+0x57>
      panic("iput busy");
80101a45:	c7 04 24 a0 84 10 80 	movl   $0x801084a0,(%esp)
...
80101a69:	e8 52 31 00 00       	call   80104bc0 <release>
    itrunc(ip);
...
80101a94:	e8 c5 30 00 00       	call   80104b5e <acquire>
    ip->flags = 0;
...
80101aa9:	e8 b9 2e 00 00       	call   80104967 <wakeup>
  }
  ip->ref--;
...
80101ac4:	e8 f7 30 00 00       	call   80104bc0 <release>
}
80101ac9:	c9                   	leave  
80101aca:	c3                   	ret    
...
80101be4:	c7 04 24 aa 84 10 80 	movl   $0x801084aa,(%esp)
...
80101e85:	e8 f7 2f 00 00       	call   80104e81 <memmove>
    brelse(bp);
...
80101fe4:	e8 98 2e 00 00       	call   80104e81 <memmove>
    log_write(bp);
...
80102062:	e8 bd 2e 00 00       	call   80104f24 <strncmp>
}
80102067:	c9                   	leave  
80102068:	c3                   	ret    
...
8010207c:	c7 04 24 bd 84 10 80 	movl   $0x801084bd,(%esp)
...
801020b8:	74 0c                	je     801020c6 <dirlookup+0x5d>
      panic("dirlink read");
801020ba:	c7 04 24 cf 84 10 80 	movl   $0x801084cf,(%esp)
...
8010219d:	74 0c                	je     801021ab <dirlink+0x79>
      panic("dirlink read");
8010219f:	c7 04 24 cf 84 10 80 	movl   $0x801084cf,(%esp)
...
801021e4:	e8 91 2d 00 00       	call   80104f7a <strncpy>
  de.inum = inum;
...
80102214:	74 0c                	je     80102222 <dirlink+0xf0>
    panic("dirlink");
80102216:	c7 04 24 dc 84 10 80 	movl   $0x801084dc,(%esp)
...
8010229b:	e8 e1 2b 00 00       	call   80104e81 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022b6:	e8 c6 2b 00 00       	call   80104e81 <memmove>
    name[len] = 0;
...
80102505:	c7 44 24 04 e4 84 10 	movl   $0x801084e4,0x4(%esp)
8010250c:	80 
8010250d:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80102514:	e8 24 26 00 00       	call   80104b3d <initlock>
  picenable(IRQ_IDE);
80102519:	c7 04 24 0e 00 00 00 	movl   $0xe,(%esp)
80102520:	e8 3b 15 00 00       	call   80103a60 <picenable>
...
801025af:	75 0c                	jne    801025bd <idestart+0x18>
    panic("idestart");
801025b1:	c7 04 24 e8 84 10 80 	movl   $0x801084e8,(%esp)
...
801026d7:	e8 82 24 00 00       	call   80104b5e <acquire>
  if((b = idequeue) == 0){
...
801026f1:	e8 ca 24 00 00       	call   80104bc0 <release>
...
80102764:	e8 fe 21 00 00       	call   80104967 <wakeup>
...
80102786:	e8 35 24 00 00       	call   80104bc0 <release>
}
8010278b:	c9                   	leave  
8010278c:	c3                   	ret    
...
8010279f:	c7 04 24 f1 84 10 80 	movl   $0x801084f1,(%esp)
...
801027b8:	c7 04 24 05 85 10 80 	movl   $0x80108505,(%esp)
...
80102845:	e8 41 20 00 00       	call   8010488b <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
8010285e:	e8 5d 23 00 00       	call   80104bc0 <release>
}
80102863:	c9                   	leave  
80102864:	c3                   	ret    
...
801028ec:	c7 04 24 38 85 10 80 	movl   $0x80108538,(%esp)
...
801029a6:	c7 44 24 04 6a 85 10 	movl   $0x8010856a,0x4(%esp)
801029ad:	80 
801029ae:	c7 04 24 40 f8 10 80 	movl   $0x8010f840,(%esp)
801029b5:	e8 83 21 00 00       	call   80104b3d <initlock>
  kmem.use_lock = 0;
...
80102a47:	81 7d 08 1c 2b 11 80 	cmpl   $0x80112b1c,0x8(%ebp)
...
80102a60:	76 0c                	jbe    80102a6e <kfree+0x39>
    panic("kfree");
80102a62:	c7 04 24 6f 85 10 80 	movl   $0x8010856f,(%esp)
...
80102a84:	e8 29 23 00 00       	call   80104db2 <memset>
...
80102a99:	e8 c0 20 00 00       	call   80104b5e <acquire>
  r = (struct run*)v;
...
80102ac7:	e8 f4 20 00 00       	call   80104bc0 <release>
}
80102acc:	c9                   	leave  
80102acd:	c3                   	ret    
...
80102ae4:	e8 75 20 00 00       	call   80104b5e <acquire>
  r = kmem.freelist;
...
80102b11:	e8 aa 20 00 00       	call   80104bc0 <release>
  return (char*)r;
...
80102e74:	c7 04 24 78 85 10 80 	movl   $0x80108578,(%esp)
...
80102fc9:	c7 44 24 04 a4 85 10 	movl   $0x801085a4,0x4(%esp)
80102fd0:	80 
80102fd1:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80102fd8:	e8 60 1b 00 00       	call   80104b3d <initlock>
  readsb(ROOTDEV, &sb);
...
8010308c:	e8 f0 1d 00 00       	call   80104e81 <memmove>
...
801031de:	e8 7b 19 00 00       	call   80104b5e <acquire>
  while (log.busy) {
...
801031f4:	e8 92 16 00 00       	call   8010488b <sleep>
...
80103213:	e8 a8 19 00 00       	call   80104bc0 <release>
}
80103218:	c9                   	leave  
80103219:	c3                   	ret    
...
80103294:	c7 04 24 a8 85 10 80 	movl   $0x801085a8,(%esp)
...
801032a9:	c7 04 24 be 85 10 80 	movl   $0x801085be,(%esp)
...
8010333a:	e8 42 1b 00 00       	call   80104e81 <memmove>
  bwrite(lbuf);
...
801033c1:	80 
801033c2:	c7 04 24 1c 2b 11 80 	movl   $0x80112b1c,(%esp)
801033c9:	e8 d2 f5 ff ff       	call   801029a0 <kinit1>
  kvmalloc();      // kernel page table
801033ce:	e8 17 48 00 00       	call   80107bea <kvmalloc>
  mpinit();        // collect info about this machine
801033d3:	e8 50 04 00 00       	call   80103828 <mpinit>
  lapicinit();
801033d8:	e8 11 f9 ff ff       	call   80102cee <lapicinit>
  seginit();       // set up segments
801033dd:	e8 58 3f 00 00       	call   8010733a <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
801033f2:	c7 04 24 d5 85 10 80 	movl   $0x801085d5,(%esp)
801033f9:	e8 a2 cf ff ff       	call   801003a0 <cprintf>
  picinit();       // interrupt controller
801033fe:	e8 8b 06 00 00       	call   80103a8e <picinit>
  ioapicinit();    // another interrupt controller
80103403:	e8 8e f4 ff ff       	call   80102896 <ioapicinit>
  consoleinit();   // I/O devices & their interrupts
80103408:	e8 74 d6 ff ff       	call   80100a81 <consoleinit>
  uartinit();      // serial port
8010340d:	e8 77 32 00 00       	call   80106689 <uartinit>
  pinit();         // process table
80103412:	e8 81 0b 00 00       	call   80103f98 <pinit>
  tvinit();        // trap vectors
80103417:	e8 1f 2e 00 00       	call   8010623b <tvinit>
  binit();         // buffer cache
...
80103439:	e8 48 2d 00 00       	call   80106186 <timerinit>
...
80103457:	e8 74 0c 00 00       	call   801040d0 <userinit>
...
80103464:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
80103467:	e8 95 47 00 00       	call   80107c01 <switchkvm>
  seginit();
8010346c:	e8 c9 3e 00 00       	call   8010733a <seginit>
  lapicinit();
...
80103491:	c7 04 24 ec 85 10 80 	movl   $0x801085ec,(%esp)
80103498:	e8 03 cf ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
8010349d:	e8 0d 2f 00 00       	call   801063af <idtinit>
...
801034bd:	e8 c5 11 00 00       	call   80104687 <scheduler>
...
801034ef:	e8 8d 19 00 00       	call   80104e81 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
801034f4:	c7 45 f4 20 f9 10 80 	movl   $0x8010f920,-0xc(%ebp)
801034fb:	e9 8a 00 00 00       	jmp    8010358a <startothers+0xc8>
...
8010350d:	c1 e0 06             	shl    $0x6,%eax
80103510:	05 20 f9 10 80       	add    $0x8010f920,%eax
80103515:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80103518:	75 02                	jne    8010351c <startothers+0x5a>
      continue;
8010351a:	eb 67                	jmp    80103583 <startothers+0xc1>

    // Tell entryother.S what stack to use, where to enter, and what 
    // pgdir to use. We cannot use kpgdir yet, because the AP processor
    // is running in low  memory, so we use entrypgdir for the APs too.
    stack = kalloc();
8010351c:	e8 ad f5 ff ff       	call   80102ace <kalloc>
80103521:	89 45 ec             	mov    %eax,-0x14(%ebp)
    *(void**)(code-4) = stack + KSTACKSIZE;
80103524:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103527:	83 e8 04             	sub    $0x4,%eax
8010352a:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010352d:	81 c2 00 10 00 00    	add    $0x1000,%edx
80103533:	89 10                	mov    %edx,(%eax)
    *(void**)(code-8) = mpenter;
80103535:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103538:	83 e8 08             	sub    $0x8,%eax
8010353b:	c7 00 61 34 10 80    	movl   $0x80103461,(%eax)
    *(int**)(code-12) = (void *) v2p(entrypgdir);
80103541:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103544:	8d 58 f4             	lea    -0xc(%eax),%ebx
80103547:	c7 04 24 00 a0 10 80 	movl   $0x8010a000,(%esp)
8010354e:	e8 2a fe ff ff       	call   8010337d <v2p>
80103553:	89 03                	mov    %eax,(%ebx)

    lapicstartap(c->id, v2p(code));
80103555:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103558:	89 04 24             	mov    %eax,(%esp)
8010355b:	e8 1d fe ff ff       	call   8010337d <v2p>
80103560:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103563:	0f b6 12             	movzbl (%edx),%edx
80103566:	0f b6 d2             	movzbl %dl,%edx
80103569:	89 44 24 04          	mov    %eax,0x4(%esp)
8010356d:	89 14 24             	mov    %edx,(%esp)
80103570:	e8 54 f9 ff ff       	call   80102ec9 <lapicstartap>

    // wait for cpu to finish mpmain()
    while(c->started == 0)
80103575:	90                   	nop
80103576:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103579:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
8010357f:	85 c0                	test   %eax,%eax
80103581:	74 f3                	je     80103576 <startothers+0xb4>
  // The linker has placed the image of entryother.S in
  // _binary_entryother_start.
  code = p2v(0x7000);
  memmove(code, _binary_entryother_start, (uint)_binary_entryother_size);
  ...
  for(c = cpus; c < cpus+ncpu; c++){
80103583:	81 45 f4 c0 00 00 00 	addl   $0xc0,-0xc(%ebp)
8010358a:	a1 20 ff 10 80       	mov    0x8010ff20,%eax
8010358f:	89 c2                	mov    %eax,%edx
80103591:	89 d0                	mov    %edx,%eax
80103593:	01 c0                	add    %eax,%eax
80103595:	01 d0                	add    %edx,%eax
80103597:	c1 e0 06             	shl    $0x6,%eax
8010359a:	05 20 f9 10 80       	add    $0x8010f920,%eax
8010359f:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801035a2:	0f 87 58 ff ff ff    	ja     80103500 <startothers+0x3e>
...
801035a8:	83 c4 24             	add    $0x24,%esp
801035ab:	5b                   	pop    %ebx
801035ac:	5d                   	pop    %ebp
801035ad:	c3                   	ret    
...
801035be:	83 ec 14             	sub    $0x14,%esp
801035c1:	8b 45 08             	mov    0x8(%ebp),%eax
801035c4:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801035c8:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
801035cc:	89 c2                	mov    %eax,%edx
801035ce:	ec                   	in     (%dx),%al
801035cf:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
801035d2:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
801035d6:	c9                   	leave  
801035d7:	c3                   	ret    
...
801035db:	83 ec 08             	sub    $0x8,%esp
801035de:	8b 55 08             	mov    0x8(%ebp),%edx
801035e1:	8b 45 0c             	mov    0xc(%ebp),%eax
801035e4:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801035e8:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801035eb:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801035ef:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
801035f7:	89 e5                	mov    %esp,%ebp
  return bcpu-cpus;
801035f9:	a1 44 b6 10 80       	mov    0x8010b644,%eax
801035fe:	89 c2                	mov    %eax,%edx
80103600:	b8 20 f9 10 80       	mov    $0x8010f920,%eax
80103605:	29 c2                	sub    %eax,%edx
80103607:	89 d0                	mov    %edx,%eax
80103609:	c1 f8 06             	sar    $0x6,%eax
8010360c:	69 c0 ab aa aa aa    	imul   $0xaaaaaaab,%eax,%eax
}
80103612:	5d                   	pop    %ebp
80103613:	c3                   	ret    
...
80103617:	83 ec 10             	sub    $0x10,%esp
  int i, sum;
  
  sum = 0;
8010361a:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
  for(i=0; i<len; i++)
80103621:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80103628:	eb 15                	jmp    8010363f <sum+0x2b>
    sum += addr[i];
8010362a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010362d:	8b 45 08             	mov    0x8(%ebp),%eax
80103630:	01 d0                	add    %edx,%eax
80103632:	0f b6 00             	movzbl (%eax),%eax
80103635:	0f b6 c0             	movzbl %al,%eax
80103638:	01 45 f8             	add    %eax,-0x8(%ebp)
sum(uchar *addr, int len)
{
  int i, sum;
  ...
  sum = 0;
  for(i=0; i<len; i++)
8010363b:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010363f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80103642:	3b 45 0c             	cmp    0xc(%ebp),%eax
80103645:	7c e3                	jl     8010362a <sum+0x16>
    sum += addr[i];
  return sum;
80103647:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
8010364a:	c9                   	leave  
8010364b:	c3                   	ret    
...
8010364f:	83 ec 28             	sub    $0x28,%esp
  uchar *e, *p, *addr;

  addr = p2v(a);
80103652:	8b 45 08             	mov    0x8(%ebp),%eax
80103655:	89 04 24             	mov    %eax,(%esp)
80103658:	e8 51 ff ff ff       	call   801035ae <p2v>
8010365d:	89 45 f0             	mov    %eax,-0x10(%ebp)
  e = addr+len;
80103660:	8b 55 0c             	mov    0xc(%ebp),%edx
80103663:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103666:	01 d0                	add    %edx,%eax
80103668:	89 45 ec             	mov    %eax,-0x14(%ebp)
  for(p = addr; p < e; p += sizeof(struct mp))
8010366b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010366e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80103671:	eb 3f                	jmp    801036b2 <mpsearch1+0x66>
    if(memcmp(p, "_MP_", 4) == 0 && sum(p, sizeof(struct mp)) == 0)
80103673:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
8010367a:	00 
8010367b:	c7 44 24 04 00 86 10 	movl   $0x80108600,0x4(%esp)
80103682:	80 
80103683:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103686:	89 04 24             	mov    %eax,(%esp)
80103689:	e8 9b 17 00 00       	call   80104e29 <memcmp>
8010368e:	85 c0                	test   %eax,%eax
80103690:	75 1c                	jne    801036ae <mpsearch1+0x62>
80103692:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
80103699:	00 
8010369a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010369d:	89 04 24             	mov    %eax,(%esp)
801036a0:	e8 6f ff ff ff       	call   80103614 <sum>
801036a5:	84 c0                	test   %al,%al
801036a7:	75 05                	jne    801036ae <mpsearch1+0x62>
      return (struct mp*)p;
801036a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036ac:	eb 11                	jmp    801036bf <mpsearch1+0x73>
{
  uchar *e, *p, *addr;
  ...
  e = addr+len;
  for(p = addr; p < e; p += sizeof(struct mp))
801036ae:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
801036b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036b5:	3b 45 ec             	cmp    -0x14(%ebp),%eax
801036b8:	72 b9                	jb     80103673 <mpsearch1+0x27>
    if(memcmp(p, "_MP_", 4) == 0 && sum(p, sizeof(struct mp)) == 0)
      return (struct mp*)p;
  return 0;
801036ba:	b8 00 00 00 00       	mov    $0x0,%eax
}
801036bf:	c9                   	leave  
801036c0:	c3                   	ret    
...
801036c4:	83 ec 28             	sub    $0x28,%esp
  uchar *bda;
  uint p;
  struct mp *mp;

  bda = (uchar *) P2V(0x400);
801036c7:	c7 45 f4 00 04 00 80 	movl   $0x80000400,-0xc(%ebp)
  if((p = ((bda[0x0F]<<8)| bda[0x0E]) << 4)){
801036ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036d1:	83 c0 0f             	add    $0xf,%eax
801036d4:	0f b6 00             	movzbl (%eax),%eax
801036d7:	0f b6 c0             	movzbl %al,%eax
801036da:	c1 e0 08             	shl    $0x8,%eax
801036dd:	89 c2                	mov    %eax,%edx
801036df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036e2:	83 c0 0e             	add    $0xe,%eax
801036e5:	0f b6 00             	movzbl (%eax),%eax
801036e8:	0f b6 c0             	movzbl %al,%eax
801036eb:	09 d0                	or     %edx,%eax
801036ed:	c1 e0 04             	shl    $0x4,%eax
801036f0:	89 45 f0             	mov    %eax,-0x10(%ebp)
801036f3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801036f7:	74 21                	je     8010371a <mpsearch+0x59>
    if((mp = mpsearch1(p, 1024)))
801036f9:	c7 44 24 04 00 04 00 	movl   $0x400,0x4(%esp)
80103700:	00 
80103701:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103704:	89 04 24             	mov    %eax,(%esp)
80103707:	e8 40 ff ff ff       	call   8010364c <mpsearch1>
8010370c:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010370f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80103713:	74 50                	je     80103765 <mpsearch+0xa4>
      return mp;
80103715:	8b 45 ec             	mov    -0x14(%ebp),%eax
80103718:	eb 5f                	jmp    80103779 <mpsearch+0xb8>
  } else {
    p = ((bda[0x14]<<8)|bda[0x13])*1024;
8010371a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010371d:	83 c0 14             	add    $0x14,%eax
80103720:	0f b6 00             	movzbl (%eax),%eax
80103723:	0f b6 c0             	movzbl %al,%eax
80103726:	c1 e0 08             	shl    $0x8,%eax
80103729:	89 c2                	mov    %eax,%edx
8010372b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010372e:	83 c0 13             	add    $0x13,%eax
80103731:	0f b6 00             	movzbl (%eax),%eax
80103734:	0f b6 c0             	movzbl %al,%eax
80103737:	09 d0                	or     %edx,%eax
80103739:	c1 e0 0a             	shl    $0xa,%eax
8010373c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if((mp = mpsearch1(p-1024, 1024)))
8010373f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103742:	2d 00 04 00 00       	sub    $0x400,%eax
80103747:	c7 44 24 04 00 04 00 	movl   $0x400,0x4(%esp)
8010374e:	00 
8010374f:	89 04 24             	mov    %eax,(%esp)
80103752:	e8 f5 fe ff ff       	call   8010364c <mpsearch1>
80103757:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010375a:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010375e:	74 05                	je     80103765 <mpsearch+0xa4>
      return mp;
80103760:	8b 45 ec             	mov    -0x14(%ebp),%eax
80103763:	eb 14                	jmp    80103779 <mpsearch+0xb8>
  }
  return mpsearch1(0xF0000, 0x10000);
80103765:	c7 44 24 04 00 00 01 	movl   $0x10000,0x4(%esp)
8010376c:	00 
8010376d:	c7 04 24 00 00 0f 00 	movl   $0xf0000,(%esp)
80103774:	e8 d3 fe ff ff       	call   8010364c <mpsearch1>
}
80103779:	c9                   	leave  
8010377a:	c3                   	ret    
...
80103781:	e8 3b ff ff ff       	call   801036c1 <mpsearch>
80103786:	89 45 f4             	mov    %eax,-0xc(%ebp)
80103789:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010378d:	74 0a                	je     80103799 <mpconfig+0x1e>
8010378f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103792:	8b 40 04             	mov    0x4(%eax),%eax
80103795:	85 c0                	test   %eax,%eax
80103797:	75 0a                	jne    801037a3 <mpconfig+0x28>
    return 0;
80103799:	b8 00 00 00 00       	mov    $0x0,%eax
8010379e:	e9 83 00 00 00       	jmp    80103826 <mpconfig+0xab>
  conf = (struct mpconf*) p2v((uint) mp->physaddr);
801037a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801037a6:	8b 40 04             	mov    0x4(%eax),%eax
801037a9:	89 04 24             	mov    %eax,(%esp)
801037ac:	e8 fd fd ff ff       	call   801035ae <p2v>
801037b1:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
801037b4:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801037bb:	00 
801037bc:	c7 44 24 04 05 86 10 	movl   $0x80108605,0x4(%esp)
801037c3:	80 
801037c4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801037c7:	89 04 24             	mov    %eax,(%esp)
801037ca:	e8 5a 16 00 00       	call   80104e29 <memcmp>
801037cf:	85 c0                	test   %eax,%eax
801037d1:	74 07                	je     801037da <mpconfig+0x5f>
    return 0;
801037d3:	b8 00 00 00 00       	mov    $0x0,%eax
801037d8:	eb 4c                	jmp    80103826 <mpconfig+0xab>
  if(conf->version != 1 && conf->version != 4)
801037da:	8b 45 f0             	mov    -0x10(%ebp),%eax
801037dd:	0f b6 40 06          	movzbl 0x6(%eax),%eax
801037e1:	3c 01                	cmp    $0x1,%al
801037e3:	74 12                	je     801037f7 <mpconfig+0x7c>
801037e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801037e8:	0f b6 40 06          	movzbl 0x6(%eax),%eax
801037ec:	3c 04                	cmp    $0x4,%al
801037ee:	74 07                	je     801037f7 <mpconfig+0x7c>
    return 0;
801037f0:	b8 00 00 00 00       	mov    $0x0,%eax
801037f5:	eb 2f                	jmp    80103826 <mpconfig+0xab>
  if(sum((uchar*)conf, conf->length) != 0)
801037f7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801037fa:	0f b7 40 04          	movzwl 0x4(%eax),%eax
801037fe:	0f b7 c0             	movzwl %ax,%eax
80103801:	89 44 24 04          	mov    %eax,0x4(%esp)
80103805:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103808:	89 04 24             	mov    %eax,(%esp)
8010380b:	e8 04 fe ff ff       	call   80103614 <sum>
80103810:	84 c0                	test   %al,%al
80103812:	74 07                	je     8010381b <mpconfig+0xa0>
    return 0;
80103814:	b8 00 00 00 00       	mov    $0x0,%eax
80103819:	eb 0b                	jmp    80103826 <mpconfig+0xab>
  *pmp = mp;
8010381b:	8b 45 08             	mov    0x8(%ebp),%eax
8010381e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103821:	89 10                	mov    %edx,(%eax)
  return conf;
...
8010382b:	83 ec 38             	sub    $0x38,%esp
  struct mp *mp;
  struct mpconf *conf;
  struct mpproc *proc;
  ...
  bcpu = &cpus[0];
8010382e:	c7 05 44 b6 10 80 20 	movl   $0x8010f920,0x8010b644
80103835:	f9 10 80 
  if((conf = mpconfig(&mp)) == 0)
80103838:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010383b:	89 04 24             	mov    %eax,(%esp)
8010383e:	e8 38 ff ff ff       	call   8010377b <mpconfig>
80103843:	89 45 f0             	mov    %eax,-0x10(%ebp)
80103846:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010384a:	75 05                	jne    80103851 <mpinit+0x29>
    return;
8010384c:	e9 a4 01 00 00       	jmp    801039f5 <mpinit+0x1cd>
  ismp = 1;
80103851:	c7 05 04 f9 10 80 01 	movl   $0x1,0x8010f904
80103858:	00 00 00 
  lapic = (uint*)conf->lapicaddr;
8010385b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010385e:	8b 40 24             	mov    0x24(%eax),%eax
80103861:	a3 7c f8 10 80       	mov    %eax,0x8010f87c
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
80103866:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103869:	83 c0 2c             	add    $0x2c,%eax
8010386c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010386f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103872:	0f b7 40 04          	movzwl 0x4(%eax),%eax
80103876:	0f b7 d0             	movzwl %ax,%edx
80103879:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010387c:	01 d0                	add    %edx,%eax
8010387e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80103881:	e9 fc 00 00 00       	jmp    80103982 <mpinit+0x15a>
    switch(*p){
80103886:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103889:	0f b6 00             	movzbl (%eax),%eax
8010388c:	0f b6 c0             	movzbl %al,%eax
8010388f:	83 f8 04             	cmp    $0x4,%eax
80103892:	0f 87 c7 00 00 00    	ja     8010395f <mpinit+0x137>
80103898:	8b 04 85 48 86 10 80 	mov    -0x7fef79b8(,%eax,4),%eax
8010389f:	ff e0                	jmp    *%eax
    case MPPROC:
      proc = (struct mpproc*)p;
801038a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801038a4:	89 45 e8             	mov    %eax,-0x18(%ebp)
      if(ncpu != proc->apicid){
801038a7:	8b 45 e8             	mov    -0x18(%ebp),%eax
801038aa:	0f b6 40 01          	movzbl 0x1(%eax),%eax
801038ae:	0f b6 d0             	movzbl %al,%edx
801038b1:	a1 20 ff 10 80       	mov    0x8010ff20,%eax
801038b6:	39 c2                	cmp    %eax,%edx
801038b8:	74 2d                	je     801038e7 <mpinit+0xbf>
        cprintf("mpinit: ncpu=%d apicid=%d\n", ncpu, proc->apicid);
801038ba:	8b 45 e8             	mov    -0x18(%ebp),%eax
801038bd:	0f b6 40 01          	movzbl 0x1(%eax),%eax
801038c1:	0f b6 d0             	movzbl %al,%edx
801038c4:	a1 20 ff 10 80       	mov    0x8010ff20,%eax
801038c9:	89 54 24 08          	mov    %edx,0x8(%esp)
801038cd:	89 44 24 04          	mov    %eax,0x4(%esp)
801038d1:	c7 04 24 0a 86 10 80 	movl   $0x8010860a,(%esp)
801038d8:	e8 c3 ca ff ff       	call   801003a0 <cprintf>
        ismp = 0;
801038dd:	c7 05 04 f9 10 80 00 	movl   $0x0,0x8010f904
801038e4:	00 00 00 
      }
      if(proc->flags & MPBOOT)
801038e7:	8b 45 e8             	mov    -0x18(%ebp),%eax
801038ea:	0f b6 40 03          	movzbl 0x3(%eax),%eax
801038ee:	0f b6 c0             	movzbl %al,%eax
801038f1:	83 e0 02             	and    $0x2,%eax
801038f4:	85 c0                	test   %eax,%eax
801038f6:	74 19                	je     80103911 <mpinit+0xe9>
        bcpu = &cpus[ncpu];
801038f8:	8b 15 20 ff 10 80    	mov    0x8010ff20,%edx
801038fe:	89 d0                	mov    %edx,%eax
80103900:	01 c0                	add    %eax,%eax
80103902:	01 d0                	add    %edx,%eax
80103904:	c1 e0 06             	shl    $0x6,%eax
80103907:	05 20 f9 10 80       	add    $0x8010f920,%eax
8010390c:	a3 44 b6 10 80       	mov    %eax,0x8010b644
      cpus[ncpu].id = ncpu;
80103911:	8b 15 20 ff 10 80    	mov    0x8010ff20,%edx
80103917:	a1 20 ff 10 80       	mov    0x8010ff20,%eax
8010391c:	89 c1                	mov    %eax,%ecx
8010391e:	89 d0                	mov    %edx,%eax
80103920:	01 c0                	add    %eax,%eax
80103922:	01 d0                	add    %edx,%eax
80103924:	c1 e0 06             	shl    $0x6,%eax
80103927:	05 20 f9 10 80       	add    $0x8010f920,%eax
8010392c:	88 08                	mov    %cl,(%eax)
      ncpu++;
8010392e:	a1 20 ff 10 80       	mov    0x8010ff20,%eax
80103933:	83 c0 01             	add    $0x1,%eax
80103936:	a3 20 ff 10 80       	mov    %eax,0x8010ff20
      p += sizeof(struct mpproc);
8010393b:	83 45 f4 14          	addl   $0x14,-0xc(%ebp)
      continue;
8010393f:	eb 41                	jmp    80103982 <mpinit+0x15a>
    case MPIOAPIC:
      ioapic = (struct mpioapic*)p;
80103941:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103944:	89 45 e4             	mov    %eax,-0x1c(%ebp)
      ioapicid = ioapic->apicno;
80103947:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010394a:	0f b6 40 01          	movzbl 0x1(%eax),%eax
8010394e:	a2 00 f9 10 80       	mov    %al,0x8010f900
      p += sizeof(struct mpioapic);
80103953:	83 45 f4 08          	addl   $0x8,-0xc(%ebp)
      continue;
80103957:	eb 29                	jmp    80103982 <mpinit+0x15a>
    case MPBUS:
    case MPIOINTR:
    case MPLINTR:
      p += 8;
80103959:	83 45 f4 08          	addl   $0x8,-0xc(%ebp)
      continue;
8010395d:	eb 23                	jmp    80103982 <mpinit+0x15a>
    default:
      cprintf("mpinit: unknown config type %x\n", *p);
8010395f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103962:	0f b6 00             	movzbl (%eax),%eax
80103965:	0f b6 c0             	movzbl %al,%eax
80103968:	89 44 24 04          	mov    %eax,0x4(%esp)
8010396c:	c7 04 24 28 86 10 80 	movl   $0x80108628,(%esp)
80103973:	e8 28 ca ff ff       	call   801003a0 <cprintf>
      ismp = 0;
80103978:	c7 05 04 f9 10 80 00 	movl   $0x0,0x8010f904
8010397f:	00 00 00 
  bcpu = &cpus[0];
  if((conf = mpconfig(&mp)) == 0)
    return;
...
80103985:	3b 45 ec             	cmp    -0x14(%ebp),%eax
80103988:	0f 82 f8 fe ff ff    	jb     80103886 <mpinit+0x5e>
    default:
      cprintf("mpinit: unknown config type %x\n", *p);
      ismp = 0;
    }
  ...
  if(!ismp){
8010398e:	a1 04 f9 10 80       	mov    0x8010f904,%eax
80103993:	85 c0                	test   %eax,%eax
80103995:	75 1d                	jne    801039b4 <mpinit+0x18c>
    // Didn't like what we found; fall back to no MP.
    ncpu = 1;
80103997:	c7 05 20 ff 10 80 01 	movl   $0x1,0x8010ff20
8010399e:	00 00 00 
    lapic = 0;
801039a1:	c7 05 7c f8 10 80 00 	movl   $0x0,0x8010f87c
801039a8:	00 00 00 
    ioapicid = 0;
801039ab:	c6 05 00 f9 10 80 00 	movb   $0x0,0x8010f900
    return;
801039b2:	eb 41                	jmp    801039f5 <mpinit+0x1cd>
  }

  if(mp->imcrp){
801039b4:	8b 45 e0             	mov    -0x20(%ebp),%eax
801039b7:	0f b6 40 0c          	movzbl 0xc(%eax),%eax
801039bb:	84 c0                	test   %al,%al
801039bd:	74 36                	je     801039f5 <mpinit+0x1cd>
    // Bochs doesn't support IMCR, so this doesn't run on Bochs.
    // But it would on real hardware.
    outb(0x22, 0x70);   // Select IMCR
801039bf:	c7 44 24 04 70 00 00 	movl   $0x70,0x4(%esp)
801039c6:	00 
801039c7:	c7 04 24 22 00 00 00 	movl   $0x22,(%esp)
801039ce:	e8 05 fc ff ff       	call   801035d8 <outb>
    outb(0x23, inb(0x23) | 1);  // Mask external interrupts.
801039d3:	c7 04 24 23 00 00 00 	movl   $0x23,(%esp)
801039da:	e8 dc fb ff ff       	call   801035bb <inb>
801039df:	83 c8 01             	or     $0x1,%eax
801039e2:	0f b6 c0             	movzbl %al,%eax
801039e5:	89 44 24 04          	mov    %eax,0x4(%esp)
801039e9:	c7 04 24 23 00 00 00 	movl   $0x23,(%esp)
801039f0:	e8 e3 fb ff ff       	call   801035d8 <outb>
  }
}
801039f5:	c9                   	leave  
801039f6:	c3                   	ret    
...
80103a1e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  irqmask = mask;
80103a22:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80103a26:	66 a3 00 b0 10 80    	mov    %ax,0x8010b000
  outb(IO_PIC1+1, mask);
80103a2c:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80103a30:	0f b6 c0             	movzbl %al,%eax
80103a33:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a37:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103a3e:	e8 b4 ff ff ff       	call   801039f7 <outb>
  outb(IO_PIC2+1, mask >> 8);
80103a43:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80103a47:	66 c1 e8 08          	shr    $0x8,%ax
80103a4b:	0f b6 c0             	movzbl %al,%eax
80103a4e:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a52:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103a59:	e8 99 ff ff ff       	call   801039f7 <outb>
}
80103a5e:	c9                   	leave  
80103a5f:	c3                   	ret    
...
80103a69:	ba 01 00 00 00       	mov    $0x1,%edx
80103a6e:	89 c1                	mov    %eax,%ecx
80103a70:	d3 e2                	shl    %cl,%edx
80103a72:	89 d0                	mov    %edx,%eax
80103a74:	f7 d0                	not    %eax
80103a76:	89 c2                	mov    %eax,%edx
80103a78:	0f b7 05 00 b0 10 80 	movzwl 0x8010b000,%eax
80103a7f:	21 d0                	and    %edx,%eax
80103a81:	0f b7 c0             	movzwl %ax,%eax
80103a84:	89 04 24             	mov    %eax,(%esp)
80103a87:	e8 89 ff ff ff       	call   80103a15 <picsetmask>
}
80103a8c:	c9                   	leave  
80103a8d:	c3                   	ret    
...
80103a91:	83 ec 08             	sub    $0x8,%esp
  // mask all interrupts
  outb(IO_PIC1+1, 0xFF);
80103a94:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
80103a9b:	00 
80103a9c:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103aa3:	e8 4f ff ff ff       	call   801039f7 <outb>
  outb(IO_PIC2+1, 0xFF);
80103aa8:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
80103aaf:	00 
80103ab0:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103ab7:	e8 3b ff ff ff       	call   801039f7 <outb>
  ...
  outb(IO_PIC1, 0x11);
80103abc:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
80103ac3:	00 
80103ac4:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80103acb:	e8 27 ff ff ff       	call   801039f7 <outb>

  // ICW2:  Vector offset
  outb(IO_PIC1+1, T_IRQ0);
80103ad0:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
80103ad7:	00 
80103ad8:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103adf:	e8 13 ff ff ff       	call   801039f7 <outb>

  // ICW3:  (master PIC) bit mask of IR lines connected to slaves
  //        (slave PIC) 3-bit # of slave's connection to master
  outb(IO_PIC1+1, 1<<IRQ_SLAVE);
80103ae4:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
80103aeb:	00 
80103aec:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103af3:	e8 ff fe ff ff       	call   801039f7 <outb>
  ...
  outb(IO_PIC1+1, 0x3);
80103af8:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80103aff:	00 
80103b00:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103b07:	e8 eb fe ff ff       	call   801039f7 <outb>

  // Set up slave (8259A-2)
  outb(IO_PIC2, 0x11);                  // ICW1
80103b0c:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
80103b13:	00 
80103b14:	c7 04 24 a0 00 00 00 	movl   $0xa0,(%esp)
80103b1b:	e8 d7 fe ff ff       	call   801039f7 <outb>
  outb(IO_PIC2+1, T_IRQ0 + 8);      // ICW2
80103b20:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
80103b27:	00 
80103b28:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103b2f:	e8 c3 fe ff ff       	call   801039f7 <outb>
  outb(IO_PIC2+1, IRQ_SLAVE);           // ICW3
80103b34:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80103b3b:	00 
80103b3c:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103b43:	e8 af fe ff ff       	call   801039f7 <outb>
...
80103b57:	e8 9b fe ff ff       	call   801039f7 <outb>
...
80103b5c:	c7 44 24 04 68 00 00 	movl   $0x68,0x4(%esp)
80103b63:	00 
80103b64:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80103b6b:	e8 87 fe ff ff       	call   801039f7 <outb>
  outb(IO_PIC1, 0x0a);             // read IRR by default
80103b70:	c7 44 24 04 0a 00 00 	movl   $0xa,0x4(%esp)
80103b77:	00 
80103b78:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80103b7f:	e8 73 fe ff ff       	call   801039f7 <outb>

  outb(IO_PIC2, 0x68);             // OCW3
80103b84:	c7 44 24 04 68 00 00 	movl   $0x68,0x4(%esp)
80103b8b:	00 
80103b8c:	c7 04 24 a0 00 00 00 	movl   $0xa0,(%esp)
80103b93:	e8 5f fe ff ff       	call   801039f7 <outb>
  outb(IO_PIC2, 0x0a);             // OCW3
80103b98:	c7 44 24 04 0a 00 00 	movl   $0xa,0x4(%esp)
80103b9f:	00 
80103ba0:	c7 04 24 a0 00 00 00 	movl   $0xa0,(%esp)
80103ba7:	e8 4b fe ff ff       	call   801039f7 <outb>

  if(irqmask != 0xFFFF)
80103bac:	0f b7 05 00 b0 10 80 	movzwl 0x8010b000,%eax
80103bb3:	66 83 f8 ff          	cmp    $0xffff,%ax
80103bb7:	74 12                	je     80103bcb <picinit+0x13d>
    picsetmask(irqmask);
80103bb9:	0f b7 05 00 b0 10 80 	movzwl 0x8010b000,%eax
80103bc0:	0f b7 c0             	movzwl %ax,%eax
80103bc3:	89 04 24             	mov    %eax,(%esp)
80103bc6:	e8 4a fe ff ff       	call   80103a15 <picsetmask>
}
80103bcb:	c9                   	leave  
80103bcc:	c3                   	ret    
...
80103bd3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  *f0 = *f1 = 0;
80103bda:	8b 45 0c             	mov    0xc(%ebp),%eax
80103bdd:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80103be3:	8b 45 0c             	mov    0xc(%ebp),%eax
80103be6:	8b 10                	mov    (%eax),%edx
80103be8:	8b 45 08             	mov    0x8(%ebp),%eax
80103beb:	89 10                	mov    %edx,(%eax)
  if((*f0 = filealloc()) == 0 || (*f1 = filealloc()) == 0)
80103bed:	e8 20 d3 ff ff       	call   80100f12 <filealloc>
80103bf2:	8b 55 08             	mov    0x8(%ebp),%edx
80103bf5:	89 02                	mov    %eax,(%edx)
80103bf7:	8b 45 08             	mov    0x8(%ebp),%eax
80103bfa:	8b 00                	mov    (%eax),%eax
80103bfc:	85 c0                	test   %eax,%eax
80103bfe:	0f 84 c8 00 00 00    	je     80103ccc <pipealloc+0xff>
80103c04:	e8 09 d3 ff ff       	call   80100f12 <filealloc>
80103c09:	8b 55 0c             	mov    0xc(%ebp),%edx
80103c0c:	89 02                	mov    %eax,(%edx)
80103c0e:	8b 45 0c             	mov    0xc(%ebp),%eax
80103c11:	8b 00                	mov    (%eax),%eax
80103c13:	85 c0                	test   %eax,%eax
80103c15:	0f 84 b1 00 00 00    	je     80103ccc <pipealloc+0xff>
    goto bad;
  if((p = (struct pipe*)kalloc()) == 0)
80103c1b:	e8 ae ee ff ff       	call   80102ace <kalloc>
80103c20:	89 45 f4             	mov    %eax,-0xc(%ebp)
80103c23:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80103c27:	75 05                	jne    80103c2e <pipealloc+0x61>
    goto bad;
80103c29:	e9 9e 00 00 00       	jmp    80103ccc <pipealloc+0xff>
  p->readopen = 1;
80103c2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103c31:	c7 80 3c 02 00 00 01 	movl   $0x1,0x23c(%eax)
80103c38:	00 00 00 
  p->writeopen = 1;
80103c3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103c3e:	c7 80 40 02 00 00 01 	movl   $0x1,0x240(%eax)
80103c45:	00 00 00 
  p->nwrite = 0;
80103c48:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103c4b:	c7 80 38 02 00 00 00 	movl   $0x0,0x238(%eax)
80103c52:	00 00 00 
  p->nread = 0;
80103c55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103c58:	c7 80 34 02 00 00 00 	movl   $0x0,0x234(%eax)
80103c5f:	00 00 00 
  initlock(&p->lock, "pipe");
80103c62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103c65:	c7 44 24 04 5c 86 10 	movl   $0x8010865c,0x4(%esp)
80103c6c:	80 
80103c6d:	89 04 24             	mov    %eax,(%esp)
80103c70:	e8 c8 0e 00 00       	call   80104b3d <initlock>
  (*f0)->type = FD_PIPE;
80103c75:	8b 45 08             	mov    0x8(%ebp),%eax
80103c78:	8b 00                	mov    (%eax),%eax
80103c7a:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  (*f0)->readable = 1;
80103c80:	8b 45 08             	mov    0x8(%ebp),%eax
80103c83:	8b 00                	mov    (%eax),%eax
80103c85:	c6 40 08 01          	movb   $0x1,0x8(%eax)
  (*f0)->writable = 0;
80103c89:	8b 45 08             	mov    0x8(%ebp),%eax
80103c8c:	8b 00                	mov    (%eax),%eax
80103c8e:	c6 40 09 00          	movb   $0x0,0x9(%eax)
  (*f0)->pipe = p;
80103c92:	8b 45 08             	mov    0x8(%ebp),%eax
80103c95:	8b 00                	mov    (%eax),%eax
80103c97:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103c9a:	89 50 0c             	mov    %edx,0xc(%eax)
  (*f1)->type = FD_PIPE;
80103c9d:	8b 45 0c             	mov    0xc(%ebp),%eax
80103ca0:	8b 00                	mov    (%eax),%eax
80103ca2:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  (*f1)->readable = 0;
80103ca8:	8b 45 0c             	mov    0xc(%ebp),%eax
80103cab:	8b 00                	mov    (%eax),%eax
80103cad:	c6 40 08 00          	movb   $0x0,0x8(%eax)
  (*f1)->writable = 1;
80103cb1:	8b 45 0c             	mov    0xc(%ebp),%eax
80103cb4:	8b 00                	mov    (%eax),%eax
80103cb6:	c6 40 09 01          	movb   $0x1,0x9(%eax)
  (*f1)->pipe = p;
80103cba:	8b 45 0c             	mov    0xc(%ebp),%eax
80103cbd:	8b 00                	mov    (%eax),%eax
80103cbf:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103cc2:	89 50 0c             	mov    %edx,0xc(%eax)
  return 0;
80103cc5:	b8 00 00 00 00       	mov    $0x0,%eax
80103cca:	eb 42                	jmp    80103d0e <pipealloc+0x141>

//PAGEBREAK: 20
 bad:
  if(p)
80103ccc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80103cd0:	74 0b                	je     80103cdd <pipealloc+0x110>
    kfree((char*)p);
80103cd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103cd5:	89 04 24             	mov    %eax,(%esp)
80103cd8:	e8 58 ed ff ff       	call   80102a35 <kfree>
  if(*f0)
80103cdd:	8b 45 08             	mov    0x8(%ebp),%eax
80103ce0:	8b 00                	mov    (%eax),%eax
80103ce2:	85 c0                	test   %eax,%eax
80103ce4:	74 0d                	je     80103cf3 <pipealloc+0x126>
    fileclose(*f0);
80103ce6:	8b 45 08             	mov    0x8(%ebp),%eax
80103ce9:	8b 00                	mov    (%eax),%eax
80103ceb:	89 04 24             	mov    %eax,(%esp)
80103cee:	e8 c7 d2 ff ff       	call   80100fba <fileclose>
  if(*f1)
80103cf3:	8b 45 0c             	mov    0xc(%ebp),%eax
80103cf6:	8b 00                	mov    (%eax),%eax
80103cf8:	85 c0                	test   %eax,%eax
80103cfa:	74 0d                	je     80103d09 <pipealloc+0x13c>
    fileclose(*f1);
80103cfc:	8b 45 0c             	mov    0xc(%ebp),%eax
80103cff:	8b 00                	mov    (%eax),%eax
80103d01:	89 04 24             	mov    %eax,(%esp)
80103d04:	e8 b1 d2 ff ff       	call   80100fba <fileclose>
  return -1;
80103d09:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80103d0e:	c9                   	leave  
80103d0f:	c3                   	ret    
...
80103d19:	89 04 24             	mov    %eax,(%esp)
80103d1c:	e8 3d 0e 00 00       	call   80104b5e <acquire>
  if(writable){
80103d21:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80103d25:	74 1f                	je     80103d46 <pipeclose+0x36>
    p->writeopen = 0;
80103d27:	8b 45 08             	mov    0x8(%ebp),%eax
80103d2a:	c7 80 40 02 00 00 00 	movl   $0x0,0x240(%eax)
80103d31:	00 00 00 
    wakeup(&p->nread);
80103d34:	8b 45 08             	mov    0x8(%ebp),%eax
80103d37:	05 34 02 00 00       	add    $0x234,%eax
80103d3c:	89 04 24             	mov    %eax,(%esp)
80103d3f:	e8 23 0c 00 00       	call   80104967 <wakeup>
80103d44:	eb 1d                	jmp    80103d63 <pipeclose+0x53>
  } else {
    p->readopen = 0;
80103d46:	8b 45 08             	mov    0x8(%ebp),%eax
80103d49:	c7 80 3c 02 00 00 00 	movl   $0x0,0x23c(%eax)
80103d50:	00 00 00 
    wakeup(&p->nwrite);
80103d53:	8b 45 08             	mov    0x8(%ebp),%eax
80103d56:	05 38 02 00 00       	add    $0x238,%eax
80103d5b:	89 04 24             	mov    %eax,(%esp)
80103d5e:	e8 04 0c 00 00       	call   80104967 <wakeup>
  }
  if(p->readopen == 0 && p->writeopen == 0){
80103d63:	8b 45 08             	mov    0x8(%ebp),%eax
80103d66:	8b 80 3c 02 00 00    	mov    0x23c(%eax),%eax
80103d6c:	85 c0                	test   %eax,%eax
80103d6e:	75 25                	jne    80103d95 <pipeclose+0x85>
80103d70:	8b 45 08             	mov    0x8(%ebp),%eax
80103d73:	8b 80 40 02 00 00    	mov    0x240(%eax),%eax
80103d79:	85 c0                	test   %eax,%eax
80103d7b:	75 18                	jne    80103d95 <pipeclose+0x85>
    release(&p->lock);
80103d7d:	8b 45 08             	mov    0x8(%ebp),%eax
80103d80:	89 04 24             	mov    %eax,(%esp)
80103d83:	e8 38 0e 00 00       	call   80104bc0 <release>
    kfree((char*)p);
80103d88:	8b 45 08             	mov    0x8(%ebp),%eax
80103d8b:	89 04 24             	mov    %eax,(%esp)
80103d8e:	e8 a2 ec ff ff       	call   80102a35 <kfree>
80103d93:	eb 0b                	jmp    80103da0 <pipeclose+0x90>
  } else
    release(&p->lock);
80103d95:	8b 45 08             	mov    0x8(%ebp),%eax
80103d98:	89 04 24             	mov    %eax,(%esp)
80103d9b:	e8 20 0e 00 00       	call   80104bc0 <release>
}
80103da0:	c9                   	leave  
80103da1:	c3                   	ret    
...
80103dae:	e8 ab 0d 00 00       	call   80104b5e <acquire>
  for(i = 0; i < n; i++){
80103db3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80103dba:	e9 a6 00 00 00       	jmp    80103e65 <pipewrite+0xc3>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
80103dbf:	eb 57                	jmp    80103e18 <pipewrite+0x76>
      if(p->readopen == 0 || proc->killed){
80103dc1:	8b 45 08             	mov    0x8(%ebp),%eax
80103dc4:	8b 80 3c 02 00 00    	mov    0x23c(%eax),%eax
80103dca:	85 c0                	test   %eax,%eax
80103dcc:	74 0d                	je     80103ddb <pipewrite+0x39>
80103dce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80103dd4:	8b 40 24             	mov    0x24(%eax),%eax
80103dd7:	85 c0                	test   %eax,%eax
80103dd9:	74 15                	je     80103df0 <pipewrite+0x4e>
        release(&p->lock);
80103ddb:	8b 45 08             	mov    0x8(%ebp),%eax
80103dde:	89 04 24             	mov    %eax,(%esp)
80103de1:	e8 da 0d 00 00       	call   80104bc0 <release>
        return -1;
80103de6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103deb:	e9 9f 00 00 00       	jmp    80103e8f <pipewrite+0xed>
      }
      wakeup(&p->nread);
80103df0:	8b 45 08             	mov    0x8(%ebp),%eax
80103df3:	05 34 02 00 00       	add    $0x234,%eax
80103df8:	89 04 24             	mov    %eax,(%esp)
80103dfb:	e8 67 0b 00 00       	call   80104967 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103e00:	8b 45 08             	mov    0x8(%ebp),%eax
80103e03:	8b 55 08             	mov    0x8(%ebp),%edx
80103e06:	81 c2 38 02 00 00    	add    $0x238,%edx
80103e0c:	89 44 24 04          	mov    %eax,0x4(%esp)
80103e10:	89 14 24             	mov    %edx,(%esp)
80103e13:	e8 73 0a 00 00       	call   8010488b <sleep>
{
  int i;
...
80103e1b:	8b 90 38 02 00 00    	mov    0x238(%eax),%edx
80103e21:	8b 45 08             	mov    0x8(%ebp),%eax
80103e24:	8b 80 34 02 00 00    	mov    0x234(%eax),%eax
80103e2a:	05 00 02 00 00       	add    $0x200,%eax
80103e2f:	39 c2                	cmp    %eax,%edx
80103e31:	74 8e                	je     80103dc1 <pipewrite+0x1f>
        return -1;
      }
      wakeup(&p->nread);
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
80103e36:	8b 80 38 02 00 00    	mov    0x238(%eax),%eax
80103e3c:	8d 48 01             	lea    0x1(%eax),%ecx
80103e3f:	8b 55 08             	mov    0x8(%ebp),%edx
80103e42:	89 8a 38 02 00 00    	mov    %ecx,0x238(%edx)
80103e48:	25 ff 01 00 00       	and    $0x1ff,%eax
80103e4d:	89 c1                	mov    %eax,%ecx
80103e4f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103e52:	8b 45 0c             	mov    0xc(%ebp),%eax
80103e55:	01 d0                	add    %edx,%eax
80103e57:	0f b6 10             	movzbl (%eax),%edx
80103e5a:	8b 45 08             	mov    0x8(%ebp),%eax
80103e5d:	88 54 08 34          	mov    %dl,0x34(%eax,%ecx,1)
pipewrite(struct pipe *p, char *addr, int n)
{
  int i;
  ...
  acquire(&p->lock);
  for(i = 0; i < n; i++){
80103e61:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80103e65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103e68:	3b 45 10             	cmp    0x10(%ebp),%eax
80103e6b:	0f 8c 4e ff ff ff    	jl     80103dbf <pipewrite+0x1d>
      wakeup(&p->nread);
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
    }
    p->data[p->nwrite++ % PIPESIZE] = addr[i];
...
80103e74:	05 34 02 00 00       	add    $0x234,%eax
80103e79:	89 04 24             	mov    %eax,(%esp)
80103e7c:	e8 e6 0a 00 00       	call   80104967 <wakeup>
  release(&p->lock);
80103e81:	8b 45 08             	mov    0x8(%ebp),%eax
80103e84:	89 04 24             	mov    %eax,(%esp)
80103e87:	e8 34 0d 00 00       	call   80104bc0 <release>
  return n;
80103e8c:	8b 45 10             	mov    0x10(%ebp),%eax
}
80103e8f:	c9                   	leave  
80103e90:	c3                   	ret    
...
80103e95:	83 ec 24             	sub    $0x24,%esp
  int i;

  acquire(&p->lock);
80103e98:	8b 45 08             	mov    0x8(%ebp),%eax
80103e9b:	89 04 24             	mov    %eax,(%esp)
80103e9e:	e8 bb 0c 00 00       	call   80104b5e <acquire>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
80103ea3:	eb 3a                	jmp    80103edf <piperead+0x4e>
    if(proc->killed){
80103ea5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80103eab:	8b 40 24             	mov    0x24(%eax),%eax
80103eae:	85 c0                	test   %eax,%eax
80103eb0:	74 15                	je     80103ec7 <piperead+0x36>
      release(&p->lock);
80103eb2:	8b 45 08             	mov    0x8(%ebp),%eax
80103eb5:	89 04 24             	mov    %eax,(%esp)
80103eb8:	e8 03 0d 00 00       	call   80104bc0 <release>
      return -1;
80103ebd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ec2:	e9 b5 00 00 00       	jmp    80103f7c <piperead+0xeb>
    }
    sleep(&p->nread, &p->lock); //DOC: piperead-sleep
80103ec7:	8b 45 08             	mov    0x8(%ebp),%eax
80103eca:	8b 55 08             	mov    0x8(%ebp),%edx
80103ecd:	81 c2 34 02 00 00    	add    $0x234,%edx
80103ed3:	89 44 24 04          	mov    %eax,0x4(%esp)
80103ed7:	89 14 24             	mov    %edx,(%esp)
80103eda:	e8 ac 09 00 00       	call   8010488b <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103ee2:	8b 90 34 02 00 00    	mov    0x234(%eax),%edx
80103ee8:	8b 45 08             	mov    0x8(%ebp),%eax
80103eeb:	8b 80 38 02 00 00    	mov    0x238(%eax),%eax
80103ef1:	39 c2                	cmp    %eax,%edx
80103ef3:	75 0d                	jne    80103f02 <piperead+0x71>
80103ef5:	8b 45 08             	mov    0x8(%ebp),%eax
80103ef8:	8b 80 40 02 00 00    	mov    0x240(%eax),%eax
80103efe:	85 c0                	test   %eax,%eax
80103f00:	75 a3                	jne    80103ea5 <piperead+0x14>
      release(&p->lock);
      return -1;
    }
    sleep(&p->nread, &p->lock); //DOC: piperead-sleep
...
80103f02:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80103f09:	eb 4b                	jmp    80103f56 <piperead+0xc5>
    if(p->nread == p->nwrite)
...
80103f1f:	75 02                	jne    80103f23 <piperead+0x92>
      break;
80103f21:	eb 3b                	jmp    80103f5e <piperead+0xcd>
    addr[i] = p->data[p->nread++ % PIPESIZE];
80103f23:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103f26:	8b 45 0c             	mov    0xc(%ebp),%eax
80103f29:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80103f2c:	8b 45 08             	mov    0x8(%ebp),%eax
80103f2f:	8b 80 34 02 00 00    	mov    0x234(%eax),%eax
80103f35:	8d 48 01             	lea    0x1(%eax),%ecx
80103f38:	8b 55 08             	mov    0x8(%ebp),%edx
80103f3b:	89 8a 34 02 00 00    	mov    %ecx,0x234(%edx)
80103f41:	25 ff 01 00 00       	and    $0x1ff,%eax
80103f46:	89 c2                	mov    %eax,%edx
80103f48:	8b 45 08             	mov    0x8(%ebp),%eax
80103f4b:	0f b6 44 10 34       	movzbl 0x34(%eax,%edx,1),%eax
80103f50:	88 03                	mov    %al,(%ebx)
      release(&p->lock);
      return -1;
    }
    sleep(&p->nread, &p->lock); //DOC: piperead-sleep
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
80103f52:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80103f56:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103f59:	3b 45 10             	cmp    0x10(%ebp),%eax
80103f5c:	7c ad                	jl     80103f0b <piperead+0x7a>
    if(p->nread == p->nwrite)
      break;
    addr[i] = p->data[p->nread++ % PIPESIZE];
  }
...
80103f61:	05 38 02 00 00       	add    $0x238,%eax
80103f66:	89 04 24             	mov    %eax,(%esp)
80103f69:	e8 f9 09 00 00       	call   80104967 <wakeup>
  release(&p->lock);
80103f6e:	8b 45 08             	mov    0x8(%ebp),%eax
80103f71:	89 04 24             	mov    %eax,(%esp)
80103f74:	e8 47 0c 00 00       	call   80104bc0 <release>
  return i;
80103f79:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
80103f7c:	83 c4 24             	add    $0x24,%esp
80103f7f:	5b                   	pop    %ebx
80103f80:	5d                   	pop    %ebp
80103f81:	c3                   	ret    
...
80103f88:	9c                   	pushf  
80103f89:	58                   	pop    %eax
80103f8a:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return eflags;
80103f8d:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80103f90:	c9                   	leave  
80103f91:	c3                   	ret    
...
80103f9e:	c7 44 24 04 61 86 10 	movl   $0x80108661,0x4(%esp)
80103fa5:	80 
80103fa6:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80103fad:	e8 8b 0b 00 00       	call   80104b3d <initlock>
}
80103fb2:	c9                   	leave  
80103fb3:	c3                   	ret    
...
80103fb7:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  char *sp;

  acquire(&ptable.lock);
80103fba:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80103fc1:	e8 98 0b 00 00       	call   80104b5e <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fc6:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
80103fcd:	eb 5d                	jmp    8010402c <allocproc+0x78>
    if(p->state == UNUSED)
80103fcf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103fd2:	8b 40 0c             	mov    0xc(%eax),%eax
80103fd5:	85 c0                	test   %eax,%eax
80103fd7:	75 4c                	jne    80104025 <allocproc+0x71>
      goto found;
80103fd9:	90                   	nop
  release(&ptable.lock);
  return 0;
...
80103fdd:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
  p->pid = nextpid++;
80103fe4:	a1 04 b0 10 80       	mov    0x8010b004,%eax
80103fe9:	8d 50 01             	lea    0x1(%eax),%edx
80103fec:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
80103ff2:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103ff5:	89 42 10             	mov    %eax,0x10(%edx)
  p->allowed_cpu = -1;
80103ff8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103ffb:	c6 80 88 00 00 00 ff 	movb   $0xff,0x88(%eax)
  release(&ptable.lock);
80104002:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104009:	e8 b2 0b 00 00       	call   80104bc0 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
8010400e:	e8 bb ea ff ff       	call   80102ace <kalloc>
80104013:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104016:	89 42 08             	mov    %eax,0x8(%edx)
80104019:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010401c:	8b 40 08             	mov    0x8(%eax),%eax
8010401f:	85 c0                	test   %eax,%eax
80104021:	75 39                	jne    8010405c <allocproc+0xa8>
80104023:	eb 26                	jmp    8010404b <allocproc+0x97>
{
  struct proc *p;
  char *sp;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104025:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
8010402c:	81 7d f4 74 22 11 80 	cmpl   $0x80112274,-0xc(%ebp)
80104033:	72 9a                	jb     80103fcf <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
80104035:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010403c:	e8 7f 0b 00 00       	call   80104bc0 <release>
  return 0;
80104041:	b8 00 00 00 00       	mov    $0x0,%eax
80104046:	e9 83 00 00 00       	jmp    801040ce <allocproc+0x11a>
  p->allowed_cpu = -1;
  release(&ptable.lock);
...
8010404e:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return 0;
80104055:	b8 00 00 00 00       	mov    $0x0,%eax
8010405a:	eb 72                	jmp    801040ce <allocproc+0x11a>
  }
  sp = p->kstack + KSTACKSIZE;
8010405c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010405f:	8b 40 08             	mov    0x8(%eax),%eax
80104062:	05 00 10 00 00       	add    $0x1000,%eax
80104067:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
8010406a:	83 6d f0 4c          	subl   $0x4c,-0x10(%ebp)
  p->tf = (struct trapframe*)sp;
8010406e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104071:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104074:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
80104077:	83 6d f0 04          	subl   $0x4,-0x10(%ebp)
  *(uint*)sp = (uint)trapret;
8010407b:	ba f6 61 10 80       	mov    $0x801061f6,%edx
80104080:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104083:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
80104085:	83 6d f0 14          	subl   $0x14,-0x10(%ebp)
  p->context = (struct context*)sp;
80104089:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010408c:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010408f:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
80104092:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104095:	8b 40 1c             	mov    0x1c(%eax),%eax
80104098:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010409f:	00 
801040a0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801040a7:	00 
801040a8:	89 04 24             	mov    %eax,(%esp)
801040ab:	e8 02 0d 00 00       	call   80104db2 <memset>
  p->context->eip = (uint)forkret;
801040b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040b3:	8b 40 1c             	mov    0x1c(%eax),%eax
801040b6:	ba 5f 48 10 80       	mov    $0x8010485f,%edx
801040bb:	89 50 10             	mov    %edx,0x10(%eax)
  p->shmem_size = 0;
801040be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040c1:	c7 80 84 00 00 00 00 	movl   $0x0,0x84(%eax)
801040c8:	00 00 00 
  return p;
...
801040d3:	83 ec 28             	sub    $0x28,%esp
  ...
  p = allocproc();
801040d6:	e8 d9 fe ff ff       	call   80103fb4 <allocproc>
801040db:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
801040de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040e1:	a3 48 b6 10 80       	mov    %eax,0x8010b648
  if((p->pgdir = setupkvm()) == 0)
801040e6:	e8 42 3a 00 00       	call   80107b2d <setupkvm>
801040eb:	8b 55 f4             	mov    -0xc(%ebp),%edx
801040ee:	89 42 04             	mov    %eax,0x4(%edx)
801040f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040f4:	8b 40 04             	mov    0x4(%eax),%eax
801040f7:	85 c0                	test   %eax,%eax
801040f9:	75 0c                	jne    80104107 <userinit+0x37>
    panic("userinit: out of memory?");
801040fb:	c7 04 24 68 86 10 80 	movl   $0x80108668,(%esp)
80104102:	e8 33 c4 ff ff       	call   8010053a <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80104107:	ba 2c 00 00 00       	mov    $0x2c,%edx
8010410c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010410f:	8b 40 04             	mov    0x4(%eax),%eax
80104112:	89 54 24 08          	mov    %edx,0x8(%esp)
80104116:	c7 44 24 04 e0 b4 10 	movl   $0x8010b4e0,0x4(%esp)
8010411d:	80 
8010411e:	89 04 24             	mov    %eax,(%esp)
80104121:	e8 5f 3c 00 00       	call   80107d85 <inituvm>
  p->sz = PGSIZE;
80104126:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104129:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
8010412f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104132:	8b 40 18             	mov    0x18(%eax),%eax
80104135:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
8010413c:	00 
8010413d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104144:	00 
80104145:	89 04 24             	mov    %eax,(%esp)
80104148:	e8 65 0c 00 00       	call   80104db2 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010414d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104150:	8b 40 18             	mov    0x18(%eax),%eax
80104153:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80104159:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010415c:	8b 40 18             	mov    0x18(%eax),%eax
8010415f:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
80104165:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104168:	8b 40 18             	mov    0x18(%eax),%eax
8010416b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010416e:	8b 52 18             	mov    0x18(%edx),%edx
80104171:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104175:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80104179:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010417c:	8b 40 18             	mov    0x18(%eax),%eax
8010417f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104182:	8b 52 18             	mov    0x18(%edx),%edx
80104185:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104189:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
8010418d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104190:	8b 40 18             	mov    0x18(%eax),%eax
80104193:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
8010419a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010419d:	8b 40 18             	mov    0x18(%eax),%eax
801041a0:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
801041a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041aa:	8b 40 18             	mov    0x18(%eax),%eax
801041ad:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
801041b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041b7:	83 c0 6c             	add    $0x6c,%eax
801041ba:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801041c1:	00 
801041c2:	c7 44 24 04 81 86 10 	movl   $0x80108681,0x4(%esp)
801041c9:	80 
801041ca:	89 04 24             	mov    %eax,(%esp)
801041cd:	e8 00 0e 00 00       	call   80104fd2 <safestrcpy>
  p->cwd = namei("/");
801041d2:	c7 04 24 8a 86 10 80 	movl   $0x8010868a,(%esp)
801041d9:	e8 14 e2 ff ff       	call   801023f2 <namei>
801041de:	8b 55 f4             	mov    -0xc(%ebp),%edx
801041e1:	89 42 68             	mov    %eax,0x68(%edx)
...
801041fe:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
80104201:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104205:	7e 34                	jle    8010423b <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
80104207:	8b 55 08             	mov    0x8(%ebp),%edx
8010420a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010420d:	01 c2                	add    %eax,%edx
8010420f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104215:	8b 40 04             	mov    0x4(%eax),%eax
80104218:	89 54 24 08          	mov    %edx,0x8(%esp)
8010421c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010421f:	89 54 24 04          	mov    %edx,0x4(%esp)
80104223:	89 04 24             	mov    %eax,(%esp)
80104226:	e8 d0 3c 00 00       	call   80107efb <allocuvm>
8010422b:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010422e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104232:	75 41                	jne    80104275 <growproc+0x85>
      return -1;
80104234:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104239:	eb 58                	jmp    80104293 <growproc+0xa3>
  } else if(n < 0){
8010423b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010423f:	79 34                	jns    80104275 <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
80104241:	8b 55 08             	mov    0x8(%ebp),%edx
80104244:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104247:	01 c2                	add    %eax,%edx
80104249:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010424f:	8b 40 04             	mov    0x4(%eax),%eax
80104252:	89 54 24 08          	mov    %edx,0x8(%esp)
80104256:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104259:	89 54 24 04          	mov    %edx,0x4(%esp)
8010425d:	89 04 24             	mov    %eax,(%esp)
80104260:	e8 70 3d 00 00       	call   80107fd5 <deallocuvm>
80104265:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104268:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010426c:	75 07                	jne    80104275 <growproc+0x85>
      return -1;
8010426e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104273:	eb 1e                	jmp    80104293 <growproc+0xa3>
  }
  proc->sz = sz;
80104275:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010427b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010427e:	89 10                	mov    %edx,(%eax)
  switchuvm(proc);
80104280:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104286:	89 04 24             	mov    %eax,(%esp)
80104289:	e8 90 39 00 00       	call   80107c1e <switchuvm>
  return 0;
...
8010429b:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
8010429e:	e8 11 fd ff ff       	call   80103fb4 <allocproc>
801042a3:	89 45 e0             	mov    %eax,-0x20(%ebp)
801042a6:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801042aa:	75 0a                	jne    801042b6 <fork+0x21>
    return -1;
801042ac:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801042b1:	e9 3a 01 00 00       	jmp    801043f0 <fork+0x15b>

  // Copy process state from p.
  if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){
801042b6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801042bc:	8b 10                	mov    (%eax),%edx
801042be:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801042c4:	8b 40 04             	mov    0x4(%eax),%eax
801042c7:	89 54 24 04          	mov    %edx,0x4(%esp)
801042cb:	89 04 24             	mov    %eax,(%esp)
801042ce:	e8 9e 3e 00 00       	call   80108171 <copyuvm>
801042d3:	8b 55 e0             	mov    -0x20(%ebp),%edx
801042d6:	89 42 04             	mov    %eax,0x4(%edx)
801042d9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801042dc:	8b 40 04             	mov    0x4(%eax),%eax
801042df:	85 c0                	test   %eax,%eax
801042e1:	75 2c                	jne    8010430f <fork+0x7a>
    kfree(np->kstack);
801042e3:	8b 45 e0             	mov    -0x20(%ebp),%eax
801042e6:	8b 40 08             	mov    0x8(%eax),%eax
801042e9:	89 04 24             	mov    %eax,(%esp)
801042ec:	e8 44 e7 ff ff       	call   80102a35 <kfree>
    np->kstack = 0;
801042f1:	8b 45 e0             	mov    -0x20(%ebp),%eax
801042f4:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
801042fb:	8b 45 e0             	mov    -0x20(%ebp),%eax
801042fe:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return -1;
80104305:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010430a:	e9 e1 00 00 00       	jmp    801043f0 <fork+0x15b>
  }
  np->sz = proc->sz;
8010430f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104315:	8b 10                	mov    (%eax),%edx
80104317:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010431a:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
8010431c:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104323:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104326:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
80104329:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010432c:	8b 50 18             	mov    0x18(%eax),%edx
8010432f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104335:	8b 40 18             	mov    0x18(%eax),%eax
80104338:	89 c3                	mov    %eax,%ebx
8010433a:	b8 13 00 00 00       	mov    $0x13,%eax
8010433f:	89 d7                	mov    %edx,%edi
80104341:	89 de                	mov    %ebx,%esi
80104343:	89 c1                	mov    %eax,%ecx
80104345:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
...
8010434d:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
80104354:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010435b:	eb 3d                	jmp    8010439a <fork+0x105>
    if(proc->ofile[i])
8010435d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104363:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104366:	83 c2 08             	add    $0x8,%edx
80104369:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010436d:	85 c0                	test   %eax,%eax
8010436f:	74 25                	je     80104396 <fork+0x101>
      np->ofile[i] = filedup(proc->ofile[i]);
80104371:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104377:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010437a:	83 c2 08             	add    $0x8,%edx
8010437d:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104381:	89 04 24             	mov    %eax,(%esp)
80104384:	e8 e9 cb ff ff       	call   80100f72 <filedup>
80104389:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010438c:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010438f:	83 c1 08             	add    $0x8,%ecx
80104392:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  /* np->startaddr = proc->startaddr; */
  ...
  for(i = 0; i < NOFILE; i++)
80104396:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
8010439a:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
8010439e:	7e bd                	jle    8010435d <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
801043a0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043a6:	8b 40 68             	mov    0x68(%eax),%eax
801043a9:	89 04 24             	mov    %eax,(%esp)
801043ac:	e8 64 d4 ff ff       	call   80101815 <idup>
801043b1:	8b 55 e0             	mov    -0x20(%ebp),%edx
801043b4:	89 42 68             	mov    %eax,0x68(%edx)
 
  pid = np->pid;
801043b7:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043ba:	8b 40 10             	mov    0x10(%eax),%eax
801043bd:	89 45 dc             	mov    %eax,-0x24(%ebp)
  np->state = RUNNABLE;
801043c0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043c3:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  safestrcpy(np->name, proc->name, sizeof(proc->name));
801043ca:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043d0:	8d 50 6c             	lea    0x6c(%eax),%edx
801043d3:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043d6:	83 c0 6c             	add    $0x6c,%eax
801043d9:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801043e0:	00 
801043e1:	89 54 24 04          	mov    %edx,0x4(%esp)
801043e5:	89 04 24             	mov    %eax,(%esp)
801043e8:	e8 e5 0b 00 00       	call   80104fd2 <safestrcpy>
  return pid;
801043ed:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
801043f0:	83 c4 2c             	add    $0x2c,%esp
801043f3:	5b                   	pop    %ebx
801043f4:	5e                   	pop    %esi
801043f5:	5f                   	pop    %edi
801043f6:	5d                   	pop    %ebp
...
801043fe:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  
  acquire(&ptable.lock);
80104405:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010440c:	e8 4d 07 00 00       	call   80104b5e <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104411:	c7 45 f0 74 ff 10 80 	movl   $0x8010ff74,-0x10(%ebp)
80104418:	eb 26                	jmp    80104440 <shmemowner+0x48>
    
    if(p->state == UNUSED)
8010441a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010441d:	8b 40 0c             	mov    0xc(%eax),%eax
80104420:	85 c0                	test   %eax,%eax
80104422:	75 02                	jne    80104426 <shmemowner+0x2e>
      continue;
80104424:	eb 13                	jmp    80104439 <shmemowner+0x41>
    
    if (p->shmem_tok == token) {
80104426:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104429:	8b 40 7c             	mov    0x7c(%eax),%eax
8010442c:	3b 45 08             	cmp    0x8(%ebp),%eax
8010442f:	75 08                	jne    80104439 <shmemowner+0x41>
      owner = p;
80104431:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104434:	89 45 f4             	mov    %eax,-0xc(%ebp)
      break;
80104437:	eb 10                	jmp    80104449 <shmemowner+0x51>
struct proc*
shmemowner(uint token) {
  struct proc *owner = (void*) 0, *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104439:	81 45 f0 8c 00 00 00 	addl   $0x8c,-0x10(%ebp)
80104440:	81 7d f0 74 22 11 80 	cmpl   $0x80112274,-0x10(%ebp)
80104447:	72 d1                	jb     8010441a <shmemowner+0x22>
    if (p->shmem_tok == token) {
      owner = p;
      break;
    }
  ...
  release(&ptable.lock);
80104449:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104450:	e8 6b 07 00 00       	call   80104bc0 <release>
  return owner;
...
80104467:	a1 48 b6 10 80       	mov    0x8010b648,%eax
8010446c:	39 c2                	cmp    %eax,%edx
8010446e:	75 0c                	jne    8010447c <exit+0x22>
    panic("init exiting");
80104470:	c7 04 24 8c 86 10 80 	movl   $0x8010868c,(%esp)
80104477:	e8 be c0 ff ff       	call   8010053a <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
8010447c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104483:	eb 44                	jmp    801044c9 <exit+0x6f>
    if(proc->ofile[fd]){
80104485:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010448b:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010448e:	83 c2 08             	add    $0x8,%edx
80104491:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104495:	85 c0                	test   %eax,%eax
80104497:	74 2c                	je     801044c5 <exit+0x6b>
...
801044c4:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
801044c5:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
801044c9:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
801044cd:	7e b6                	jle    80104485 <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
...
801044d5:	8b 40 68             	mov    0x68(%eax),%eax
801044d8:	89 04 24             	mov    %eax,(%esp)
801044db:	e8 1a d5 ff ff       	call   801019fa <iput>
  proc->cwd = 0;
801044e0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044e6:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
801044ed:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801044f4:	e8 65 06 00 00       	call   80104b5e <acquire>
...
80104505:	e8 1c 04 00 00       	call   80104926 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010450a:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
80104511:	eb 3b                	jmp    8010454e <exit+0xf4>
    if(p->parent == proc){
80104513:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104516:	8b 50 14             	mov    0x14(%eax),%edx
80104519:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010451f:	39 c2                	cmp    %eax,%edx
80104521:	75 24                	jne    80104547 <exit+0xed>
      p->parent = initproc;
80104523:	8b 15 48 b6 10 80    	mov    0x8010b648,%edx
80104529:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010452c:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
8010452f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104532:	8b 40 0c             	mov    0xc(%eax),%eax
80104535:	83 f8 05             	cmp    $0x5,%eax
80104538:	75 0d                	jne    80104547 <exit+0xed>
        wakeup1(initproc);
8010453a:	a1 48 b6 10 80       	mov    0x8010b648,%eax
8010453f:	89 04 24             	mov    %eax,(%esp)
80104542:	e8 df 03 00 00       	call   80104926 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104547:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
8010454e:	81 7d f4 74 22 11 80 	cmpl   $0x80112274,-0xc(%ebp)
80104555:	72 bc                	jb     80104513 <exit+0xb9>
        wakeup1(initproc);
    }
  }
...
8010455d:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104564:	e8 12 02 00 00       	call   8010477b <sched>
  panic("zombie exit");
80104569:	c7 04 24 99 86 10 80 	movl   $0x80108699,(%esp)
80104570:	e8 c5 bf ff ff       	call   8010053a <panic>
...
80104578:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
8010457b:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104582:	e8 d7 05 00 00       	call   80104b5e <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104587:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010458e:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
80104595:	e9 9d 00 00 00       	jmp    80104637 <wait+0xc2>
      if(p->parent != proc)
8010459a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010459d:	8b 50 14             	mov    0x14(%eax),%edx
801045a0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045a6:	39 c2                	cmp    %eax,%edx
801045a8:	74 05                	je     801045af <wait+0x3a>
        continue;
801045aa:	e9 81 00 00 00       	jmp    80104630 <wait+0xbb>
      havekids = 1;
801045af:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
801045b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045b9:	8b 40 0c             	mov    0xc(%eax),%eax
801045bc:	83 f8 05             	cmp    $0x5,%eax
801045bf:	75 6f                	jne    80104630 <wait+0xbb>
        // Found one.
        pid = p->pid;
801045c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045c4:	8b 40 10             	mov    0x10(%eax),%eax
801045c7:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
801045ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045cd:	8b 40 08             	mov    0x8(%eax),%eax
801045d0:	89 04 24             	mov    %eax,(%esp)
801045d3:	e8 5d e4 ff ff       	call   80102a35 <kfree>
        p->kstack = 0;
801045d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045db:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        freevm(p->pgdir);
801045e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045e5:	8b 40 04             	mov    0x4(%eax),%eax
801045e8:	89 04 24             	mov    %eax,(%esp)
801045eb:	e8 a1 3a 00 00       	call   80108091 <freevm>
        p->state = UNUSED;
801045f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045f3:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
801045fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045fd:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104604:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104607:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
8010460e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104611:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
80104615:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104618:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
8010461f:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104626:	e8 95 05 00 00       	call   80104bc0 <release>
        return pid;
8010462b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010462e:	eb 55                	jmp    80104685 <wait+0x110>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104630:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
80104637:	81 7d f4 74 22 11 80 	cmpl   $0x80112274,-0xc(%ebp)
8010463e:	0f 82 56 ff ff ff    	jb     8010459a <wait+0x25>
        return pid;
      }
    }
...
80104644:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104648:	74 0d                	je     80104657 <wait+0xe2>
8010464a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104650:	8b 40 24             	mov    0x24(%eax),%eax
80104653:	85 c0                	test   %eax,%eax
80104655:	74 13                	je     8010466a <wait+0xf5>
      release(&ptable.lock);
80104657:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010465e:	e8 5d 05 00 00       	call   80104bc0 <release>
      return -1;
80104663:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104668:	eb 1b                	jmp    80104685 <wait+0x110>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
8010466a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104670:	c7 44 24 04 40 ff 10 	movl   $0x8010ff40,0x4(%esp)
80104677:	80 
80104678:	89 04 24             	mov    %eax,(%esp)
8010467b:	e8 0b 02 00 00       	call   8010488b <sleep>
  }
80104680:	e9 02 ff ff ff       	jmp    80104587 <wait+0x12>
}
80104685:	c9                   	leave  
80104686:	c3                   	ret    
...
8010468a:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  for(;;){
    // Enable interrupts on this processor.
    sti();
8010468d:	e8 00 f9 ff ff       	call   80103f92 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104692:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104699:	e8 c0 04 00 00       	call   80104b5e <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010469e:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
801046a5:	e9 b3 00 00 00       	jmp    8010475d <scheduler+0xd6>
      if(p->state != RUNNABLE)
801046aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046ad:	8b 40 0c             	mov    0xc(%eax),%eax
801046b0:	83 f8 03             	cmp    $0x3,%eax
801046b3:	74 05                	je     801046ba <scheduler+0x33>
        continue;
801046b5:	e9 9c 00 00 00       	jmp    80104756 <scheduler+0xcf>
...
801046bd:	0f b6 80 88 00 00 00 	movzbl 0x88(%eax),%eax
801046c4:	84 c0                	test   %al,%al
801046c6:	78 1f                	js     801046e7 <scheduler+0x60>
801046c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046cb:	0f b6 80 88 00 00 00 	movzbl 0x88(%eax),%eax
801046d2:	0f be d0             	movsbl %al,%edx
801046d5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801046db:	0f b6 00             	movzbl (%eax),%eax
801046de:	0f b6 c0             	movzbl %al,%eax
801046e1:	39 c2                	cmp    %eax,%edx
801046e3:	75 02                	jne    801046e7 <scheduler+0x60>
801046e5:	eb 10                	jmp    801046f7 <scheduler+0x70>
        //cprintf("\n Processing prod %d, at cpu %d", p->pid, cpu->id);
      } else if (p->allowed_cpu > -1) {
801046e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046ea:	0f b6 80 88 00 00 00 	movzbl 0x88(%eax),%eax
801046f1:	84 c0                	test   %al,%al
801046f3:	78 02                	js     801046f7 <scheduler+0x70>
        //cprintf("\nSkipping proc %d at cpu %d, proc->allowed_cpu %d", p->pid, cpu->id, p->allowed_cpu);
          continue;
801046f5:	eb 5f                	jmp    80104756 <scheduler+0xcf>
      }

rerun:
      proc = p;
801046f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046fa:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104700:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104703:	89 04 24             	mov    %eax,(%esp)
80104706:	e8 13 35 00 00       	call   80107c1e <switchuvm>
      p->state = RUNNING;
8010470b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010470e:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
80104715:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010471b:	8b 40 1c             	mov    0x1c(%eax),%eax
8010471e:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104725:	83 c2 04             	add    $0x4,%edx
80104728:	89 44 24 04          	mov    %eax,0x4(%esp)
8010472c:	89 14 24             	mov    %edx,(%esp)
8010472f:	e8 0f 09 00 00       	call   80105043 <swtch>
      switchkvm();
80104734:	e8 c8 34 00 00       	call   80107c01 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      if (cpu->preempt_disable_count > 0) {
80104739:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010473f:	8b 80 bc 00 00 00    	mov    0xbc(%eax),%eax
80104745:	85 c0                	test   %eax,%eax
80104747:	74 02                	je     8010474b <scheduler+0xc4>
          // Go back and reschedule the same process
          goto rerun;
80104749:	eb ac                	jmp    801046f7 <scheduler+0x70>
      }
      proc = 0;
8010474b:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104752:	00 00 00 00 
    // Enable interrupts on this processor.
    sti();
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104756:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
8010475d:	81 7d f4 74 22 11 80 	cmpl   $0x80112274,-0xc(%ebp)
80104764:	0f 82 40 ff ff ff    	jb     801046aa <scheduler+0x23>
          goto rerun;
      }
      proc = 0;
    ...
    release(&ptable.lock);
8010476a:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104771:	e8 4a 04 00 00       	call   80104bc0 <release>

  }
80104776:	e9 12 ff ff ff       	jmp    8010468d <scheduler+0x6>
...
8010477e:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
80104781:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104788:	e8 fb 04 00 00       	call   80104c88 <holding>
8010478d:	85 c0                	test   %eax,%eax
8010478f:	75 0c                	jne    8010479d <sched+0x22>
    panic("sched ptable.lock");
80104791:	c7 04 24 a5 86 10 80 	movl   $0x801086a5,(%esp)
80104798:	e8 9d bd ff ff       	call   8010053a <panic>
  if(cpu->ncli != 1)
8010479d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801047a3:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801047a9:	83 f8 01             	cmp    $0x1,%eax
801047ac:	74 0c                	je     801047ba <sched+0x3f>
    panic("sched locks");
801047ae:	c7 04 24 b7 86 10 80 	movl   $0x801086b7,(%esp)
801047b5:	e8 80 bd ff ff       	call   8010053a <panic>
  if(proc->state == RUNNING)
801047ba:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047c0:	8b 40 0c             	mov    0xc(%eax),%eax
801047c3:	83 f8 04             	cmp    $0x4,%eax
801047c6:	75 0c                	jne    801047d4 <sched+0x59>
    panic("sched running");
801047c8:	c7 04 24 c3 86 10 80 	movl   $0x801086c3,(%esp)
801047cf:	e8 66 bd ff ff       	call   8010053a <panic>
  if(readeflags()&FL_IF)
801047d4:	e8 a9 f7 ff ff       	call   80103f82 <readeflags>
801047d9:	25 00 02 00 00       	and    $0x200,%eax
801047de:	85 c0                	test   %eax,%eax
801047e0:	74 0c                	je     801047ee <sched+0x73>
    panic("sched interruptible");
801047e2:	c7 04 24 d1 86 10 80 	movl   $0x801086d1,(%esp)
801047e9:	e8 4c bd ff ff       	call   8010053a <panic>
  intena = cpu->intena;
801047ee:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801047f4:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801047fa:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
801047fd:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104803:	8b 40 04             	mov    0x4(%eax),%eax
80104806:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010480d:	83 c2 1c             	add    $0x1c,%edx
80104810:	89 44 24 04          	mov    %eax,0x4(%esp)
80104814:	89 14 24             	mov    %edx,(%esp)
80104817:	e8 27 08 00 00       	call   80105043 <swtch>
  cpu->intena = intena;
8010481c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104822:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104825:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
8010482b:	c9                   	leave  
8010482c:	c3                   	ret    
...
80104833:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010483a:	e8 1f 03 00 00       	call   80104b5e <acquire>
  proc->state = RUNNABLE;
8010483f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104845:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
8010484c:	e8 2a ff ff ff       	call   8010477b <sched>
  release(&ptable.lock);
80104851:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104858:	e8 63 03 00 00       	call   80104bc0 <release>
}
8010485d:	c9                   	leave  
8010485e:	c3                   	ret    
...
80104862:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104865:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010486c:	e8 4f 03 00 00       	call   80104bc0 <release>

  if (first) {
80104871:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80104876:	85 c0                	test   %eax,%eax
80104878:	74 0f                	je     80104889 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
8010487a:	c7 05 08 b0 10 80 00 	movl   $0x0,0x8010b008
80104881:	00 00 00 
    initlog();
80104884:	e8 3a e7 ff ff       	call   80102fc3 <initlog>
  }
...
8010488e:	83 ec 18             	sub    $0x18,%esp
  if(proc == 0)
80104891:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104897:	85 c0                	test   %eax,%eax
80104899:	75 0c                	jne    801048a7 <sleep+0x1c>
    panic("sleep");
8010489b:	c7 04 24 e5 86 10 80 	movl   $0x801086e5,(%esp)
801048a2:	e8 93 bc ff ff       	call   8010053a <panic>

  if(lk == 0)
801048a7:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801048ab:	75 0c                	jne    801048b9 <sleep+0x2e>
    panic("sleep without lk");
801048ad:	c7 04 24 eb 86 10 80 	movl   $0x801086eb,(%esp)
...
801048b9:	81 7d 0c 40 ff 10 80 	cmpl   $0x8010ff40,0xc(%ebp)
801048c0:	74 17                	je     801048d9 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
801048c2:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801048c9:	e8 90 02 00 00       	call   80104b5e <acquire>
    release(lk);
801048ce:	8b 45 0c             	mov    0xc(%ebp),%eax
801048d1:	89 04 24             	mov    %eax,(%esp)
801048d4:	e8 e7 02 00 00       	call   80104bc0 <release>
  }

  // Go to sleep.
  proc->chan = chan;
801048d9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048df:	8b 55 08             	mov    0x8(%ebp),%edx
801048e2:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
801048e5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048eb:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
801048f2:	e8 84 fe ff ff       	call   8010477b <sched>

  // Tidy up.
  proc->chan = 0;
801048f7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048fd:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104904:	81 7d 0c 40 ff 10 80 	cmpl   $0x8010ff40,0xc(%ebp)
8010490b:	74 17                	je     80104924 <sleep+0x99>
    release(&ptable.lock);
8010490d:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104914:	e8 a7 02 00 00       	call   80104bc0 <release>
    acquire(lk);
80104919:	8b 45 0c             	mov    0xc(%ebp),%eax
8010491c:	89 04 24             	mov    %eax,(%esp)
8010491f:	e8 3a 02 00 00       	call   80104b5e <acquire>
  }
}
80104924:	c9                   	leave  
80104925:	c3                   	ret    
...
80104929:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010492c:	c7 45 fc 74 ff 10 80 	movl   $0x8010ff74,-0x4(%ebp)
80104933:	eb 27                	jmp    8010495c <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
80104935:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104938:	8b 40 0c             	mov    0xc(%eax),%eax
8010493b:	83 f8 02             	cmp    $0x2,%eax
8010493e:	75 15                	jne    80104955 <wakeup1+0x2f>
80104940:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104943:	8b 40 20             	mov    0x20(%eax),%eax
80104946:	3b 45 08             	cmp    0x8(%ebp),%eax
80104949:	75 0a                	jne    80104955 <wakeup1+0x2f>
      p->state = RUNNABLE;
8010494b:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010494e:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104955:	81 45 fc 8c 00 00 00 	addl   $0x8c,-0x4(%ebp)
8010495c:	81 7d fc 74 22 11 80 	cmpl   $0x80112274,-0x4(%ebp)
80104963:	72 d0                	jb     80104935 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80104965:	c9                   	leave  
...
8010496a:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
8010496d:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104974:	e8 e5 01 00 00       	call   80104b5e <acquire>
  wakeup1(chan);
80104979:	8b 45 08             	mov    0x8(%ebp),%eax
8010497c:	89 04 24             	mov    %eax,(%esp)
8010497f:	e8 a2 ff ff ff       	call   80104926 <wakeup1>
  release(&ptable.lock);
80104984:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010498b:	e8 30 02 00 00       	call   80104bc0 <release>
}
80104990:	c9                   	leave  
80104991:	c3                   	ret    
...
8010499f:	e8 ba 01 00 00       	call   80104b5e <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049a4:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
801049ab:	eb 44                	jmp    801049f1 <kill+0x5f>
    if(p->pid == pid){
801049ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049b0:	8b 40 10             	mov    0x10(%eax),%eax
801049b3:	3b 45 08             	cmp    0x8(%ebp),%eax
801049b6:	75 32                	jne    801049ea <kill+0x58>
      p->killed = 1;
801049b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049bb:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
801049c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049c5:	8b 40 0c             	mov    0xc(%eax),%eax
801049c8:	83 f8 02             	cmp    $0x2,%eax
801049cb:	75 0a                	jne    801049d7 <kill+0x45>
        p->state = RUNNABLE;
801049cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049d0:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
801049d7:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801049de:	e8 dd 01 00 00       	call   80104bc0 <release>
      return 0;
801049e3:	b8 00 00 00 00       	mov    $0x0,%eax
801049e8:	eb 21                	jmp    80104a0b <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049ea:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
801049f1:	81 7d f4 74 22 11 80 	cmpl   $0x80112274,-0xc(%ebp)
801049f8:	72 b3                	jb     801049ad <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
801049fa:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104a01:	e8 ba 01 00 00       	call   80104bc0 <release>
  return -1;
...
80104a10:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a13:	c7 45 f0 74 ff 10 80 	movl   $0x8010ff74,-0x10(%ebp)
80104a1a:	e9 d9 00 00 00       	jmp    80104af8 <procdump+0xeb>
    if(p->state == UNUSED)
80104a1f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a22:	8b 40 0c             	mov    0xc(%eax),%eax
80104a25:	85 c0                	test   %eax,%eax
80104a27:	75 05                	jne    80104a2e <procdump+0x21>
      continue;
80104a29:	e9 c3 00 00 00       	jmp    80104af1 <procdump+0xe4>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104a2e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a31:	8b 40 0c             	mov    0xc(%eax),%eax
80104a34:	83 f8 05             	cmp    $0x5,%eax
80104a37:	77 23                	ja     80104a5c <procdump+0x4f>
80104a39:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a3c:	8b 40 0c             	mov    0xc(%eax),%eax
80104a3f:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104a46:	85 c0                	test   %eax,%eax
80104a48:	74 12                	je     80104a5c <procdump+0x4f>
      state = states[p->state];
80104a4a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a4d:	8b 40 0c             	mov    0xc(%eax),%eax
80104a50:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104a57:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104a5a:	eb 07                	jmp    80104a63 <procdump+0x56>
    else
      state = "???";
80104a5c:	c7 45 ec fc 86 10 80 	movl   $0x801086fc,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104a63:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a66:	8d 50 6c             	lea    0x6c(%eax),%edx
80104a69:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a6c:	8b 40 10             	mov    0x10(%eax),%eax
80104a6f:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104a73:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104a76:	89 54 24 08          	mov    %edx,0x8(%esp)
80104a7a:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a7e:	c7 04 24 00 87 10 80 	movl   $0x80108700,(%esp)
80104a85:	e8 16 b9 ff ff       	call   801003a0 <cprintf>
    if(p->state == SLEEPING){
80104a8a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a8d:	8b 40 0c             	mov    0xc(%eax),%eax
80104a90:	83 f8 02             	cmp    $0x2,%eax
80104a93:	75 50                	jne    80104ae5 <procdump+0xd8>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104a95:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a98:	8b 40 1c             	mov    0x1c(%eax),%eax
80104a9b:	8b 40 0c             	mov    0xc(%eax),%eax
80104a9e:	83 c0 08             	add    $0x8,%eax
80104aa1:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104aa4:	89 54 24 04          	mov    %edx,0x4(%esp)
80104aa8:	89 04 24             	mov    %eax,(%esp)
80104aab:	e8 5f 01 00 00       	call   80104c0f <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104ab0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104ab7:	eb 1b                	jmp    80104ad4 <procdump+0xc7>
        cprintf(" %p", pc[i]);
80104ab9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104abc:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104ac0:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ac4:	c7 04 24 09 87 10 80 	movl   $0x80108709,(%esp)
80104acb:	e8 d0 b8 ff ff       	call   801003a0 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104ad0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104ad4:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104ad8:	7f 0b                	jg     80104ae5 <procdump+0xd8>
80104ada:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104add:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104ae1:	85 c0                	test   %eax,%eax
80104ae3:	75 d4                	jne    80104ab9 <procdump+0xac>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104ae5:	c7 04 24 0d 87 10 80 	movl   $0x8010870d,(%esp)
80104aec:	e8 af b8 ff ff       	call   801003a0 <cprintf>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104af1:	81 45 f0 8c 00 00 00 	addl   $0x8c,-0x10(%ebp)
80104af8:	81 7d f0 74 22 11 80 	cmpl   $0x80112274,-0x10(%ebp)
80104aff:	0f 82 1a ff ff ff    	jb     80104a1f <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104b0d:	9c                   	pushf  
80104b0e:	58                   	pop    %eax
80104b0f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return eflags;
80104b12:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80104b15:	c9                   	leave  
80104b16:	c3                   	ret    
...
80104b26:	83 ec 10             	sub    $0x10,%esp
  uint result;
...
80104b32:	f0 87 02             	lock xchg %eax,(%edx)
...
80104b64:	e8 49 01 00 00       	call   80104cb2 <pushcli>
  if(holding(lk))
80104b69:	8b 45 08             	mov    0x8(%ebp),%eax
80104b6c:	89 04 24             	mov    %eax,(%esp)
80104b6f:	e8 14 01 00 00       	call   80104c88 <holding>
80104b74:	85 c0                	test   %eax,%eax
80104b76:	74 0c                	je     80104b84 <acquire+0x26>
    panic("acquire");
80104b78:	c7 04 24 39 87 10 80 	movl   $0x80108739,(%esp)
80104b7f:	e8 b6 b9 ff ff       	call   8010053a <panic>
...
80104b88:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104b8f:	00 
80104b90:	89 04 24             	mov    %eax,(%esp)
80104b93:	e8 8b ff ff ff       	call   80104b23 <xchg>
80104b98:	85 c0                	test   %eax,%eax
80104b9a:	75 e9                	jne    80104b85 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104b9c:	8b 45 08             	mov    0x8(%ebp),%eax
80104b9f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104ba6:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104ba9:	8b 45 08             	mov    0x8(%ebp),%eax
80104bac:	83 c0 0c             	add    $0xc,%eax
80104baf:	89 44 24 04          	mov    %eax,0x4(%esp)
80104bb3:	8d 45 08             	lea    0x8(%ebp),%eax
80104bb6:	89 04 24             	mov    %eax,(%esp)
80104bb9:	e8 51 00 00 00       	call   80104c0f <getcallerpcs>
}
80104bbe:	c9                   	leave  
80104bbf:	c3                   	ret    
...
80104bcc:	e8 b7 00 00 00       	call   80104c88 <holding>
80104bd1:	85 c0                	test   %eax,%eax
80104bd3:	75 0c                	jne    80104be1 <release+0x21>
    panic("release");
80104bd5:	c7 04 24 41 87 10 80 	movl   $0x80108741,(%esp)
80104bdc:	e8 59 b9 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80104be1:	8b 45 08             	mov    0x8(%ebp),%eax
80104be4:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
...
80104bf8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104bff:	00 
80104c00:	89 04 24             	mov    %eax,(%esp)
80104c03:	e8 1b ff ff ff       	call   80104b23 <xchg>
...
80104cb5:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80104cb8:	e8 4a fe ff ff       	call   80104b07 <readeflags>
80104cbd:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104cc0:	e8 52 fe ff ff       	call   80104b17 <cli>
  if(cpu->ncli++ == 0)
...
80104cf9:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80104cfc:	e8 06 fe ff ff       	call   80104b07 <readeflags>
80104d01:	25 00 02 00 00       	and    $0x200,%eax
80104d06:	85 c0                	test   %eax,%eax
80104d08:	74 0c                	je     80104d16 <popcli+0x20>
    panic("popcli - interruptible");
80104d0a:	c7 04 24 49 87 10 80 	movl   $0x80108749,(%esp)
80104d11:	e8 24 b8 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
80104d16:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104d1c:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104d22:	83 ea 01             	sub    $0x1,%edx
80104d25:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104d2b:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104d31:	85 c0                	test   %eax,%eax
80104d33:	79 0c                	jns    80104d41 <popcli+0x4b>
    panic("popcli");
80104d35:	c7 04 24 60 87 10 80 	movl   $0x80108760,(%esp)
80104d3c:	e8 f9 b7 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
80104d41:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104d47:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104d4d:	85 c0                	test   %eax,%eax
80104d4f:	75 15                	jne    80104d66 <popcli+0x70>
80104d51:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104d57:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104d5d:	85 c0                	test   %eax,%eax
80104d5f:	74 05                	je     80104d66 <popcli+0x70>
    sti();
80104d61:	e8 b7 fd ff ff       	call   80104b1d <sti>
}
80104d66:	c9                   	leave  
80104d67:	c3                   	ret    
...
80104d6b:	57                   	push   %edi
80104d6c:	53                   	push   %ebx
  asm volatile("cld; rep stosb" :
80104d6d:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104d70:	8b 55 10             	mov    0x10(%ebp),%edx
80104d73:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d76:	89 cb                	mov    %ecx,%ebx
80104d78:	89 df                	mov    %ebx,%edi
80104d7a:	89 d1                	mov    %edx,%ecx
80104d7c:	fc                   	cld    
80104d7d:	f3 aa                	rep stos %al,%es:(%edi)
80104d7f:	89 ca                	mov    %ecx,%edx
80104d81:	89 fb                	mov    %edi,%ebx
80104d83:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80104d92:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104d95:	8b 55 10             	mov    0x10(%ebp),%edx
80104d98:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d9b:	89 cb                	mov    %ecx,%ebx
80104d9d:	89 df                	mov    %ebx,%edi
80104d9f:	89 d1                	mov    %edx,%ecx
80104da1:	fc                   	cld    
80104da2:	f3 ab                	rep stos %eax,%es:(%edi)
80104da4:	89 ca                	mov    %ecx,%edx
80104da6:	89 fb                	mov    %edi,%ebx
80104da8:	89 5d 08             	mov    %ebx,0x8(%ebp)
80104dab:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80104dbb:	83 e0 03             	and    $0x3,%eax
80104dbe:	85 c0                	test   %eax,%eax
80104dc0:	75 49                	jne    80104e0b <memset+0x59>
80104dc2:	8b 45 10             	mov    0x10(%ebp),%eax
80104dc5:	83 e0 03             	and    $0x3,%eax
80104dc8:	85 c0                	test   %eax,%eax
80104dca:	75 3f                	jne    80104e0b <memset+0x59>
    c &= 0xFF;
80104dcc:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104dd3:	8b 45 10             	mov    0x10(%ebp),%eax
80104dd6:	c1 e8 02             	shr    $0x2,%eax
80104dd9:	89 c2                	mov    %eax,%edx
80104ddb:	8b 45 0c             	mov    0xc(%ebp),%eax
80104dde:	c1 e0 18             	shl    $0x18,%eax
80104de1:	89 c1                	mov    %eax,%ecx
80104de3:	8b 45 0c             	mov    0xc(%ebp),%eax
80104de6:	c1 e0 10             	shl    $0x10,%eax
80104de9:	09 c1                	or     %eax,%ecx
80104deb:	8b 45 0c             	mov    0xc(%ebp),%eax
80104dee:	c1 e0 08             	shl    $0x8,%eax
80104df1:	09 c8                	or     %ecx,%eax
80104df3:	0b 45 0c             	or     0xc(%ebp),%eax
80104df6:	89 54 24 08          	mov    %edx,0x8(%esp)
80104dfa:	89 44 24 04          	mov    %eax,0x4(%esp)
80104dfe:	8b 45 08             	mov    0x8(%ebp),%eax
80104e01:	89 04 24             	mov    %eax,(%esp)
80104e04:	e8 84 ff ff ff       	call   80104d8d <stosl>
80104e09:	eb 19                	jmp    80104e24 <memset+0x72>
  } else
    stosb(dst, c, n);
80104e0b:	8b 45 10             	mov    0x10(%ebp),%eax
80104e0e:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80104e1f:	e8 44 ff ff ff       	call   80104d68 <stosb>
  return dst;
...
80104e38:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80104e3b:	eb 30                	jmp    80104e6d <memcmp+0x44>
    if(*s1 != *s2)
...
80104e4b:	74 18                	je     80104e65 <memcmp+0x3c>
      return *s1 - *s2;
...
80104e63:	eb 1a                	jmp    80104e7f <memcmp+0x56>
    s1++, s2++;
...
80104e78:	75 c3                	jne    80104e3d <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80104e90:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
80104e93:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104e96:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80104e99:	73 3d                	jae    80104ed8 <memmove+0x57>
80104e9b:	8b 45 10             	mov    0x10(%ebp),%eax
80104e9e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104ea1:	01 d0                	add    %edx,%eax
80104ea3:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80104ea6:	76 30                	jbe    80104ed8 <memmove+0x57>
    s += n;
80104ea8:	8b 45 10             	mov    0x10(%ebp),%eax
80104eab:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80104eae:	8b 45 10             	mov    0x10(%ebp),%eax
80104eb1:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80104eb4:	eb 13                	jmp    80104ec9 <memmove+0x48>
      *--d = *--s;
80104eb6:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
...
80104ed4:	75 e0                	jne    80104eb6 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104ed6:	eb 26                	jmp    80104efe <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80104ed8:	eb 17                	jmp    80104ef1 <memmove+0x70>
      *d++ = *s++;
80104eda:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104edd:	8d 50 01             	lea    0x1(%eax),%edx
80104ee0:	89 55 f8             	mov    %edx,-0x8(%ebp)
80104ee3:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104ee6:	8d 4a 01             	lea    0x1(%edx),%ecx
80104ee9:	89 4d fc             	mov    %ecx,-0x4(%ebp)
80104eec:	0f b6 12             	movzbl (%edx),%edx
80104eef:	88 10                	mov    %dl,(%eax)
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80104ef1:	8b 45 10             	mov    0x10(%ebp),%eax
80104ef4:	8d 50 ff             	lea    -0x1(%eax),%edx
80104ef7:	89 55 10             	mov    %edx,0x10(%ebp)
80104efa:	85 c0                	test   %eax,%eax
80104efc:	75 dc                	jne    80104eda <memmove+0x59>
      *d++ = *s++;
...
80104f1d:	e8 5f ff ff ff       	call   80104e81 <memmove>
}
80104f22:	c9                   	leave  
80104f23:	c3                   	ret    
...
80104f25:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80104f27:	eb 0c                	jmp    80104f35 <strncmp+0x11>
    n--, p++, q++;
80104f29:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104f2d:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80104f31:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
  while(n > 0 && *p && *p == *q)
80104f35:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104f39:	74 1a                	je     80104f55 <strncmp+0x31>
80104f3b:	8b 45 08             	mov    0x8(%ebp),%eax
80104f3e:	0f b6 00             	movzbl (%eax),%eax
80104f41:	84 c0                	test   %al,%al
80104f43:	74 10                	je     80104f55 <strncmp+0x31>
80104f45:	8b 45 08             	mov    0x8(%ebp),%eax
80104f48:	0f b6 10             	movzbl (%eax),%edx
80104f4b:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f4e:	0f b6 00             	movzbl (%eax),%eax
80104f51:	38 c2                	cmp    %al,%dl
80104f53:	74 d4                	je     80104f29 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
80104f55:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104f59:	75 07                	jne    80104f62 <strncmp+0x3e>
    return 0;
80104f5b:	b8 00 00 00 00       	mov    $0x0,%eax
80104f60:	eb 16                	jmp    80104f78 <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
80104f62:	8b 45 08             	mov    0x8(%ebp),%eax
80104f65:	0f b6 00             	movzbl (%eax),%eax
80104f68:	0f b6 d0             	movzbl %al,%edx
80104f6b:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f6e:	0f b6 00             	movzbl (%eax),%eax
80104f71:	0f b6 c0             	movzbl %al,%eax
80104f74:	29 c2                	sub    %eax,%edx
...
80104f8a:	8d 50 ff             	lea    -0x1(%eax),%edx
80104f8d:	89 55 10             	mov    %edx,0x10(%ebp)
80104f90:	85 c0                	test   %eax,%eax
80104f92:	7e 1e                	jle    80104fb2 <strncpy+0x38>
80104f94:	8b 45 08             	mov    0x8(%ebp),%eax
80104f97:	8d 50 01             	lea    0x1(%eax),%edx
80104f9a:	89 55 08             	mov    %edx,0x8(%ebp)
80104f9d:	8b 55 0c             	mov    0xc(%ebp),%edx
80104fa0:	8d 4a 01             	lea    0x1(%edx),%ecx
80104fa3:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80104fa6:	0f b6 12             	movzbl (%edx),%edx
80104fa9:	88 10                	mov    %dl,(%eax)
80104fab:	0f b6 00             	movzbl (%eax),%eax
80104fae:	84 c0                	test   %al,%al
80104fb0:	75 d5                	jne    80104f87 <strncpy+0xd>
    ;
  while(n-- > 0)
80104fb2:	eb 0c                	jmp    80104fc0 <strncpy+0x46>
    *s++ = 0;
80104fb4:	8b 45 08             	mov    0x8(%ebp),%eax
80104fb7:	8d 50 01             	lea    0x1(%eax),%edx
80104fba:	89 55 08             	mov    %edx,0x8(%ebp)
80104fbd:	c6 00 00             	movb   $0x0,(%eax)
  char *os;
...
80104fc3:	8d 50 ff             	lea    -0x1(%eax),%edx
80104fc6:	89 55 10             	mov    %edx,0x10(%ebp)
80104fc9:	85 c0                	test   %eax,%eax
80104fcb:	7f e7                	jg     80104fb4 <strncpy+0x3a>
    *s++ = 0;
  return os;
...
80104fdb:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80104fde:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104fe2:	7f 05                	jg     80104fe9 <safestrcpy+0x17>
    return os;
80104fe4:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104fe7:	eb 31                	jmp    8010501a <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
80104fe9:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104fed:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104ff1:	7e 1e                	jle    80105011 <safestrcpy+0x3f>
80104ff3:	8b 45 08             	mov    0x8(%ebp),%eax
80104ff6:	8d 50 01             	lea    0x1(%eax),%edx
80104ff9:	89 55 08             	mov    %edx,0x8(%ebp)
80104ffc:	8b 55 0c             	mov    0xc(%ebp),%edx
80104fff:	8d 4a 01             	lea    0x1(%edx),%ecx
80105002:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105005:	0f b6 12             	movzbl (%edx),%edx
80105008:	88 10                	mov    %dl,(%eax)
8010500a:	0f b6 00             	movzbl (%eax),%eax
8010500d:	84 c0                	test   %al,%al
8010500f:	75 d8                	jne    80104fe9 <safestrcpy+0x17>
    ;
  *s = 0;
...
8010509e:	8b 00                	mov    (%eax),%eax
801050a0:	3b 45 08             	cmp    0x8(%ebp),%eax
801050a3:	77 07                	ja     801050ac <fetchstr+0x1a>
    return -1;
801050a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050aa:	eb 46                	jmp    801050f2 <fetchstr+0x60>
  *pp = (char*)addr;
801050ac:	8b 55 08             	mov    0x8(%ebp),%edx
...
801050df:	eb 11                	jmp    801050f2 <fetchstr+0x60>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
801050e1:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801050e5:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050e8:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801050eb:	72 dc                	jb     801050c9 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
8010510e:	8d 50 04             	lea    0x4(%eax),%edx
80105111:	8b 45 0c             	mov    0xc(%ebp),%eax
80105114:	89 44 24 04          	mov    %eax,0x4(%esp)
80105118:	89 14 24             	mov    %edx,(%esp)
8010511b:	e8 38 ff ff ff       	call   80105058 <fetchint>
}
80105120:	c9                   	leave  
80105121:	c3                   	ret    
...
80105187:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
8010518a:	8d 45 fc             	lea    -0x4(%ebp),%eax
8010518d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105191:	8b 45 08             	mov    0x8(%ebp),%eax
80105194:	89 04 24             	mov    %eax,(%esp)
80105197:	e8 58 ff ff ff       	call   801050f4 <argint>
8010519c:	85 c0                	test   %eax,%eax
8010519e:	79 07                	jns    801051a7 <argstr+0x23>
    return -1;
801051a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801051a5:	eb 12                	jmp    801051b9 <argstr+0x35>
  return fetchstr(addr, pp);
801051a7:	8b 45 fc             	mov    -0x4(%ebp),%eax
801051aa:	8b 55 0c             	mov    0xc(%ebp),%edx
801051ad:	89 54 24 04          	mov    %edx,0x4(%esp)
801051b1:	89 04 24             	mov    %eax,(%esp)
801051b4:	e8 d9 fe ff ff       	call   80105092 <fetchstr>
}
801051b9:	c9                   	leave  
801051ba:	c3                   	ret    
...
801051bf:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
801051c2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051c8:	8b 40 18             	mov    0x18(%eax),%eax
801051cb:	8b 40 1c             	mov    0x1c(%eax),%eax
801051ce:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801051d1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801051d5:	7e 30                	jle    80105207 <syscall+0x4c>
801051d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051da:	83 f8 16             	cmp    $0x16,%eax
801051dd:	77 28                	ja     80105207 <syscall+0x4c>
801051df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051e2:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801051e9:	85 c0                	test   %eax,%eax
801051eb:	74 1a                	je     80105207 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
801051ed:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051f3:	8b 58 18             	mov    0x18(%eax),%ebx
801051f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051f9:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105200:	ff d0                	call   *%eax
80105202:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105205:	eb 3d                	jmp    80105244 <syscall+0x89>
  } else {
...
8010521c:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105220:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105224:	89 44 24 04          	mov    %eax,0x4(%esp)
80105228:	c7 04 24 67 87 10 80 	movl   $0x80108767,(%esp)
8010522f:	e8 6c b1 ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105234:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010523a:	8b 40 18             	mov    0x18(%eax),%eax
8010523d:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105244:	83 c4 24             	add    $0x24,%esp
80105247:	5b                   	pop    %ebx
80105248:	5d                   	pop    %ebp
80105249:	c3                   	ret    
...
8010525d:	e8 92 fe ff ff       	call   801050f4 <argint>
80105262:	85 c0                	test   %eax,%eax
80105264:	79 07                	jns    8010526d <argfd+0x23>
    return -1;
80105266:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010526b:	eb 50                	jmp    801052bd <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
8010526d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105270:	85 c0                	test   %eax,%eax
80105272:	78 21                	js     80105295 <argfd+0x4b>
80105274:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105277:	83 f8 0f             	cmp    $0xf,%eax
8010527a:	7f 19                	jg     80105295 <argfd+0x4b>
8010527c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105282:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105285:	83 c2 08             	add    $0x8,%edx
80105288:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010528c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010528f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105293:	75 07                	jne    8010529c <argfd+0x52>
    return -1;
80105295:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010529a:	eb 21                	jmp    801052bd <argfd+0x73>
  if(pfd)
8010529c:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801052a0:	74 08                	je     801052aa <argfd+0x60>
    *pfd = fd;
801052a2:	8b 55 f0             	mov    -0x10(%ebp),%edx
801052a5:	8b 45 0c             	mov    0xc(%ebp),%eax
801052a8:	89 10                	mov    %edx,(%eax)
  if(pf)
801052aa:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801052ae:	74 08                	je     801052b8 <argfd+0x6e>
    *pf = f;
801052b0:	8b 45 10             	mov    0x10(%ebp),%eax
801052b3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801052b6:	89 10                	mov    %edx,(%eax)
  return 0;
801052b8:	b8 00 00 00 00       	mov    $0x0,%eax
}
801052bd:	c9                   	leave  
801052be:	c3                   	ret    
...
801052c2:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
801052c5:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801052cc:	eb 30                	jmp    801052fe <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
801052ce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052d4:	8b 55 fc             	mov    -0x4(%ebp),%edx
801052d7:	83 c2 08             	add    $0x8,%edx
801052da:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801052de:	85 c0                	test   %eax,%eax
801052e0:	75 18                	jne    801052fa <fdalloc+0x3b>
      proc->ofile[fd] = f;
801052e2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052e8:	8b 55 fc             	mov    -0x4(%ebp),%edx
801052eb:	8d 4a 08             	lea    0x8(%edx),%ecx
801052ee:	8b 55 08             	mov    0x8(%ebp),%edx
801052f1:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
801052f5:	8b 45 fc             	mov    -0x4(%ebp),%eax
801052f8:	eb 0f                	jmp    80105309 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
801052fa:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801052fe:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105302:	7e ca                	jle    801052ce <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
8010530e:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argfd(0, 0, &f) < 0)
80105311:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105314:	89 44 24 08          	mov    %eax,0x8(%esp)
80105318:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010531f:	00 
80105320:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105327:	e8 1e ff ff ff       	call   8010524a <argfd>
8010532c:	85 c0                	test   %eax,%eax
8010532e:	79 07                	jns    80105337 <sys_dup+0x2c>
    return -1;
80105330:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105335:	eb 29                	jmp    80105360 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105337:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010533a:	89 04 24             	mov    %eax,(%esp)
8010533d:	e8 7d ff ff ff       	call   801052bf <fdalloc>
80105342:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105345:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105349:	79 07                	jns    80105352 <sys_dup+0x47>
    return -1;
8010534b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105350:	eb 0e                	jmp    80105360 <sys_dup+0x55>
  filedup(f);
80105352:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105355:	89 04 24             	mov    %eax,(%esp)
80105358:	e8 15 bc ff ff       	call   80100f72 <filedup>
  return fd;
...
8010536f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105376:	00 
80105377:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010537e:	e8 c7 fe ff ff       	call   8010524a <argfd>
80105383:	85 c0                	test   %eax,%eax
80105385:	78 35                	js     801053bc <sys_read+0x5a>
80105387:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010538a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010538e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105395:	e8 5a fd ff ff       	call   801050f4 <argint>
8010539a:	85 c0                	test   %eax,%eax
8010539c:	78 1e                	js     801053bc <sys_read+0x5a>
8010539e:	8b 45 f0             	mov    -0x10(%ebp),%eax
801053a1:	89 44 24 08          	mov    %eax,0x8(%esp)
801053a5:	8d 45 ec             	lea    -0x14(%ebp),%eax
801053a8:	89 44 24 04          	mov    %eax,0x4(%esp)
801053ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801053b3:	e8 6a fd ff ff       	call   80105122 <argptr>
801053b8:	85 c0                	test   %eax,%eax
801053ba:	79 07                	jns    801053c3 <sys_read+0x61>
    return -1;
801053bc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053c1:	eb 19                	jmp    801053dc <sys_read+0x7a>
  return fileread(f, p, n);
801053c3:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801053c6:	8b 55 ec             	mov    -0x14(%ebp),%edx
801053c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053cc:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801053d0:	89 54 24 04          	mov    %edx,0x4(%esp)
801053d4:	89 04 24             	mov    %eax,(%esp)
801053d7:	e8 03 bd ff ff       	call   801010df <fileread>
}
801053dc:	c9                   	leave  
801053dd:	c3                   	ret    
...
801053e1:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
801053e7:	89 44 24 08          	mov    %eax,0x8(%esp)
801053eb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801053f2:	00 
801053f3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801053fa:	e8 4b fe ff ff       	call   8010524a <argfd>
801053ff:	85 c0                	test   %eax,%eax
80105401:	78 35                	js     80105438 <sys_write+0x5a>
80105403:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105406:	89 44 24 04          	mov    %eax,0x4(%esp)
8010540a:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105411:	e8 de fc ff ff       	call   801050f4 <argint>
80105416:	85 c0                	test   %eax,%eax
80105418:	78 1e                	js     80105438 <sys_write+0x5a>
8010541a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010541d:	89 44 24 08          	mov    %eax,0x8(%esp)
80105421:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105424:	89 44 24 04          	mov    %eax,0x4(%esp)
80105428:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010542f:	e8 ee fc ff ff       	call   80105122 <argptr>
80105434:	85 c0                	test   %eax,%eax
80105436:	79 07                	jns    8010543f <sys_write+0x61>
    return -1;
80105438:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010543d:	eb 19                	jmp    80105458 <sys_write+0x7a>
  return filewrite(f, p, n);
8010543f:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105442:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105445:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105448:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010544c:	89 54 24 04          	mov    %edx,0x4(%esp)
80105450:	89 04 24             	mov    %eax,(%esp)
80105453:	e8 43 bd ff ff       	call   8010119b <filewrite>
}
80105458:	c9                   	leave  
80105459:	c3                   	ret    
...
80105463:	89 44 24 08          	mov    %eax,0x8(%esp)
80105467:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010546a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010546e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105475:	e8 d0 fd ff ff       	call   8010524a <argfd>
8010547a:	85 c0                	test   %eax,%eax
8010547c:	79 07                	jns    80105485 <sys_close+0x2b>
    return -1;
8010547e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105483:	eb 24                	jmp    801054a9 <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105485:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010548b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010548e:	83 c2 08             	add    $0x8,%edx
80105491:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105498:	00 
  fileclose(f);
80105499:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010549c:	89 04 24             	mov    %eax,(%esp)
8010549f:	e8 16 bb ff ff       	call   80100fba <fileclose>
  return 0;
...
801054ae:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;
  
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
801054b1:	8d 45 f4             	lea    -0xc(%ebp),%eax
801054b4:	89 44 24 08          	mov    %eax,0x8(%esp)
801054b8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801054bf:	00 
801054c0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801054c7:	e8 7e fd ff ff       	call   8010524a <argfd>
801054cc:	85 c0                	test   %eax,%eax
801054ce:	78 1f                	js     801054ef <sys_fstat+0x44>
801054d0:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801054d7:	00 
801054d8:	8d 45 f0             	lea    -0x10(%ebp),%eax
801054db:	89 44 24 04          	mov    %eax,0x4(%esp)
801054df:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801054e6:	e8 37 fc ff ff       	call   80105122 <argptr>
801054eb:	85 c0                	test   %eax,%eax
801054ed:	79 07                	jns    801054f6 <sys_fstat+0x4b>
    return -1;
801054ef:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054f4:	eb 12                	jmp    80105508 <sys_fstat+0x5d>
  return filestat(f, st);
801054f6:	8b 55 f0             	mov    -0x10(%ebp),%edx
801054f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054fc:	89 54 24 04          	mov    %edx,0x4(%esp)
80105500:	89 04 24             	mov    %eax,(%esp)
80105503:	e8 88 bb ff ff       	call   80101090 <filestat>
}
80105508:	c9                   	leave  
80105509:	c3                   	ret    
...
8010550d:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105510:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105513:	89 44 24 04          	mov    %eax,0x4(%esp)
80105517:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010551e:	e8 61 fc ff ff       	call   80105184 <argstr>
80105523:	85 c0                	test   %eax,%eax
80105525:	78 17                	js     8010553e <sys_link+0x34>
80105527:	8d 45 dc             	lea    -0x24(%ebp),%eax
8010552a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010552e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105535:	e8 4a fc ff ff       	call   80105184 <argstr>
8010553a:	85 c0                	test   %eax,%eax
8010553c:	79 0a                	jns    80105548 <sys_link+0x3e>
    return -1;
8010553e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105543:	e9 3d 01 00 00       	jmp    80105685 <sys_link+0x17b>
  if((ip = namei(old)) == 0)
80105548:	8b 45 d8             	mov    -0x28(%ebp),%eax
8010554b:	89 04 24             	mov    %eax,(%esp)
8010554e:	e8 9f ce ff ff       	call   801023f2 <namei>
...
80105561:	e9 1f 01 00 00       	jmp    80105685 <sys_link+0x17b>

  begin_trans();
80105566:	e8 66 dc ff ff       	call   801031d1 <begin_trans>

  ilock(ip);
8010556b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010556e:	89 04 24             	mov    %eax,(%esp)
80105571:	e8 d1 c2 ff ff       	call   80101847 <ilock>
  if(ip->type == T_DIR){
80105576:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105579:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010557d:	66 83 f8 01          	cmp    $0x1,%ax
80105581:	75 1a                	jne    8010559d <sys_link+0x93>
    iunlockput(ip);
80105583:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105586:	89 04 24             	mov    %eax,(%esp)
80105589:	e8 3d c5 ff ff       	call   80101acb <iunlockput>
    commit_trans();
8010558e:	e8 87 dc ff ff       	call   8010321a <commit_trans>
    return -1;
80105593:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105598:	e9 e8 00 00 00       	jmp    80105685 <sys_link+0x17b>
  }

  ip->nlink++;
8010559d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055a0:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801055a4:	8d 50 01             	lea    0x1(%eax),%edx
801055a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055aa:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801055ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055b1:	89 04 24             	mov    %eax,(%esp)
801055b4:	e8 d2 c0 ff ff       	call   8010168b <iupdate>
  iunlock(ip);
801055b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055bc:	89 04 24             	mov    %eax,(%esp)
801055bf:	e8 d1 c3 ff ff       	call   80101995 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
801055c4:	8b 45 dc             	mov    -0x24(%ebp),%eax
801055c7:	8d 55 e2             	lea    -0x1e(%ebp),%edx
801055ca:	89 54 24 04          	mov    %edx,0x4(%esp)
801055ce:	89 04 24             	mov    %eax,(%esp)
801055d1:	e8 3e ce ff ff       	call   80102414 <nameiparent>
801055d6:	89 45 f0             	mov    %eax,-0x10(%ebp)
801055d9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801055dd:	75 02                	jne    801055e1 <sys_link+0xd7>
    goto bad;
801055df:	eb 68                	jmp    80105649 <sys_link+0x13f>
  ilock(dp);
801055e1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055e4:	89 04 24             	mov    %eax,(%esp)
801055e7:	e8 5b c2 ff ff       	call   80101847 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801055ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055ef:	8b 10                	mov    (%eax),%edx
801055f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055f4:	8b 00                	mov    (%eax),%eax
801055f6:	39 c2                	cmp    %eax,%edx
801055f8:	75 20                	jne    8010561a <sys_link+0x110>
801055fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055fd:	8b 40 04             	mov    0x4(%eax),%eax
80105600:	89 44 24 08          	mov    %eax,0x8(%esp)
80105604:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105607:	89 44 24 04          	mov    %eax,0x4(%esp)
8010560b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010560e:	89 04 24             	mov    %eax,(%esp)
80105611:	e8 1c cb ff ff       	call   80102132 <dirlink>
80105616:	85 c0                	test   %eax,%eax
80105618:	79 0d                	jns    80105627 <sys_link+0x11d>
    iunlockput(dp);
8010561a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010561d:	89 04 24             	mov    %eax,(%esp)
80105620:	e8 a6 c4 ff ff       	call   80101acb <iunlockput>
    goto bad;
80105625:	eb 22                	jmp    80105649 <sys_link+0x13f>
  }
  iunlockput(dp);
80105627:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010562a:	89 04 24             	mov    %eax,(%esp)
8010562d:	e8 99 c4 ff ff       	call   80101acb <iunlockput>
  iput(ip);
80105632:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105635:	89 04 24             	mov    %eax,(%esp)
80105638:	e8 bd c3 ff ff       	call   801019fa <iput>

  commit_trans();
8010563d:	e8 d8 db ff ff       	call   8010321a <commit_trans>

  return 0;
80105642:	b8 00 00 00 00       	mov    $0x0,%eax
80105647:	eb 3c                	jmp    80105685 <sys_link+0x17b>

bad:
  ilock(ip);
80105649:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010564c:	89 04 24             	mov    %eax,(%esp)
8010564f:	e8 f3 c1 ff ff       	call   80101847 <ilock>
  ip->nlink--;
80105654:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105657:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010565b:	8d 50 ff             	lea    -0x1(%eax),%edx
8010565e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105661:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105665:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105668:	89 04 24             	mov    %eax,(%esp)
8010566b:	e8 1b c0 ff ff       	call   8010168b <iupdate>
  iunlockput(ip);
80105670:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105673:	89 04 24             	mov    %eax,(%esp)
80105676:	e8 50 c4 ff ff       	call   80101acb <iunlockput>
  commit_trans();
8010567b:	e8 9a db ff ff       	call   8010321a <commit_trans>
  return -1;
...
8010568d:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105694:	eb 4b                	jmp    801056e1 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105696:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105699:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801056a0:	00 
801056a1:	89 44 24 08          	mov    %eax,0x8(%esp)
801056a5:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801056a8:	89 44 24 04          	mov    %eax,0x4(%esp)
801056ac:	8b 45 08             	mov    0x8(%ebp),%eax
801056af:	89 04 24             	mov    %eax,(%esp)
801056b2:	e8 9d c6 ff ff       	call   80101d54 <readi>
801056b7:	83 f8 10             	cmp    $0x10,%eax
801056ba:	74 0c                	je     801056c8 <isdirempty+0x41>
      panic("isdirempty: readi");
801056bc:	c7 04 24 83 87 10 80 	movl   $0x80108783,(%esp)
801056c3:	e8 72 ae ff ff       	call   8010053a <panic>
    if(de.inum != 0)
801056c8:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
801056cc:	66 85 c0             	test   %ax,%ax
801056cf:	74 07                	je     801056d8 <isdirempty+0x51>
      return 0;
801056d1:	b8 00 00 00 00       	mov    $0x0,%eax
801056d6:	eb 1b                	jmp    801056f3 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
801056db:	83 c0 10             	add    $0x10,%eax
801056de:	89 45 f4             	mov    %eax,-0xc(%ebp)
801056e1:	8b 55 f4             	mov    -0xc(%ebp),%edx
801056e4:	8b 45 08             	mov    0x8(%ebp),%eax
801056e7:	8b 40 18             	mov    0x18(%eax),%eax
801056ea:	39 c2                	cmp    %eax,%edx
801056ec:	72 a8                	jb     80105696 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
801056ee:	b8 01 00 00 00       	mov    $0x1,%eax
}
801056f3:	c9                   	leave  
801056f4:	c3                   	ret    
...
801056f8:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801056fb:	8d 45 cc             	lea    -0x34(%ebp),%eax
801056fe:	89 44 24 04          	mov    %eax,0x4(%esp)
80105702:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105709:	e8 76 fa ff ff       	call   80105184 <argstr>
8010570e:	85 c0                	test   %eax,%eax
80105710:	79 0a                	jns    8010571c <sys_unlink+0x27>
    return -1;
80105712:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105717:	e9 aa 01 00 00       	jmp    801058c6 <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
8010571c:	8b 45 cc             	mov    -0x34(%ebp),%eax
8010571f:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105722:	89 54 24 04          	mov    %edx,0x4(%esp)
80105726:	89 04 24             	mov    %eax,(%esp)
80105729:	e8 e6 cc ff ff       	call   80102414 <nameiparent>
8010572e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105731:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105735:	75 0a                	jne    80105741 <sys_unlink+0x4c>
    return -1;
80105737:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010573c:	e9 85 01 00 00       	jmp    801058c6 <sys_unlink+0x1d1>

  begin_trans();
80105741:	e8 8b da ff ff       	call   801031d1 <begin_trans>

  ilock(dp);
80105746:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105749:	89 04 24             	mov    %eax,(%esp)
8010574c:	e8 f6 c0 ff ff       	call   80101847 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105751:	c7 44 24 04 95 87 10 	movl   $0x80108795,0x4(%esp)
80105758:	80 
80105759:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010575c:	89 04 24             	mov    %eax,(%esp)
8010575f:	e8 e3 c8 ff ff       	call   80102047 <namecmp>
80105764:	85 c0                	test   %eax,%eax
80105766:	0f 84 45 01 00 00    	je     801058b1 <sys_unlink+0x1bc>
8010576c:	c7 44 24 04 97 87 10 	movl   $0x80108797,0x4(%esp)
80105773:	80 
80105774:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105777:	89 04 24             	mov    %eax,(%esp)
8010577a:	e8 c8 c8 ff ff       	call   80102047 <namecmp>
8010577f:	85 c0                	test   %eax,%eax
80105781:	0f 84 2a 01 00 00    	je     801058b1 <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105787:	8d 45 c8             	lea    -0x38(%ebp),%eax
...
8010579b:	e8 c9 c8 ff ff       	call   80102069 <dirlookup>
801057a0:	89 45 f0             	mov    %eax,-0x10(%ebp)
801057a3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801057a7:	75 05                	jne    801057ae <sys_unlink+0xb9>
    goto bad;
801057a9:	e9 03 01 00 00       	jmp    801058b1 <sys_unlink+0x1bc>
  ilock(ip);
801057ae:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057b1:	89 04 24             	mov    %eax,(%esp)
801057b4:	e8 8e c0 ff ff       	call   80101847 <ilock>

  if(ip->nlink < 1)
801057b9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057bc:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801057c0:	66 85 c0             	test   %ax,%ax
801057c3:	7f 0c                	jg     801057d1 <sys_unlink+0xdc>
    panic("unlink: nlink < 1");
801057c5:	c7 04 24 9a 87 10 80 	movl   $0x8010879a,(%esp)
801057cc:	e8 69 ad ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
801057d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057d4:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801057d8:	66 83 f8 01          	cmp    $0x1,%ax
801057dc:	75 1f                	jne    801057fd <sys_unlink+0x108>
801057de:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057e1:	89 04 24             	mov    %eax,(%esp)
801057e4:	e8 9e fe ff ff       	call   80105687 <isdirempty>
801057e9:	85 c0                	test   %eax,%eax
801057eb:	75 10                	jne    801057fd <sys_unlink+0x108>
    iunlockput(ip);
801057ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057f0:	89 04 24             	mov    %eax,(%esp)
801057f3:	e8 d3 c2 ff ff       	call   80101acb <iunlockput>
    goto bad;
801057f8:	e9 b4 00 00 00       	jmp    801058b1 <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
801057fd:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105804:	00 
80105805:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010580c:	00 
8010580d:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105810:	89 04 24             	mov    %eax,(%esp)
80105813:	e8 9a f5 ff ff       	call   80104db2 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105818:	8b 45 c8             	mov    -0x38(%ebp),%eax
...
80105834:	e8 7f c6 ff ff       	call   80101eb8 <writei>
80105839:	83 f8 10             	cmp    $0x10,%eax
8010583c:	74 0c                	je     8010584a <sys_unlink+0x155>
    panic("unlink: writei");
8010583e:	c7 04 24 ac 87 10 80 	movl   $0x801087ac,(%esp)
80105845:	e8 f0 ac ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
8010584a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010584d:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105851:	66 83 f8 01          	cmp    $0x1,%ax
80105855:	75 1c                	jne    80105873 <sys_unlink+0x17e>
    dp->nlink--;
80105857:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010585a:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010585e:	8d 50 ff             	lea    -0x1(%eax),%edx
80105861:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105864:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105868:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010586b:	89 04 24             	mov    %eax,(%esp)
8010586e:	e8 18 be ff ff       	call   8010168b <iupdate>
  }
  iunlockput(dp);
80105873:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105876:	89 04 24             	mov    %eax,(%esp)
80105879:	e8 4d c2 ff ff       	call   80101acb <iunlockput>

  ip->nlink--;
8010587e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105881:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105885:	8d 50 ff             	lea    -0x1(%eax),%edx
80105888:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010588b:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
8010588f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105892:	89 04 24             	mov    %eax,(%esp)
80105895:	e8 f1 bd ff ff       	call   8010168b <iupdate>
  iunlockput(ip);
8010589a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010589d:	89 04 24             	mov    %eax,(%esp)
801058a0:	e8 26 c2 ff ff       	call   80101acb <iunlockput>

  commit_trans();
801058a5:	e8 70 d9 ff ff       	call   8010321a <commit_trans>

  return 0;
801058aa:	b8 00 00 00 00       	mov    $0x0,%eax
801058af:	eb 15                	jmp    801058c6 <sys_unlink+0x1d1>

bad:
  iunlockput(dp);
801058b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058b4:	89 04 24             	mov    %eax,(%esp)
801058b7:	e8 0f c2 ff ff       	call   80101acb <iunlockput>
  commit_trans();
801058bc:	e8 59 d9 ff ff       	call   8010321a <commit_trans>
  return -1;
...
801058cb:	83 ec 48             	sub    $0x48,%esp
801058ce:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801058d1:	8b 55 10             	mov    0x10(%ebp),%edx
801058d4:	8b 45 14             	mov    0x14(%ebp),%eax
801058d7:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
801058db:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
801058df:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
801058e3:	8d 45 de             	lea    -0x22(%ebp),%eax
801058e6:	89 44 24 04          	mov    %eax,0x4(%esp)
801058ea:	8b 45 08             	mov    0x8(%ebp),%eax
801058ed:	89 04 24             	mov    %eax,(%esp)
801058f0:	e8 1f cb ff ff       	call   80102414 <nameiparent>
801058f5:	89 45 f4             	mov    %eax,-0xc(%ebp)
801058f8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801058fc:	75 0a                	jne    80105908 <create+0x40>
    return 0;
801058fe:	b8 00 00 00 00       	mov    $0x0,%eax
80105903:	e9 7e 01 00 00       	jmp    80105a86 <create+0x1be>
  ilock(dp);
80105908:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010590b:	89 04 24             	mov    %eax,(%esp)
8010590e:	e8 34 bf ff ff       	call   80101847 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105913:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105916:	89 44 24 08          	mov    %eax,0x8(%esp)
8010591a:	8d 45 de             	lea    -0x22(%ebp),%eax
8010591d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105921:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105924:	89 04 24             	mov    %eax,(%esp)
80105927:	e8 3d c7 ff ff       	call   80102069 <dirlookup>
8010592c:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010592f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105933:	74 47                	je     8010597c <create+0xb4>
    iunlockput(dp);
80105935:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105938:	89 04 24             	mov    %eax,(%esp)
8010593b:	e8 8b c1 ff ff       	call   80101acb <iunlockput>
    ilock(ip);
80105940:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105943:	89 04 24             	mov    %eax,(%esp)
80105946:	e8 fc be ff ff       	call   80101847 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010594b:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105950:	75 15                	jne    80105967 <create+0x9f>
80105952:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105955:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105959:	66 83 f8 02          	cmp    $0x2,%ax
8010595d:	75 08                	jne    80105967 <create+0x9f>
      return ip;
8010595f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105962:	e9 1f 01 00 00       	jmp    80105a86 <create+0x1be>
    iunlockput(ip);
80105967:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010596a:	89 04 24             	mov    %eax,(%esp)
8010596d:	e8 59 c1 ff ff       	call   80101acb <iunlockput>
    return 0;
80105972:	b8 00 00 00 00       	mov    $0x0,%eax
80105977:	e9 0a 01 00 00       	jmp    80105a86 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
8010597c:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105980:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105983:	8b 00                	mov    (%eax),%eax
80105985:	89 54 24 04          	mov    %edx,0x4(%esp)
80105989:	89 04 24             	mov    %eax,(%esp)
8010598c:	e8 1b bc ff ff       	call   801015ac <ialloc>
80105991:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105994:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105998:	75 0c                	jne    801059a6 <create+0xde>
    panic("create: ialloc");
8010599a:	c7 04 24 bb 87 10 80 	movl   $0x801087bb,(%esp)
801059a1:	e8 94 ab ff ff       	call   8010053a <panic>

  ilock(ip);
801059a6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059a9:	89 04 24             	mov    %eax,(%esp)
801059ac:	e8 96 be ff ff       	call   80101847 <ilock>
  ip->major = major;
801059b1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059b4:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
801059b8:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
801059bc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059bf:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
801059c3:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
801059c7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059ca:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
801059d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059d3:	89 04 24             	mov    %eax,(%esp)
801059d6:	e8 b0 bc ff ff       	call   8010168b <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
801059db:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
801059e0:	75 6a                	jne    80105a4c <create+0x184>
    dp->nlink++;  // for ".."
801059e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059e5:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801059e9:	8d 50 01             	lea    0x1(%eax),%edx
801059ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059ef:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
801059f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059f6:	89 04 24             	mov    %eax,(%esp)
801059f9:	e8 8d bc ff ff       	call   8010168b <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801059fe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a01:	8b 40 04             	mov    0x4(%eax),%eax
80105a04:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a08:	c7 44 24 04 95 87 10 	movl   $0x80108795,0x4(%esp)
80105a0f:	80 
80105a10:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a13:	89 04 24             	mov    %eax,(%esp)
80105a16:	e8 17 c7 ff ff       	call   80102132 <dirlink>
80105a1b:	85 c0                	test   %eax,%eax
80105a1d:	78 21                	js     80105a40 <create+0x178>
80105a1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a22:	8b 40 04             	mov    0x4(%eax),%eax
80105a25:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a29:	c7 44 24 04 97 87 10 	movl   $0x80108797,0x4(%esp)
80105a30:	80 
80105a31:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a34:	89 04 24             	mov    %eax,(%esp)
80105a37:	e8 f6 c6 ff ff       	call   80102132 <dirlink>
80105a3c:	85 c0                	test   %eax,%eax
80105a3e:	79 0c                	jns    80105a4c <create+0x184>
      panic("create dots");
80105a40:	c7 04 24 ca 87 10 80 	movl   $0x801087ca,(%esp)
...
80105a52:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a56:	8d 45 de             	lea    -0x22(%ebp),%eax
80105a59:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a60:	89 04 24             	mov    %eax,(%esp)
80105a63:	e8 ca c6 ff ff       	call   80102132 <dirlink>
80105a68:	85 c0                	test   %eax,%eax
80105a6a:	79 0c                	jns    80105a78 <create+0x1b0>
    panic("create: dirlink");
80105a6c:	c7 04 24 d6 87 10 80 	movl   $0x801087d6,(%esp)
80105a73:	e8 c2 aa ff ff       	call   8010053a <panic>

  iunlockput(dp);
80105a78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a7b:	89 04 24             	mov    %eax,(%esp)
80105a7e:	e8 48 c0 ff ff       	call   80101acb <iunlockput>
...
80105a8b:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105a8e:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105a91:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a95:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a9c:	e8 e3 f6 ff ff       	call   80105184 <argstr>
80105aa1:	85 c0                	test   %eax,%eax
80105aa3:	78 17                	js     80105abc <sys_open+0x34>
80105aa5:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105aa8:	89 44 24 04          	mov    %eax,0x4(%esp)
80105aac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105ab3:	e8 3c f6 ff ff       	call   801050f4 <argint>
80105ab8:	85 c0                	test   %eax,%eax
80105aba:	79 0a                	jns    80105ac6 <sys_open+0x3e>
    return -1;
80105abc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ac1:	e9 48 01 00 00       	jmp    80105c0e <sys_open+0x186>
  if(omode & O_CREATE){
80105ac6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ac9:	25 00 02 00 00       	and    $0x200,%eax
80105ace:	85 c0                	test   %eax,%eax
80105ad0:	74 40                	je     80105b12 <sys_open+0x8a>
    begin_trans();
80105ad2:	e8 fa d6 ff ff       	call   801031d1 <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80105ad7:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105ada:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105ae1:	00 
80105ae2:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105ae9:	00 
80105aea:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105af1:	00 
80105af2:	89 04 24             	mov    %eax,(%esp)
80105af5:	e8 ce fd ff ff       	call   801058c8 <create>
80105afa:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80105afd:	e8 18 d7 ff ff       	call   8010321a <commit_trans>
    if(ip == 0)
80105b02:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105b06:	75 5c                	jne    80105b64 <sys_open+0xdc>
      return -1;
80105b08:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b0d:	e9 fc 00 00 00       	jmp    80105c0e <sys_open+0x186>
  } else {
    if((ip = namei(path)) == 0)
80105b12:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105b15:	89 04 24             	mov    %eax,(%esp)
80105b18:	e8 d5 c8 ff ff       	call   801023f2 <namei>
80105b1d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105b20:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105b24:	75 0a                	jne    80105b30 <sys_open+0xa8>
      return -1;
80105b26:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b2b:	e9 de 00 00 00       	jmp    80105c0e <sys_open+0x186>
    ilock(ip);
80105b30:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b33:	89 04 24             	mov    %eax,(%esp)
80105b36:	e8 0c bd ff ff       	call   80101847 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105b3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b3e:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b42:	66 83 f8 01          	cmp    $0x1,%ax
80105b46:	75 1c                	jne    80105b64 <sys_open+0xdc>
80105b48:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105b4b:	85 c0                	test   %eax,%eax
80105b4d:	74 15                	je     80105b64 <sys_open+0xdc>
      iunlockput(ip);
80105b4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b52:	89 04 24             	mov    %eax,(%esp)
80105b55:	e8 71 bf ff ff       	call   80101acb <iunlockput>
      return -1;
80105b5a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b5f:	e9 aa 00 00 00       	jmp    80105c0e <sys_open+0x186>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105b64:	e8 a9 b3 ff ff       	call   80100f12 <filealloc>
80105b69:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105b6c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b70:	74 14                	je     80105b86 <sys_open+0xfe>
80105b72:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b75:	89 04 24             	mov    %eax,(%esp)
80105b78:	e8 42 f7 ff ff       	call   801052bf <fdalloc>
80105b7d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105b80:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105b84:	79 23                	jns    80105ba9 <sys_open+0x121>
    if(f)
80105b86:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b8a:	74 0b                	je     80105b97 <sys_open+0x10f>
      fileclose(f);
80105b8c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b8f:	89 04 24             	mov    %eax,(%esp)
80105b92:	e8 23 b4 ff ff       	call   80100fba <fileclose>
    iunlockput(ip);
80105b97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b9a:	89 04 24             	mov    %eax,(%esp)
80105b9d:	e8 29 bf ff ff       	call   80101acb <iunlockput>
    return -1;
80105ba2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ba7:	eb 65                	jmp    80105c0e <sys_open+0x186>
  }
  iunlock(ip);
80105ba9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bac:	89 04 24             	mov    %eax,(%esp)
80105baf:	e8 e1 bd ff ff       	call   80101995 <iunlock>

  f->type = FD_INODE;
80105bb4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bb7:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105bbd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bc0:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105bc3:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105bc6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bc9:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105bd0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105bd3:	83 e0 01             	and    $0x1,%eax
80105bd6:	85 c0                	test   %eax,%eax
80105bd8:	0f 94 c0             	sete   %al
80105bdb:	89 c2                	mov    %eax,%edx
80105bdd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105be0:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105be3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105be6:	83 e0 01             	and    $0x1,%eax
80105be9:	85 c0                	test   %eax,%eax
80105beb:	75 0a                	jne    80105bf7 <sys_open+0x16f>
80105bed:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105bf0:	83 e0 02             	and    $0x2,%eax
80105bf3:	85 c0                	test   %eax,%eax
80105bf5:	74 07                	je     80105bfe <sys_open+0x176>
80105bf7:	b8 01 00 00 00       	mov    $0x1,%eax
80105bfc:	eb 05                	jmp    80105c03 <sys_open+0x17b>
80105bfe:	b8 00 00 00 00       	mov    $0x0,%eax
80105c03:	89 c2                	mov    %eax,%edx
80105c05:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c08:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
80105c13:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
80105c16:	e8 b6 d5 ff ff       	call   801031d1 <begin_trans>
...
80105c29:	e8 56 f5 ff ff       	call   80105184 <argstr>
80105c2e:	85 c0                	test   %eax,%eax
80105c30:	78 2c                	js     80105c5e <sys_mkdir+0x4e>
80105c32:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c35:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105c3c:	00 
80105c3d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105c44:	00 
80105c45:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105c4c:	00 
80105c4d:	89 04 24             	mov    %eax,(%esp)
80105c50:	e8 73 fc ff ff       	call   801058c8 <create>
80105c55:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c58:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c5c:	75 0c                	jne    80105c6a <sys_mkdir+0x5a>
    commit_trans();
80105c5e:	e8 b7 d5 ff ff       	call   8010321a <commit_trans>
    return -1;
80105c63:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c68:	eb 15                	jmp    80105c7f <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80105c6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c6d:	89 04 24             	mov    %eax,(%esp)
80105c70:	e8 56 be ff ff       	call   80101acb <iunlockput>
  commit_trans();
80105c75:	e8 a0 d5 ff ff       	call   8010321a <commit_trans>
  return 0;
80105c7a:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105c7f:	c9                   	leave  
80105c80:	c3                   	ret    
...
80105c84:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
...
80105cbd:	78 47                	js     80105d06 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105cbf:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105cc2:	89 44 24 04          	mov    %eax,0x4(%esp)
80105cc6:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105ccd:	e8 22 f4 ff ff       	call   801050f4 <argint>
  int len;
  int major, minor;
...
80105cd4:	78 30                	js     80105d06 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80105cd6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105cd9:	0f bf c8             	movswl %ax,%ecx
80105cdc:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105cdf:	0f bf d0             	movswl %ax,%edx
80105ce2:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105ce5:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80105ce9:	89 54 24 08          	mov    %edx,0x8(%esp)
80105ced:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80105cf4:	00 
80105cf5:	89 04 24             	mov    %eax,(%esp)
80105cf8:	e8 cb fb ff ff       	call   801058c8 <create>
80105cfd:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105d00:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d04:	75 0c                	jne    80105d12 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
80105d06:	e8 0f d5 ff ff       	call   8010321a <commit_trans>
    return -1;
80105d0b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d10:	eb 15                	jmp    80105d27 <sys_mknod+0xa6>
  }
  iunlockput(ip);
80105d12:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d15:	89 04 24             	mov    %eax,(%esp)
80105d18:	e8 ae bd ff ff       	call   80101acb <iunlockput>
  commit_trans();
80105d1d:	e8 f8 d4 ff ff       	call   8010321a <commit_trans>
  return 0;
...
80105dbd:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80105dd1:	e8 ae f3 ff ff       	call   80105184 <argstr>
80105dd6:	85 c0                	test   %eax,%eax
80105dd8:	78 1a                	js     80105df4 <sys_exec+0x3a>
80105dda:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80105de0:	89 44 24 04          	mov    %eax,0x4(%esp)
80105de4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105deb:	e8 04 f3 ff ff       	call   801050f4 <argint>
80105df0:	85 c0                	test   %eax,%eax
80105df2:	79 0a                	jns    80105dfe <sys_exec+0x44>
    return -1;
80105df4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105df9:	e9 c8 00 00 00       	jmp    80105ec6 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
80105dfe:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80105e05:	00 
80105e06:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105e0d:	00 
80105e0e:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80105e14:	89 04 24             	mov    %eax,(%esp)
80105e17:	e8 96 ef ff ff       	call   80104db2 <memset>
  for(i=0;; i++){
80105e1c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80105e23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e26:	83 f8 1f             	cmp    $0x1f,%eax
80105e29:	76 0a                	jbe    80105e35 <sys_exec+0x7b>
      return -1;
80105e2b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e30:	e9 91 00 00 00       	jmp    80105ec6 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105e35:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e38:	c1 e0 02             	shl    $0x2,%eax
80105e3b:	89 c2                	mov    %eax,%edx
80105e3d:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80105e43:	01 c2                	add    %eax,%edx
80105e45:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80105e4b:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e4f:	89 14 24             	mov    %edx,(%esp)
80105e52:	e8 01 f2 ff ff       	call   80105058 <fetchint>
80105e57:	85 c0                	test   %eax,%eax
80105e59:	79 07                	jns    80105e62 <sys_exec+0xa8>
      return -1;
80105e5b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e60:	eb 64                	jmp    80105ec6 <sys_exec+0x10c>
    if(uarg == 0){
80105e62:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80105e68:	85 c0                	test   %eax,%eax
80105e6a:	75 26                	jne    80105e92 <sys_exec+0xd8>
      argv[i] = 0;
80105e6c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e6f:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80105e76:	00 00 00 00 
      break;
80105e7a:	90                   	nop
    }
...
80105e7e:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80105e84:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e88:	89 04 24             	mov    %eax,(%esp)
80105e8b:	e8 5f ac ff ff       	call   80100aef <exec>
80105e90:	eb 34                	jmp    80105ec6 <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80105ead:	e8 e0 f1 ff ff       	call   80105092 <fetchstr>
80105eb2:	85 c0                	test   %eax,%eax
80105eb4:	79 07                	jns    80105ebd <sys_exec+0x103>
      return -1;
80105eb6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ebb:	eb 09                	jmp    80105ec6 <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80105ebd:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
80105ec1:	e9 5d ff ff ff       	jmp    80105e23 <sys_exec+0x69>
  return exec(path, argv);
}
80105ec6:	c9                   	leave  
80105ec7:	c3                   	ret    
...
80105ece:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105ed5:	00 
80105ed6:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105ed9:	89 44 24 04          	mov    %eax,0x4(%esp)
80105edd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ee4:	e8 39 f2 ff ff       	call   80105122 <argptr>
80105ee9:	85 c0                	test   %eax,%eax
80105eeb:	79 0a                	jns    80105ef7 <sys_pipe+0x2f>
    return -1;
80105eed:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ef2:	e9 9b 00 00 00       	jmp    80105f92 <sys_pipe+0xca>
...
80105f04:	e8 c4 dc ff ff       	call   80103bcd <pipealloc>
80105f09:	85 c0                	test   %eax,%eax
80105f0b:	79 07                	jns    80105f14 <sys_pipe+0x4c>
    return -1;
80105f0d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f12:	eb 7e                	jmp    80105f92 <sys_pipe+0xca>
  fd0 = -1;
80105f14:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105f1b:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105f1e:	89 04 24             	mov    %eax,(%esp)
80105f21:	e8 99 f3 ff ff       	call   801052bf <fdalloc>
80105f26:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f29:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f2d:	78 14                	js     80105f43 <sys_pipe+0x7b>
80105f2f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f32:	89 04 24             	mov    %eax,(%esp)
80105f35:	e8 85 f3 ff ff       	call   801052bf <fdalloc>
80105f3a:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f3d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f41:	79 37                	jns    80105f7a <sys_pipe+0xb2>
    if(fd0 >= 0)
80105f43:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f47:	78 14                	js     80105f5d <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80105f49:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105f4f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f52:	83 c2 08             	add    $0x8,%edx
80105f55:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105f5c:	00 
    fileclose(rf);
80105f5d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105f60:	89 04 24             	mov    %eax,(%esp)
80105f63:	e8 52 b0 ff ff       	call   80100fba <fileclose>
    fileclose(wf);
80105f68:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f6b:	89 04 24             	mov    %eax,(%esp)
80105f6e:	e8 47 b0 ff ff       	call   80100fba <fileclose>
    return -1;
80105f73:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f78:	eb 18                	jmp    80105f92 <sys_pipe+0xca>
  }
  fd[0] = fd0;
80105f7a:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105f7d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f80:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80105f82:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105f85:	8d 50 04             	lea    0x4(%eax),%edx
...
80105f97:	83 ec 08             	sub    $0x8,%esp
  return fork();
80105f9a:	e8 f6 e2 ff ff       	call   80104295 <fork>
}
80105f9f:	c9                   	leave  
80105fa0:	c3                   	ret    
...
80105fa4:	83 ec 08             	sub    $0x8,%esp
  exit();
80105fa7:	e8 ae e4 ff ff       	call   8010445a <exit>
...
80105fb6:	83 ec 08             	sub    $0x8,%esp
  return wait();
80105fb9:	e8 b7 e5 ff ff       	call   80104575 <wait>
}
80105fbe:	c9                   	leave  
80105fbf:	c3                   	ret    
...
80105fd4:	e8 1b f1 ff ff       	call   801050f4 <argint>
80105fd9:	85 c0                	test   %eax,%eax
80105fdb:	79 07                	jns    80105fe4 <sys_kill+0x24>
    return -1;
80105fdd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fe2:	eb 0b                	jmp    80105fef <sys_kill+0x2f>
  return kill(pid);
80105fe4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fe7:	89 04 24             	mov    %eax,(%esp)
80105fea:	e8 a3 e9 ff ff       	call   80104992 <kill>
}
80105fef:	c9                   	leave  
80105ff0:	c3                   	ret    
...
80105ff2:	89 e5                	mov    %esp,%ebp
  return proc->pid;
80105ff4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
...
80106002:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;
...
80106013:	e8 dc f0 ff ff       	call   801050f4 <argint>
80106018:	85 c0                	test   %eax,%eax
8010601a:	79 07                	jns    80106023 <sys_sbrk+0x24>
    return -1;
8010601c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106021:	eb 24                	jmp    80106047 <sys_sbrk+0x48>
  addr = proc->sz;
...
80106034:	e8 b7 e1 ff ff       	call   801041f0 <growproc>
80106039:	85 c0                	test   %eax,%eax
8010603b:	79 07                	jns    80106044 <sys_sbrk+0x45>
    return -1;
8010603d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106042:	eb 03                	jmp    80106047 <sys_sbrk+0x48>
  return addr;
...
8010604c:	83 ec 28             	sub    $0x28,%esp
  ...
  int i;
  argint(0, &token);
8010604f:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106052:	89 44 24 04          	mov    %eax,0x4(%esp)
80106056:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010605d:	e8 92 f0 ff ff       	call   801050f4 <argint>
  argint(1, &i);
80106062:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106065:	89 44 24 04          	mov    %eax,0x4(%esp)
80106069:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106070:	e8 7f f0 ff ff       	call   801050f4 <argint>
  addr = (char*)i;
...
80106082:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106089:	e8 66 f0 ff ff       	call   801050f4 <argint>
  return shmmanip(token, addr, size);
8010608e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106091:	89 c2                	mov    %eax,%edx
80106093:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106096:	89 54 24 08          	mov    %edx,0x8(%esp)
8010609a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010609d:	89 54 24 04          	mov    %edx,0x4(%esp)
801060a1:	89 04 24             	mov    %eax,(%esp)
801060a4:	e8 46 18 00 00       	call   801078ef <shmmanip>
}
801060a9:	c9                   	leave  
801060aa:	c3                   	ret    
...
801060bf:	e8 30 f0 ff ff       	call   801050f4 <argint>
801060c4:	85 c0                	test   %eax,%eax
801060c6:	79 07                	jns    801060cf <sys_sleep+0x24>
    return -1;
801060c8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060cd:	eb 6c                	jmp    8010613b <sys_sleep+0x90>
  acquire(&tickslock);
801060cf:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
801060d6:	e8 83 ea ff ff       	call   80104b5e <acquire>
  ticks0 = ticks;
801060db:	a1 c0 2a 11 80       	mov    0x80112ac0,%eax
801060e0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801060e3:	eb 34                	jmp    80106119 <sys_sleep+0x6e>
    if(proc->killed){
801060e5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801060eb:	8b 40 24             	mov    0x24(%eax),%eax
801060ee:	85 c0                	test   %eax,%eax
801060f0:	74 13                	je     80106105 <sys_sleep+0x5a>
      release(&tickslock);
801060f2:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
801060f9:	e8 c2 ea ff ff       	call   80104bc0 <release>
      return -1;
801060fe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106103:	eb 36                	jmp    8010613b <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106105:	c7 44 24 04 80 22 11 	movl   $0x80112280,0x4(%esp)
8010610c:	80 
8010610d:	c7 04 24 c0 2a 11 80 	movl   $0x80112ac0,(%esp)
80106114:	e8 72 e7 ff ff       	call   8010488b <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106119:	a1 c0 2a 11 80       	mov    0x80112ac0,%eax
8010611e:	2b 45 f4             	sub    -0xc(%ebp),%eax
80106121:	89 c2                	mov    %eax,%edx
80106123:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106126:	39 c2                	cmp    %eax,%edx
80106128:	72 bb                	jb     801060e5 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
8010612a:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
80106131:	e8 8a ea ff ff       	call   80104bc0 <release>
  return 0;
...
80106140:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106143:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
8010614a:	e8 0f ea ff ff       	call   80104b5e <acquire>
  xticks = ticks;
8010614f:	a1 c0 2a 11 80       	mov    0x80112ac0,%eax
80106154:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106157:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
8010615e:	e8 5d ea ff ff       	call   80104bc0 <release>
  return xticks;
...
8010616e:	8b 55 08             	mov    0x8(%ebp),%edx
80106171:	8b 45 0c             	mov    0xc(%ebp),%eax
80106174:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106178:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010617b:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
8010617f:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
8010618c:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106193:	00 
80106194:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
8010619b:	e8 c8 ff ff ff       	call   80106168 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
801061a0:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
801061a7:	00 
801061a8:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801061af:	e8 b4 ff ff ff       	call   80106168 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801061b4:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
801061bb:	00 
801061bc:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801061c3:	e8 a0 ff ff ff       	call   80106168 <outb>
  picenable(IRQ_TIMER);
801061c8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061cf:	e8 8c d8 ff ff       	call   80103a60 <picenable>
}
801061d4:	c9                   	leave  
801061d5:	c3                   	ret    
...
801061d7:	06                   	push   %es
  pushl %fs
801061d8:	0f a0                	push   %fs
  pushl %gs
801061da:	0f a8                	push   %gs
  pushal
801061dc:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801061dd:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801061e1:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801061e3:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801061e5:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801061e9:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801061eb:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801061ed:	54                   	push   %esp
  call trap
801061ee:	e8 d8 01 00 00       	call   801063cb <trap>
  addl $4, %esp
801061f3:	83 c4 04             	add    $0x4,%esp
...
801061f6:	61                   	popa   
  popl %gs
801061f7:	0f a9                	pop    %gs
  popl %fs
801061f9:	0f a1                	pop    %fs
  popl %es
801061fb:	07                   	pop    %es
  popl %ds
801061fc:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801061fd:	83 c4 08             	add    $0x8,%esp
  iret
80106200:	cf                   	iret   
...
8010620a:	83 e8 01             	sub    $0x1,%eax
8010620d:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106211:	8b 45 08             	mov    0x8(%ebp),%eax
80106214:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106218:	8b 45 08             	mov    0x8(%ebp),%eax
8010621b:	c1 e8 10             	shr    $0x10,%eax
8010621e:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106222:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106225:	0f 01 18             	lidtl  (%eax)
}
80106228:	c9                   	leave  
80106229:	c3                   	ret    
...
80106230:	0f 20 d0             	mov    %cr2,%eax
80106233:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
80106236:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80106239:	c9                   	leave  
8010623a:	c3                   	ret    
...
8010623e:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106241:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106248:	e9 c3 00 00 00       	jmp    80106310 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
8010624d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106250:	8b 04 85 9c b0 10 80 	mov    -0x7fef4f64(,%eax,4),%eax
80106257:	89 c2                	mov    %eax,%edx
80106259:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010625c:	66 89 14 c5 c0 22 11 	mov    %dx,-0x7feedd40(,%eax,8)
80106263:	80 
80106264:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106267:	66 c7 04 c5 c2 22 11 	movw   $0x8,-0x7feedd3e(,%eax,8)
8010626e:	80 08 00 
80106271:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106274:	0f b6 14 c5 c4 22 11 	movzbl -0x7feedd3c(,%eax,8),%edx
8010627b:	80 
8010627c:	83 e2 e0             	and    $0xffffffe0,%edx
8010627f:	88 14 c5 c4 22 11 80 	mov    %dl,-0x7feedd3c(,%eax,8)
80106286:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106289:	0f b6 14 c5 c4 22 11 	movzbl -0x7feedd3c(,%eax,8),%edx
80106290:	80 
80106291:	83 e2 1f             	and    $0x1f,%edx
80106294:	88 14 c5 c4 22 11 80 	mov    %dl,-0x7feedd3c(,%eax,8)
8010629b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010629e:	0f b6 14 c5 c5 22 11 	movzbl -0x7feedd3b(,%eax,8),%edx
801062a5:	80 
801062a6:	83 e2 f0             	and    $0xfffffff0,%edx
801062a9:	83 ca 0e             	or     $0xe,%edx
801062ac:	88 14 c5 c5 22 11 80 	mov    %dl,-0x7feedd3b(,%eax,8)
801062b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062b6:	0f b6 14 c5 c5 22 11 	movzbl -0x7feedd3b(,%eax,8),%edx
801062bd:	80 
801062be:	83 e2 ef             	and    $0xffffffef,%edx
801062c1:	88 14 c5 c5 22 11 80 	mov    %dl,-0x7feedd3b(,%eax,8)
801062c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062cb:	0f b6 14 c5 c5 22 11 	movzbl -0x7feedd3b(,%eax,8),%edx
801062d2:	80 
801062d3:	83 e2 9f             	and    $0xffffff9f,%edx
801062d6:	88 14 c5 c5 22 11 80 	mov    %dl,-0x7feedd3b(,%eax,8)
801062dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062e0:	0f b6 14 c5 c5 22 11 	movzbl -0x7feedd3b(,%eax,8),%edx
801062e7:	80 
801062e8:	83 ca 80             	or     $0xffffff80,%edx
801062eb:	88 14 c5 c5 22 11 80 	mov    %dl,-0x7feedd3b(,%eax,8)
801062f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062f5:	8b 04 85 9c b0 10 80 	mov    -0x7fef4f64(,%eax,4),%eax
801062fc:	c1 e8 10             	shr    $0x10,%eax
801062ff:	89 c2                	mov    %eax,%edx
80106301:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106304:	66 89 14 c5 c6 22 11 	mov    %dx,-0x7feedd3a(,%eax,8)
8010630b:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
8010630c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106310:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106317:	0f 8e 30 ff ff ff    	jle    8010624d <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010631d:	a1 9c b1 10 80       	mov    0x8010b19c,%eax
80106322:	66 a3 c0 24 11 80    	mov    %ax,0x801124c0
80106328:	66 c7 05 c2 24 11 80 	movw   $0x8,0x801124c2
8010632f:	08 00 
80106331:	0f b6 05 c4 24 11 80 	movzbl 0x801124c4,%eax
80106338:	83 e0 e0             	and    $0xffffffe0,%eax
8010633b:	a2 c4 24 11 80       	mov    %al,0x801124c4
80106340:	0f b6 05 c4 24 11 80 	movzbl 0x801124c4,%eax
80106347:	83 e0 1f             	and    $0x1f,%eax
8010634a:	a2 c4 24 11 80       	mov    %al,0x801124c4
8010634f:	0f b6 05 c5 24 11 80 	movzbl 0x801124c5,%eax
80106356:	83 c8 0f             	or     $0xf,%eax
80106359:	a2 c5 24 11 80       	mov    %al,0x801124c5
8010635e:	0f b6 05 c5 24 11 80 	movzbl 0x801124c5,%eax
80106365:	83 e0 ef             	and    $0xffffffef,%eax
80106368:	a2 c5 24 11 80       	mov    %al,0x801124c5
8010636d:	0f b6 05 c5 24 11 80 	movzbl 0x801124c5,%eax
80106374:	83 c8 60             	or     $0x60,%eax
80106377:	a2 c5 24 11 80       	mov    %al,0x801124c5
8010637c:	0f b6 05 c5 24 11 80 	movzbl 0x801124c5,%eax
80106383:	83 c8 80             	or     $0xffffff80,%eax
80106386:	a2 c5 24 11 80       	mov    %al,0x801124c5
8010638b:	a1 9c b1 10 80       	mov    0x8010b19c,%eax
80106390:	c1 e8 10             	shr    $0x10,%eax
80106393:	66 a3 c6 24 11 80    	mov    %ax,0x801124c6
  
  initlock(&tickslock, "time");
80106399:	c7 44 24 04 e8 87 10 	movl   $0x801087e8,0x4(%esp)
801063a0:	80 
801063a1:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
801063a8:	e8 90 e7 ff ff       	call   80104b3d <initlock>
}
801063ad:	c9                   	leave  
801063ae:	c3                   	ret    
...
801063b2:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801063b5:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801063bc:	00 
801063bd:	c7 04 24 c0 22 11 80 	movl   $0x801122c0,(%esp)
801063c4:	e8 38 fe ff ff       	call   80106201 <lidt>
}
801063c9:	c9                   	leave  
801063ca:	c3                   	ret    
...
801063d1:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801063d4:	8b 45 08             	mov    0x8(%ebp),%eax
801063d7:	8b 40 30             	mov    0x30(%eax),%eax
801063da:	83 f8 40             	cmp    $0x40,%eax
801063dd:	75 3f                	jne    8010641e <trap+0x53>
    if(proc->killed)
801063df:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801063e5:	8b 40 24             	mov    0x24(%eax),%eax
801063e8:	85 c0                	test   %eax,%eax
801063ea:	74 05                	je     801063f1 <trap+0x26>
      exit();
801063ec:	e8 69 e0 ff ff       	call   8010445a <exit>
    proc->tf = tf;
801063f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801063f7:	8b 55 08             	mov    0x8(%ebp),%edx
801063fa:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801063fd:	e8 b9 ed ff ff       	call   801051bb <syscall>
    if(proc->killed)
80106402:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106408:	8b 40 24             	mov    0x24(%eax),%eax
8010640b:	85 c0                	test   %eax,%eax
8010640d:	74 0a                	je     80106419 <trap+0x4e>
      exit();
8010640f:	e8 46 e0 ff ff       	call   8010445a <exit>
    return;
80106414:	e9 2d 02 00 00       	jmp    80106646 <trap+0x27b>
80106419:	e9 28 02 00 00       	jmp    80106646 <trap+0x27b>
  }

  switch(tf->trapno){
8010641e:	8b 45 08             	mov    0x8(%ebp),%eax
80106421:	8b 40 30             	mov    0x30(%eax),%eax
80106424:	83 e8 20             	sub    $0x20,%eax
80106427:	83 f8 1f             	cmp    $0x1f,%eax
8010642a:	0f 87 bc 00 00 00    	ja     801064ec <trap+0x121>
80106430:	8b 04 85 90 88 10 80 	mov    -0x7fef7770(,%eax,4),%eax
80106437:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106439:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010643f:	0f b6 00             	movzbl (%eax),%eax
80106442:	84 c0                	test   %al,%al
80106444:	75 31                	jne    80106477 <trap+0xac>
      acquire(&tickslock);
80106446:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
8010644d:	e8 0c e7 ff ff       	call   80104b5e <acquire>
      ticks++;
80106452:	a1 c0 2a 11 80       	mov    0x80112ac0,%eax
80106457:	83 c0 01             	add    $0x1,%eax
8010645a:	a3 c0 2a 11 80       	mov    %eax,0x80112ac0
      wakeup(&ticks);
8010645f:	c7 04 24 c0 2a 11 80 	movl   $0x80112ac0,(%esp)
80106466:	e8 fc e4 ff ff       	call   80104967 <wakeup>
      release(&tickslock);
8010646b:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
80106472:	e8 49 e7 ff ff       	call   80104bc0 <release>
    }
    lapiceoi();
80106477:	e8 23 ca ff ff       	call   80102e9f <lapiceoi>
    break;
8010647c:	e9 41 01 00 00       	jmp    801065c2 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106481:	e8 44 c2 ff ff       	call   801026ca <ideintr>
    lapiceoi();
80106486:	e8 14 ca ff ff       	call   80102e9f <lapiceoi>
    break;
8010648b:	e9 32 01 00 00       	jmp    801065c2 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106490:	e8 f6 c7 ff ff       	call   80102c8b <kbdintr>
    lapiceoi();
80106495:	e8 05 ca ff ff       	call   80102e9f <lapiceoi>
    break;
8010649a:	e9 23 01 00 00       	jmp    801065c2 <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
8010649f:	e8 97 03 00 00       	call   8010683b <uartintr>
    lapiceoi();
801064a4:	e8 f6 c9 ff ff       	call   80102e9f <lapiceoi>
    break;
801064a9:	e9 14 01 00 00       	jmp    801065c2 <trap+0x1f7>
  case T_IRQ0 + 7:
...
801064b7:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801064bb:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
801064be:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801064c4:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801064c7:	0f b6 c0             	movzbl %al,%eax
801064ca:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801064ce:	89 54 24 08          	mov    %edx,0x8(%esp)
801064d2:	89 44 24 04          	mov    %eax,0x4(%esp)
801064d6:	c7 04 24 f0 87 10 80 	movl   $0x801087f0,(%esp)
801064dd:	e8 be 9e ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
801064e2:	e8 b8 c9 ff ff       	call   80102e9f <lapiceoi>
    break;
801064e7:	e9 d6 00 00 00       	jmp    801065c2 <trap+0x1f7>
...
801064f4:	74 11                	je     80106507 <trap+0x13c>
801064f6:	8b 45 08             	mov    0x8(%ebp),%eax
801064f9:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801064fd:	0f b7 c0             	movzwl %ax,%eax
80106500:	83 e0 03             	and    $0x3,%eax
80106503:	85 c0                	test   %eax,%eax
80106505:	75 46                	jne    8010654d <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106507:	e8 1e fd ff ff       	call   8010622a <rcr2>
8010650c:	8b 55 08             	mov    0x8(%ebp),%edx
8010650f:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106512:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106519:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010651c:	0f b6 ca             	movzbl %dl,%ecx
8010651f:	8b 55 08             	mov    0x8(%ebp),%edx
80106522:	8b 52 30             	mov    0x30(%edx),%edx
80106525:	89 44 24 10          	mov    %eax,0x10(%esp)
80106529:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010652d:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106531:	89 54 24 04          	mov    %edx,0x4(%esp)
80106535:	c7 04 24 14 88 10 80 	movl   $0x80108814,(%esp)
8010653c:	e8 5f 9e ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106541:	c7 04 24 46 88 10 80 	movl   $0x80108846,(%esp)
80106548:	e8 ed 9f ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010654d:	e8 d8 fc ff ff       	call   8010622a <rcr2>
80106552:	89 c2                	mov    %eax,%edx
80106554:	8b 45 08             	mov    0x8(%ebp),%eax
80106557:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010655a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106560:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106563:	0f b6 f0             	movzbl %al,%esi
80106566:	8b 45 08             	mov    0x8(%ebp),%eax
80106569:	8b 58 34             	mov    0x34(%eax),%ebx
8010656c:	8b 45 08             	mov    0x8(%ebp),%eax
8010656f:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106572:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106578:	83 c0 6c             	add    $0x6c,%eax
...
8010657e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106584:	8b 40 10             	mov    0x10(%eax),%eax
80106587:	89 54 24 1c          	mov    %edx,0x1c(%esp)
8010658b:	89 7c 24 18          	mov    %edi,0x18(%esp)
8010658f:	89 74 24 14          	mov    %esi,0x14(%esp)
80106593:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106597:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010659b:	8b 75 e4             	mov    -0x1c(%ebp),%esi
8010659e:	89 74 24 08          	mov    %esi,0x8(%esp)
801065a2:	89 44 24 04          	mov    %eax,0x4(%esp)
801065a6:	c7 04 24 4c 88 10 80 	movl   $0x8010884c,(%esp)
801065ad:	e8 ee 9d ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
801065b2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801065b8:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801065bf:	eb 01                	jmp    801065c2 <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801065ca:	74 24                	je     801065f0 <trap+0x225>
801065cc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801065d2:	8b 40 24             	mov    0x24(%eax),%eax
801065d5:	85 c0                	test   %eax,%eax
801065d7:	74 17                	je     801065f0 <trap+0x225>
801065d9:	8b 45 08             	mov    0x8(%ebp),%eax
801065dc:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801065e0:	0f b7 c0             	movzwl %ax,%eax
801065e3:	83 e0 03             	and    $0x3,%eax
801065e6:	83 f8 03             	cmp    $0x3,%eax
801065e9:	75 05                	jne    801065f0 <trap+0x225>
    exit();
801065eb:	e8 6a de ff ff       	call   8010445a <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
801065f0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801065f6:	85 c0                	test   %eax,%eax
801065f8:	74 1e                	je     80106618 <trap+0x24d>
801065fa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106600:	8b 40 0c             	mov    0xc(%eax),%eax
80106603:	83 f8 04             	cmp    $0x4,%eax
80106606:	75 10                	jne    80106618 <trap+0x24d>
80106608:	8b 45 08             	mov    0x8(%ebp),%eax
8010660b:	8b 40 30             	mov    0x30(%eax),%eax
8010660e:	83 f8 20             	cmp    $0x20,%eax
80106611:	75 05                	jne    80106618 <trap+0x24d>
    yield();
80106613:	e8 15 e2 ff ff       	call   8010482d <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106618:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010661e:	85 c0                	test   %eax,%eax
80106620:	74 24                	je     80106646 <trap+0x27b>
80106622:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106628:	8b 40 24             	mov    0x24(%eax),%eax
8010662b:	85 c0                	test   %eax,%eax
8010662d:	74 17                	je     80106646 <trap+0x27b>
...
8010663f:	75 05                	jne    80106646 <trap+0x27b>
    exit();
80106641:	e8 14 de ff ff       	call   8010445a <exit>
}
80106646:	83 c4 3c             	add    $0x3c,%esp
80106649:	5b                   	pop    %ebx
8010664a:	5e                   	pop    %esi
8010664b:	5f                   	pop    %edi
8010664c:	5d                   	pop    %ebp
...
80106651:	83 ec 14             	sub    $0x14,%esp
80106654:	8b 45 08             	mov    0x8(%ebp),%eax
80106657:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010665b:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
8010665f:	89 c2                	mov    %eax,%edx
80106661:	ec                   	in     (%dx),%al
80106662:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106665:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106669:	c9                   	leave  
8010666a:	c3                   	ret    
...
80106671:	8b 55 08             	mov    0x8(%ebp),%edx
80106674:	8b 45 0c             	mov    0xc(%ebp),%eax
80106677:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010667b:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010667e:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106682:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
8010668c:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
8010668f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106696:	00 
80106697:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010669e:	e8 c8 ff ff ff       	call   8010666b <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801066a3:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801066aa:	00 
801066ab:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801066b2:	e8 b4 ff ff ff       	call   8010666b <outb>
  outb(COM1+0, 115200/9600);
801066b7:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801066be:	00 
801066bf:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801066c6:	e8 a0 ff ff ff       	call   8010666b <outb>
  outb(COM1+1, 0);
801066cb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801066d2:	00 
801066d3:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801066da:	e8 8c ff ff ff       	call   8010666b <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801066df:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801066e6:	00 
801066e7:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801066ee:	e8 78 ff ff ff       	call   8010666b <outb>
  outb(COM1+4, 0);
801066f3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801066fa:	00 
801066fb:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106702:	e8 64 ff ff ff       	call   8010666b <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106707:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010670e:	00 
8010670f:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106716:	e8 50 ff ff ff       	call   8010666b <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
8010671b:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106722:	e8 27 ff ff ff       	call   8010664e <inb>
80106727:	3c ff                	cmp    $0xff,%al
80106729:	75 02                	jne    8010672d <uartinit+0xa4>
    return;
8010672b:	eb 6a                	jmp    80106797 <uartinit+0x10e>
  uart = 1;
8010672d:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
80106734:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106737:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010673e:	e8 0b ff ff ff       	call   8010664e <inb>
  inb(COM1+0);
80106743:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010674a:	e8 ff fe ff ff       	call   8010664e <inb>
  picenable(IRQ_COM1);
8010674f:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106756:	e8 05 d3 ff ff       	call   80103a60 <picenable>
  ioapicenable(IRQ_COM1, 0);
8010675b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106762:	00 
80106763:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010676a:	e8 da c1 ff ff       	call   80102949 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010676f:	c7 45 f4 10 89 10 80 	movl   $0x80108910,-0xc(%ebp)
80106776:	eb 15                	jmp    8010678d <uartinit+0x104>
    uartputc(*p);
80106778:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010677b:	0f b6 00             	movzbl (%eax),%eax
8010677e:	0f be c0             	movsbl %al,%eax
80106781:	89 04 24             	mov    %eax,(%esp)
80106784:	e8 10 00 00 00       	call   80106799 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80106790:	0f b6 00             	movzbl (%eax),%eax
80106793:	84 c0                	test   %al,%al
80106795:	75 e1                	jne    80106778 <uartinit+0xef>
    uartputc(*p);
}
80106797:	c9                   	leave  
80106798:	c3                   	ret    
...
8010679c:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
8010679f:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
801067a4:	85 c0                	test   %eax,%eax
801067a6:	75 02                	jne    801067aa <uartputc+0x11>
    return;
801067a8:	eb 4b                	jmp    801067f5 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801067aa:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801067b1:	eb 10                	jmp    801067c3 <uartputc+0x2a>
    microdelay(10);
801067b3:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801067ba:	e8 05 c7 ff ff       	call   80102ec4 <microdelay>
{
  int i;
...
801067c3:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801067c7:	7f 16                	jg     801067df <uartputc+0x46>
801067c9:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801067d0:	e8 79 fe ff ff       	call   8010664e <inb>
801067d5:	0f b6 c0             	movzbl %al,%eax
801067d8:	83 e0 20             	and    $0x20,%eax
801067db:	85 c0                	test   %eax,%eax
801067dd:	74 d4                	je     801067b3 <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
801067df:	8b 45 08             	mov    0x8(%ebp),%eax
801067e2:	0f b6 c0             	movzbl %al,%eax
801067e5:	89 44 24 04          	mov    %eax,0x4(%esp)
801067e9:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801067f0:	e8 76 fe ff ff       	call   8010666b <outb>
}
801067f5:	c9                   	leave  
801067f6:	c3                   	ret    
...
801067fa:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
801067fd:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106802:	85 c0                	test   %eax,%eax
80106804:	75 07                	jne    8010680d <uartgetc+0x16>
    return -1;
80106806:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010680b:	eb 2c                	jmp    80106839 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
8010680d:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106814:	e8 35 fe ff ff       	call   8010664e <inb>
80106819:	0f b6 c0             	movzbl %al,%eax
8010681c:	83 e0 01             	and    $0x1,%eax
8010681f:	85 c0                	test   %eax,%eax
80106821:	75 07                	jne    8010682a <uartgetc+0x33>
    return -1;
80106823:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106828:	eb 0f                	jmp    80106839 <uartgetc+0x42>
  return inb(COM1+0);
8010682a:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106831:	e8 18 fe ff ff       	call   8010664e <inb>
...
8010683e:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106841:	c7 04 24 f7 67 10 80 	movl   $0x801067f7,(%esp)
80106848:	e8 60 9f ff ff       	call   801007ad <consoleintr>
}
8010684d:	c9                   	leave  
8010684e:	c3                   	ret    
...
80106851:	6a 00                	push   $0x0
  jmp alltraps
80106853:	e9 7e f9 ff ff       	jmp    801061d6 <alltraps>
...
80106858:	6a 00                	push   $0x0
  pushl $1
8010685a:	6a 01                	push   $0x1
  jmp alltraps
8010685c:	e9 75 f9 ff ff       	jmp    801061d6 <alltraps>
...
80106861:	6a 00                	push   $0x0
  pushl $2
80106863:	6a 02                	push   $0x2
  jmp alltraps
80106865:	e9 6c f9 ff ff       	jmp    801061d6 <alltraps>
...
8010686a:	6a 00                	push   $0x0
  pushl $3
8010686c:	6a 03                	push   $0x3
  jmp alltraps
8010686e:	e9 63 f9 ff ff       	jmp    801061d6 <alltraps>
...
80106873:	6a 00                	push   $0x0
  pushl $4
80106875:	6a 04                	push   $0x4
  jmp alltraps
80106877:	e9 5a f9 ff ff       	jmp    801061d6 <alltraps>
...
8010687c:	6a 00                	push   $0x0
  pushl $5
8010687e:	6a 05                	push   $0x5
  jmp alltraps
80106880:	e9 51 f9 ff ff       	jmp    801061d6 <alltraps>
...
80106885:	6a 00                	push   $0x0
  pushl $6
80106887:	6a 06                	push   $0x6
  jmp alltraps
80106889:	e9 48 f9 ff ff       	jmp    801061d6 <alltraps>
...
8010688e:	6a 00                	push   $0x0
  pushl $7
80106890:	6a 07                	push   $0x7
  jmp alltraps
80106892:	e9 3f f9 ff ff       	jmp    801061d6 <alltraps>

80106897 <vector8>:
.globl vector8
vector8:
  pushl $8
80106897:	6a 08                	push   $0x8
  jmp alltraps
80106899:	e9 38 f9 ff ff       	jmp    801061d6 <alltraps>
...
8010689e:	6a 00                	push   $0x0
  pushl $9
801068a0:	6a 09                	push   $0x9
  jmp alltraps
801068a2:	e9 2f f9 ff ff       	jmp    801061d6 <alltraps>

801068a7 <vector10>:
.globl vector10
vector10:
  pushl $10
801068a7:	6a 0a                	push   $0xa
  jmp alltraps
801068a9:	e9 28 f9 ff ff       	jmp    801061d6 <alltraps>

801068ae <vector11>:
.globl vector11
vector11:
  pushl $11
801068ae:	6a 0b                	push   $0xb
  jmp alltraps
801068b0:	e9 21 f9 ff ff       	jmp    801061d6 <alltraps>

801068b5 <vector12>:
.globl vector12
vector12:
  pushl $12
801068b5:	6a 0c                	push   $0xc
  jmp alltraps
801068b7:	e9 1a f9 ff ff       	jmp    801061d6 <alltraps>

801068bc <vector13>:
.globl vector13
vector13:
  pushl $13
801068bc:	6a 0d                	push   $0xd
  jmp alltraps
801068be:	e9 13 f9 ff ff       	jmp    801061d6 <alltraps>

801068c3 <vector14>:
.globl vector14
vector14:
  pushl $14
801068c3:	6a 0e                	push   $0xe
  jmp alltraps
801068c5:	e9 0c f9 ff ff       	jmp    801061d6 <alltraps>
...
801068ca:	6a 00                	push   $0x0
  pushl $15
801068cc:	6a 0f                	push   $0xf
  jmp alltraps
801068ce:	e9 03 f9 ff ff       	jmp    801061d6 <alltraps>
...
801068d5:	6a 10                	push   $0x10
  jmp alltraps
801068d7:	e9 fa f8 ff ff       	jmp    801061d6 <alltraps>

801068dc <vector17>:
.globl vector17
vector17:
  pushl $17
801068dc:	6a 11                	push   $0x11
  jmp alltraps
801068de:	e9 f3 f8 ff ff       	jmp    801061d6 <alltraps>
...
801068e3:	6a 00                	push   $0x0
  pushl $18
801068e5:	6a 12                	push   $0x12
  jmp alltraps
801068e7:	e9 ea f8 ff ff       	jmp    801061d6 <alltraps>
...
801068ec:	6a 00                	push   $0x0
  pushl $19
801068ee:	6a 13                	push   $0x13
  jmp alltraps
801068f0:	e9 e1 f8 ff ff       	jmp    801061d6 <alltraps>
...
801068f5:	6a 00                	push   $0x0
  pushl $20
801068f7:	6a 14                	push   $0x14
  jmp alltraps
801068f9:	e9 d8 f8 ff ff       	jmp    801061d6 <alltraps>
...
801068fe:	6a 00                	push   $0x0
  pushl $21
80106900:	6a 15                	push   $0x15
  jmp alltraps
80106902:	e9 cf f8 ff ff       	jmp    801061d6 <alltraps>
...
80106907:	6a 00                	push   $0x0
  pushl $22
80106909:	6a 16                	push   $0x16
  jmp alltraps
8010690b:	e9 c6 f8 ff ff       	jmp    801061d6 <alltraps>
...
80106910:	6a 00                	push   $0x0
  pushl $23
80106912:	6a 17                	push   $0x17
  jmp alltraps
80106914:	e9 bd f8 ff ff       	jmp    801061d6 <alltraps>
...
80106919:	6a 00                	push   $0x0
  pushl $24
8010691b:	6a 18                	push   $0x18
  jmp alltraps
8010691d:	e9 b4 f8 ff ff       	jmp    801061d6 <alltraps>
...
80106922:	6a 00                	push   $0x0
  pushl $25
80106924:	6a 19                	push   $0x19
  jmp alltraps
80106926:	e9 ab f8 ff ff       	jmp    801061d6 <alltraps>
...
8010692b:	6a 00                	push   $0x0
  pushl $26
8010692d:	6a 1a                	push   $0x1a
  jmp alltraps
8010692f:	e9 a2 f8 ff ff       	jmp    801061d6 <alltraps>
...
80106934:	6a 00                	push   $0x0
  pushl $27
80106936:	6a 1b                	push   $0x1b
  jmp alltraps
80106938:	e9 99 f8 ff ff       	jmp    801061d6 <alltraps>
...
8010693d:	6a 00                	push   $0x0
  pushl $28
8010693f:	6a 1c                	push   $0x1c
  jmp alltraps
80106941:	e9 90 f8 ff ff       	jmp    801061d6 <alltraps>
...
80106946:	6a 00                	push   $0x0
  pushl $29
80106948:	6a 1d                	push   $0x1d
  jmp alltraps
8010694a:	e9 87 f8 ff ff       	jmp    801061d6 <alltraps>
...
8010694f:	6a 00                	push   $0x0
  pushl $30
80106951:	6a 1e                	push   $0x1e
  jmp alltraps
80106953:	e9 7e f8 ff ff       	jmp    801061d6 <alltraps>
...
80106958:	6a 00                	push   $0x0
  pushl $31
8010695a:	6a 1f                	push   $0x1f
  jmp alltraps
8010695c:	e9 75 f8 ff ff       	jmp    801061d6 <alltraps>
...
80106961:	6a 00                	push   $0x0
  pushl $32
80106963:	6a 20                	push   $0x20
  jmp alltraps
80106965:	e9 6c f8 ff ff       	jmp    801061d6 <alltraps>
...
8010696a:	6a 00                	push   $0x0
  pushl $33
8010696c:	6a 21                	push   $0x21
  jmp alltraps
8010696e:	e9 63 f8 ff ff       	jmp    801061d6 <alltraps>
...
80106973:	6a 00                	push   $0x0
  pushl $34
80106975:	6a 22                	push   $0x22
  jmp alltraps
80106977:	e9 5a f8 ff ff       	jmp    801061d6 <alltraps>
...
8010697c:	6a 00                	push   $0x0
  pushl $35
8010697e:	6a 23                	push   $0x23
  jmp alltraps
80106980:	e9 51 f8 ff ff       	jmp    801061d6 <alltraps>
...
80106985:	6a 00                	push   $0x0
  pushl $36
80106987:	6a 24                	push   $0x24
  jmp alltraps
80106989:	e9 48 f8 ff ff       	jmp    801061d6 <alltraps>
...
8010698e:	6a 00                	push   $0x0
  pushl $37
80106990:	6a 25                	push   $0x25
  jmp alltraps
80106992:	e9 3f f8 ff ff       	jmp    801061d6 <alltraps>
...
80106997:	6a 00                	push   $0x0
  pushl $38
80106999:	6a 26                	push   $0x26
  jmp alltraps
8010699b:	e9 36 f8 ff ff       	jmp    801061d6 <alltraps>
...
801069a0:	6a 00                	push   $0x0
  pushl $39
801069a2:	6a 27                	push   $0x27
  jmp alltraps
801069a4:	e9 2d f8 ff ff       	jmp    801061d6 <alltraps>
...
801069a9:	6a 00                	push   $0x0
  pushl $40
801069ab:	6a 28                	push   $0x28
  jmp alltraps
801069ad:	e9 24 f8 ff ff       	jmp    801061d6 <alltraps>
...
801069b2:	6a 00                	push   $0x0
  pushl $41
801069b4:	6a 29                	push   $0x29
  jmp alltraps
801069b6:	e9 1b f8 ff ff       	jmp    801061d6 <alltraps>
...
801069bb:	6a 00                	push   $0x0
  pushl $42
801069bd:	6a 2a                	push   $0x2a
  jmp alltraps
801069bf:	e9 12 f8 ff ff       	jmp    801061d6 <alltraps>
...
801069c4:	6a 00                	push   $0x0
  pushl $43
801069c6:	6a 2b                	push   $0x2b
  jmp alltraps
801069c8:	e9 09 f8 ff ff       	jmp    801061d6 <alltraps>
...
801069cd:	6a 00                	push   $0x0
  pushl $44
801069cf:	6a 2c                	push   $0x2c
  jmp alltraps
801069d1:	e9 00 f8 ff ff       	jmp    801061d6 <alltraps>
...
801069d6:	6a 00                	push   $0x0
  pushl $45
801069d8:	6a 2d                	push   $0x2d
  jmp alltraps
801069da:	e9 f7 f7 ff ff       	jmp    801061d6 <alltraps>
...
801069df:	6a 00                	push   $0x0
  pushl $46
801069e1:	6a 2e                	push   $0x2e
  jmp alltraps
801069e3:	e9 ee f7 ff ff       	jmp    801061d6 <alltraps>
...
801069e8:	6a 00                	push   $0x0
  pushl $47
801069ea:	6a 2f                	push   $0x2f
  jmp alltraps
801069ec:	e9 e5 f7 ff ff       	jmp    801061d6 <alltraps>
...
801069f1:	6a 00                	push   $0x0
  pushl $48
801069f3:	6a 30                	push   $0x30
  jmp alltraps
801069f5:	e9 dc f7 ff ff       	jmp    801061d6 <alltraps>
...
801069fa:	6a 00                	push   $0x0
  pushl $49
801069fc:	6a 31                	push   $0x31
  jmp alltraps
801069fe:	e9 d3 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a03:	6a 00                	push   $0x0
  pushl $50
80106a05:	6a 32                	push   $0x32
  jmp alltraps
80106a07:	e9 ca f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a0c:	6a 00                	push   $0x0
  pushl $51
80106a0e:	6a 33                	push   $0x33
  jmp alltraps
80106a10:	e9 c1 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a15:	6a 00                	push   $0x0
  pushl $52
80106a17:	6a 34                	push   $0x34
  jmp alltraps
80106a19:	e9 b8 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a1e:	6a 00                	push   $0x0
  pushl $53
80106a20:	6a 35                	push   $0x35
  jmp alltraps
80106a22:	e9 af f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a27:	6a 00                	push   $0x0
  pushl $54
80106a29:	6a 36                	push   $0x36
  jmp alltraps
80106a2b:	e9 a6 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a30:	6a 00                	push   $0x0
  pushl $55
80106a32:	6a 37                	push   $0x37
  jmp alltraps
80106a34:	e9 9d f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a39:	6a 00                	push   $0x0
  pushl $56
80106a3b:	6a 38                	push   $0x38
  jmp alltraps
80106a3d:	e9 94 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a42:	6a 00                	push   $0x0
  pushl $57
80106a44:	6a 39                	push   $0x39
  jmp alltraps
80106a46:	e9 8b f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a4b:	6a 00                	push   $0x0
  pushl $58
80106a4d:	6a 3a                	push   $0x3a
  jmp alltraps
80106a4f:	e9 82 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a54:	6a 00                	push   $0x0
  pushl $59
80106a56:	6a 3b                	push   $0x3b
  jmp alltraps
80106a58:	e9 79 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a5d:	6a 00                	push   $0x0
  pushl $60
80106a5f:	6a 3c                	push   $0x3c
  jmp alltraps
80106a61:	e9 70 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a66:	6a 00                	push   $0x0
  pushl $61
80106a68:	6a 3d                	push   $0x3d
  jmp alltraps
80106a6a:	e9 67 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a6f:	6a 00                	push   $0x0
  pushl $62
80106a71:	6a 3e                	push   $0x3e
  jmp alltraps
80106a73:	e9 5e f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a78:	6a 00                	push   $0x0
  pushl $63
80106a7a:	6a 3f                	push   $0x3f
  jmp alltraps
80106a7c:	e9 55 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a81:	6a 00                	push   $0x0
  pushl $64
80106a83:	6a 40                	push   $0x40
  jmp alltraps
80106a85:	e9 4c f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a8a:	6a 00                	push   $0x0
  pushl $65
80106a8c:	6a 41                	push   $0x41
  jmp alltraps
80106a8e:	e9 43 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a93:	6a 00                	push   $0x0
  pushl $66
80106a95:	6a 42                	push   $0x42
  jmp alltraps
80106a97:	e9 3a f7 ff ff       	jmp    801061d6 <alltraps>
...
80106a9c:	6a 00                	push   $0x0
  pushl $67
80106a9e:	6a 43                	push   $0x43
  jmp alltraps
80106aa0:	e9 31 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106aa5:	6a 00                	push   $0x0
  pushl $68
80106aa7:	6a 44                	push   $0x44
  jmp alltraps
80106aa9:	e9 28 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106aae:	6a 00                	push   $0x0
  pushl $69
80106ab0:	6a 45                	push   $0x45
  jmp alltraps
80106ab2:	e9 1f f7 ff ff       	jmp    801061d6 <alltraps>
...
80106ab7:	6a 00                	push   $0x0
  pushl $70
80106ab9:	6a 46                	push   $0x46
  jmp alltraps
80106abb:	e9 16 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106ac0:	6a 00                	push   $0x0
  pushl $71
80106ac2:	6a 47                	push   $0x47
  jmp alltraps
80106ac4:	e9 0d f7 ff ff       	jmp    801061d6 <alltraps>
...
80106ac9:	6a 00                	push   $0x0
  pushl $72
80106acb:	6a 48                	push   $0x48
  jmp alltraps
80106acd:	e9 04 f7 ff ff       	jmp    801061d6 <alltraps>
...
80106ad2:	6a 00                	push   $0x0
  pushl $73
80106ad4:	6a 49                	push   $0x49
  jmp alltraps
80106ad6:	e9 fb f6 ff ff       	jmp    801061d6 <alltraps>
...
80106adb:	6a 00                	push   $0x0
  pushl $74
80106add:	6a 4a                	push   $0x4a
  jmp alltraps
80106adf:	e9 f2 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106ae4:	6a 00                	push   $0x0
  pushl $75
80106ae6:	6a 4b                	push   $0x4b
  jmp alltraps
80106ae8:	e9 e9 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106aed:	6a 00                	push   $0x0
  pushl $76
80106aef:	6a 4c                	push   $0x4c
  jmp alltraps
80106af1:	e9 e0 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106af6:	6a 00                	push   $0x0
  pushl $77
80106af8:	6a 4d                	push   $0x4d
  jmp alltraps
80106afa:	e9 d7 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106aff:	6a 00                	push   $0x0
  pushl $78
80106b01:	6a 4e                	push   $0x4e
  jmp alltraps
80106b03:	e9 ce f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b08:	6a 00                	push   $0x0
  pushl $79
80106b0a:	6a 4f                	push   $0x4f
  jmp alltraps
80106b0c:	e9 c5 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b11:	6a 00                	push   $0x0
  pushl $80
80106b13:	6a 50                	push   $0x50
  jmp alltraps
80106b15:	e9 bc f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b1a:	6a 00                	push   $0x0
  pushl $81
80106b1c:	6a 51                	push   $0x51
  jmp alltraps
80106b1e:	e9 b3 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b23:	6a 00                	push   $0x0
  pushl $82
80106b25:	6a 52                	push   $0x52
  jmp alltraps
80106b27:	e9 aa f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b2c:	6a 00                	push   $0x0
  pushl $83
80106b2e:	6a 53                	push   $0x53
  jmp alltraps
80106b30:	e9 a1 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b35:	6a 00                	push   $0x0
  pushl $84
80106b37:	6a 54                	push   $0x54
  jmp alltraps
80106b39:	e9 98 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b3e:	6a 00                	push   $0x0
  pushl $85
80106b40:	6a 55                	push   $0x55
  jmp alltraps
80106b42:	e9 8f f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b47:	6a 00                	push   $0x0
  pushl $86
80106b49:	6a 56                	push   $0x56
  jmp alltraps
80106b4b:	e9 86 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b50:	6a 00                	push   $0x0
  pushl $87
80106b52:	6a 57                	push   $0x57
  jmp alltraps
80106b54:	e9 7d f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b59:	6a 00                	push   $0x0
  pushl $88
80106b5b:	6a 58                	push   $0x58
  jmp alltraps
80106b5d:	e9 74 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b62:	6a 00                	push   $0x0
  pushl $89
80106b64:	6a 59                	push   $0x59
  jmp alltraps
80106b66:	e9 6b f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b6b:	6a 00                	push   $0x0
  pushl $90
80106b6d:	6a 5a                	push   $0x5a
  jmp alltraps
80106b6f:	e9 62 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b74:	6a 00                	push   $0x0
  pushl $91
80106b76:	6a 5b                	push   $0x5b
  jmp alltraps
80106b78:	e9 59 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b7d:	6a 00                	push   $0x0
  pushl $92
80106b7f:	6a 5c                	push   $0x5c
  jmp alltraps
80106b81:	e9 50 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b86:	6a 00                	push   $0x0
  pushl $93
80106b88:	6a 5d                	push   $0x5d
  jmp alltraps
80106b8a:	e9 47 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b8f:	6a 00                	push   $0x0
  pushl $94
80106b91:	6a 5e                	push   $0x5e
  jmp alltraps
80106b93:	e9 3e f6 ff ff       	jmp    801061d6 <alltraps>
...
80106b98:	6a 00                	push   $0x0
  pushl $95
80106b9a:	6a 5f                	push   $0x5f
  jmp alltraps
80106b9c:	e9 35 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106ba1:	6a 00                	push   $0x0
  pushl $96
80106ba3:	6a 60                	push   $0x60
  jmp alltraps
80106ba5:	e9 2c f6 ff ff       	jmp    801061d6 <alltraps>
...
80106baa:	6a 00                	push   $0x0
  pushl $97
80106bac:	6a 61                	push   $0x61
  jmp alltraps
80106bae:	e9 23 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106bb3:	6a 00                	push   $0x0
  pushl $98
80106bb5:	6a 62                	push   $0x62
  jmp alltraps
80106bb7:	e9 1a f6 ff ff       	jmp    801061d6 <alltraps>
...
80106bbc:	6a 00                	push   $0x0
  pushl $99
80106bbe:	6a 63                	push   $0x63
  jmp alltraps
80106bc0:	e9 11 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106bc5:	6a 00                	push   $0x0
  pushl $100
80106bc7:	6a 64                	push   $0x64
  jmp alltraps
80106bc9:	e9 08 f6 ff ff       	jmp    801061d6 <alltraps>
...
80106bce:	6a 00                	push   $0x0
  pushl $101
80106bd0:	6a 65                	push   $0x65
  jmp alltraps
80106bd2:	e9 ff f5 ff ff       	jmp    801061d6 <alltraps>
...
80106bd7:	6a 00                	push   $0x0
  pushl $102
80106bd9:	6a 66                	push   $0x66
  jmp alltraps
80106bdb:	e9 f6 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106be0:	6a 00                	push   $0x0
  pushl $103
80106be2:	6a 67                	push   $0x67
  jmp alltraps
80106be4:	e9 ed f5 ff ff       	jmp    801061d6 <alltraps>
...
80106be9:	6a 00                	push   $0x0
  pushl $104
80106beb:	6a 68                	push   $0x68
  jmp alltraps
80106bed:	e9 e4 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106bf2:	6a 00                	push   $0x0
  pushl $105
80106bf4:	6a 69                	push   $0x69
  jmp alltraps
80106bf6:	e9 db f5 ff ff       	jmp    801061d6 <alltraps>
...
80106bfb:	6a 00                	push   $0x0
  pushl $106
80106bfd:	6a 6a                	push   $0x6a
  jmp alltraps
80106bff:	e9 d2 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c04:	6a 00                	push   $0x0
  pushl $107
80106c06:	6a 6b                	push   $0x6b
  jmp alltraps
80106c08:	e9 c9 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c0d:	6a 00                	push   $0x0
  pushl $108
80106c0f:	6a 6c                	push   $0x6c
  jmp alltraps
80106c11:	e9 c0 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c16:	6a 00                	push   $0x0
  pushl $109
80106c18:	6a 6d                	push   $0x6d
  jmp alltraps
80106c1a:	e9 b7 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c1f:	6a 00                	push   $0x0
  pushl $110
80106c21:	6a 6e                	push   $0x6e
  jmp alltraps
80106c23:	e9 ae f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c28:	6a 00                	push   $0x0
  pushl $111
80106c2a:	6a 6f                	push   $0x6f
  jmp alltraps
80106c2c:	e9 a5 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c31:	6a 00                	push   $0x0
  pushl $112
80106c33:	6a 70                	push   $0x70
  jmp alltraps
80106c35:	e9 9c f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c3a:	6a 00                	push   $0x0
  pushl $113
80106c3c:	6a 71                	push   $0x71
  jmp alltraps
80106c3e:	e9 93 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c43:	6a 00                	push   $0x0
  pushl $114
80106c45:	6a 72                	push   $0x72
  jmp alltraps
80106c47:	e9 8a f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c4c:	6a 00                	push   $0x0
  pushl $115
80106c4e:	6a 73                	push   $0x73
  jmp alltraps
80106c50:	e9 81 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c55:	6a 00                	push   $0x0
  pushl $116
80106c57:	6a 74                	push   $0x74
  jmp alltraps
80106c59:	e9 78 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c5e:	6a 00                	push   $0x0
  pushl $117
80106c60:	6a 75                	push   $0x75
  jmp alltraps
80106c62:	e9 6f f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c67:	6a 00                	push   $0x0
  pushl $118
80106c69:	6a 76                	push   $0x76
  jmp alltraps
80106c6b:	e9 66 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c70:	6a 00                	push   $0x0
  pushl $119
80106c72:	6a 77                	push   $0x77
  jmp alltraps
80106c74:	e9 5d f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c79:	6a 00                	push   $0x0
  pushl $120
80106c7b:	6a 78                	push   $0x78
  jmp alltraps
80106c7d:	e9 54 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c82:	6a 00                	push   $0x0
  pushl $121
80106c84:	6a 79                	push   $0x79
  jmp alltraps
80106c86:	e9 4b f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c8b:	6a 00                	push   $0x0
  pushl $122
80106c8d:	6a 7a                	push   $0x7a
  jmp alltraps
80106c8f:	e9 42 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c94:	6a 00                	push   $0x0
  pushl $123
80106c96:	6a 7b                	push   $0x7b
  jmp alltraps
80106c98:	e9 39 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106c9d:	6a 00                	push   $0x0
  pushl $124
80106c9f:	6a 7c                	push   $0x7c
  jmp alltraps
80106ca1:	e9 30 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106ca6:	6a 00                	push   $0x0
  pushl $125
80106ca8:	6a 7d                	push   $0x7d
  jmp alltraps
80106caa:	e9 27 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106caf:	6a 00                	push   $0x0
  pushl $126
80106cb1:	6a 7e                	push   $0x7e
  jmp alltraps
80106cb3:	e9 1e f5 ff ff       	jmp    801061d6 <alltraps>
...
80106cb8:	6a 00                	push   $0x0
  pushl $127
80106cba:	6a 7f                	push   $0x7f
  jmp alltraps
80106cbc:	e9 15 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106cc1:	6a 00                	push   $0x0
  pushl $128
80106cc3:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106cc8:	e9 09 f5 ff ff       	jmp    801061d6 <alltraps>
...
80106ccd:	6a 00                	push   $0x0
  pushl $129
80106ccf:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106cd4:	e9 fd f4 ff ff       	jmp    801061d6 <alltraps>
...
80106cd9:	6a 00                	push   $0x0
  pushl $130
80106cdb:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106ce0:	e9 f1 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106ce5:	6a 00                	push   $0x0
  pushl $131
80106ce7:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106cec:	e9 e5 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106cf1:	6a 00                	push   $0x0
  pushl $132
80106cf3:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106cf8:	e9 d9 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106cfd:	6a 00                	push   $0x0
  pushl $133
80106cff:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106d04:	e9 cd f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d09:	6a 00                	push   $0x0
  pushl $134
80106d0b:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106d10:	e9 c1 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d15:	6a 00                	push   $0x0
  pushl $135
80106d17:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106d1c:	e9 b5 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d21:	6a 00                	push   $0x0
  pushl $136
80106d23:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106d28:	e9 a9 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d2d:	6a 00                	push   $0x0
  pushl $137
80106d2f:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106d34:	e9 9d f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d39:	6a 00                	push   $0x0
  pushl $138
80106d3b:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106d40:	e9 91 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d45:	6a 00                	push   $0x0
  pushl $139
80106d47:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106d4c:	e9 85 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d51:	6a 00                	push   $0x0
  pushl $140
80106d53:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106d58:	e9 79 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d5d:	6a 00                	push   $0x0
  pushl $141
80106d5f:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106d64:	e9 6d f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d69:	6a 00                	push   $0x0
  pushl $142
80106d6b:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106d70:	e9 61 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d75:	6a 00                	push   $0x0
  pushl $143
80106d77:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106d7c:	e9 55 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d81:	6a 00                	push   $0x0
  pushl $144
80106d83:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106d88:	e9 49 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d8d:	6a 00                	push   $0x0
  pushl $145
80106d8f:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106d94:	e9 3d f4 ff ff       	jmp    801061d6 <alltraps>
...
80106d99:	6a 00                	push   $0x0
  pushl $146
80106d9b:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106da0:	e9 31 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106da5:	6a 00                	push   $0x0
  pushl $147
80106da7:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106dac:	e9 25 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106db1:	6a 00                	push   $0x0
  pushl $148
80106db3:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106db8:	e9 19 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106dbd:	6a 00                	push   $0x0
  pushl $149
80106dbf:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106dc4:	e9 0d f4 ff ff       	jmp    801061d6 <alltraps>
...
80106dc9:	6a 00                	push   $0x0
  pushl $150
80106dcb:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106dd0:	e9 01 f4 ff ff       	jmp    801061d6 <alltraps>
...
80106dd5:	6a 00                	push   $0x0
  pushl $151
80106dd7:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106ddc:	e9 f5 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106de1:	6a 00                	push   $0x0
  pushl $152
80106de3:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106de8:	e9 e9 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106ded:	6a 00                	push   $0x0
  pushl $153
80106def:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106df4:	e9 dd f3 ff ff       	jmp    801061d6 <alltraps>
...
80106df9:	6a 00                	push   $0x0
  pushl $154
80106dfb:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106e00:	e9 d1 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e05:	6a 00                	push   $0x0
  pushl $155
80106e07:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106e0c:	e9 c5 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e11:	6a 00                	push   $0x0
  pushl $156
80106e13:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106e18:	e9 b9 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e1d:	6a 00                	push   $0x0
  pushl $157
80106e1f:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106e24:	e9 ad f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e29:	6a 00                	push   $0x0
  pushl $158
80106e2b:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106e30:	e9 a1 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e35:	6a 00                	push   $0x0
  pushl $159
80106e37:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106e3c:	e9 95 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e41:	6a 00                	push   $0x0
  pushl $160
80106e43:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106e48:	e9 89 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e4d:	6a 00                	push   $0x0
  pushl $161
80106e4f:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106e54:	e9 7d f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e59:	6a 00                	push   $0x0
  pushl $162
80106e5b:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106e60:	e9 71 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e65:	6a 00                	push   $0x0
  pushl $163
80106e67:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106e6c:	e9 65 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e71:	6a 00                	push   $0x0
  pushl $164
80106e73:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106e78:	e9 59 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e7d:	6a 00                	push   $0x0
  pushl $165
80106e7f:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106e84:	e9 4d f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e89:	6a 00                	push   $0x0
  pushl $166
80106e8b:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106e90:	e9 41 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106e95:	6a 00                	push   $0x0
  pushl $167
80106e97:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106e9c:	e9 35 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106ea1:	6a 00                	push   $0x0
  pushl $168
80106ea3:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106ea8:	e9 29 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106ead:	6a 00                	push   $0x0
  pushl $169
80106eaf:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106eb4:	e9 1d f3 ff ff       	jmp    801061d6 <alltraps>
...
80106eb9:	6a 00                	push   $0x0
  pushl $170
80106ebb:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106ec0:	e9 11 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106ec5:	6a 00                	push   $0x0
  pushl $171
80106ec7:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106ecc:	e9 05 f3 ff ff       	jmp    801061d6 <alltraps>
...
80106ed1:	6a 00                	push   $0x0
  pushl $172
80106ed3:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106ed8:	e9 f9 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106edd:	6a 00                	push   $0x0
  pushl $173
80106edf:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106ee4:	e9 ed f2 ff ff       	jmp    801061d6 <alltraps>
...
80106ee9:	6a 00                	push   $0x0
  pushl $174
80106eeb:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106ef0:	e9 e1 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106ef5:	6a 00                	push   $0x0
  pushl $175
80106ef7:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106efc:	e9 d5 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f01:	6a 00                	push   $0x0
  pushl $176
80106f03:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106f08:	e9 c9 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f0d:	6a 00                	push   $0x0
  pushl $177
80106f0f:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106f14:	e9 bd f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f19:	6a 00                	push   $0x0
  pushl $178
80106f1b:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106f20:	e9 b1 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f25:	6a 00                	push   $0x0
  pushl $179
80106f27:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106f2c:	e9 a5 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f31:	6a 00                	push   $0x0
  pushl $180
80106f33:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106f38:	e9 99 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f3d:	6a 00                	push   $0x0
  pushl $181
80106f3f:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106f44:	e9 8d f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f49:	6a 00                	push   $0x0
  pushl $182
80106f4b:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106f50:	e9 81 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f55:	6a 00                	push   $0x0
  pushl $183
80106f57:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106f5c:	e9 75 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f61:	6a 00                	push   $0x0
  pushl $184
80106f63:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106f68:	e9 69 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f6d:	6a 00                	push   $0x0
  pushl $185
80106f6f:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106f74:	e9 5d f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f79:	6a 00                	push   $0x0
  pushl $186
80106f7b:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106f80:	e9 51 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f85:	6a 00                	push   $0x0
  pushl $187
80106f87:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106f8c:	e9 45 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f91:	6a 00                	push   $0x0
  pushl $188
80106f93:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106f98:	e9 39 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106f9d:	6a 00                	push   $0x0
  pushl $189
80106f9f:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106fa4:	e9 2d f2 ff ff       	jmp    801061d6 <alltraps>
...
80106fa9:	6a 00                	push   $0x0
  pushl $190
80106fab:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106fb0:	e9 21 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106fb5:	6a 00                	push   $0x0
  pushl $191
80106fb7:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106fbc:	e9 15 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106fc1:	6a 00                	push   $0x0
  pushl $192
80106fc3:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106fc8:	e9 09 f2 ff ff       	jmp    801061d6 <alltraps>
...
80106fcd:	6a 00                	push   $0x0
  pushl $193
80106fcf:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106fd4:	e9 fd f1 ff ff       	jmp    801061d6 <alltraps>
...
80106fd9:	6a 00                	push   $0x0
  pushl $194
80106fdb:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106fe0:	e9 f1 f1 ff ff       	jmp    801061d6 <alltraps>
...
80106fe5:	6a 00                	push   $0x0
  pushl $195
80106fe7:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106fec:	e9 e5 f1 ff ff       	jmp    801061d6 <alltraps>
...
80106ff1:	6a 00                	push   $0x0
  pushl $196
80106ff3:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106ff8:	e9 d9 f1 ff ff       	jmp    801061d6 <alltraps>
...
80106ffd:	6a 00                	push   $0x0
  pushl $197
80106fff:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107004:	e9 cd f1 ff ff       	jmp    801061d6 <alltraps>
...
80107009:	6a 00                	push   $0x0
  pushl $198
8010700b:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107010:	e9 c1 f1 ff ff       	jmp    801061d6 <alltraps>
...
80107015:	6a 00                	push   $0x0
  pushl $199
80107017:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
8010701c:	e9 b5 f1 ff ff       	jmp    801061d6 <alltraps>
...
80107021:	6a 00                	push   $0x0
  pushl $200
80107023:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107028:	e9 a9 f1 ff ff       	jmp    801061d6 <alltraps>
...
8010702d:	6a 00                	push   $0x0
  pushl $201
8010702f:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107034:	e9 9d f1 ff ff       	jmp    801061d6 <alltraps>
...
80107039:	6a 00                	push   $0x0
  pushl $202
8010703b:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107040:	e9 91 f1 ff ff       	jmp    801061d6 <alltraps>
...
80107045:	6a 00                	push   $0x0
  pushl $203
80107047:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
8010704c:	e9 85 f1 ff ff       	jmp    801061d6 <alltraps>
...
80107051:	6a 00                	push   $0x0
  pushl $204
80107053:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107058:	e9 79 f1 ff ff       	jmp    801061d6 <alltraps>
...
8010705d:	6a 00                	push   $0x0
  pushl $205
8010705f:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107064:	e9 6d f1 ff ff       	jmp    801061d6 <alltraps>
...
80107069:	6a 00                	push   $0x0
  pushl $206
8010706b:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107070:	e9 61 f1 ff ff       	jmp    801061d6 <alltraps>
...
80107075:	6a 00                	push   $0x0
  pushl $207
80107077:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
8010707c:	e9 55 f1 ff ff       	jmp    801061d6 <alltraps>
...
80107081:	6a 00                	push   $0x0
  pushl $208
80107083:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107088:	e9 49 f1 ff ff       	jmp    801061d6 <alltraps>
...
8010708d:	6a 00                	push   $0x0
  pushl $209
8010708f:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107094:	e9 3d f1 ff ff       	jmp    801061d6 <alltraps>
...
80107099:	6a 00                	push   $0x0
  pushl $210
8010709b:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801070a0:	e9 31 f1 ff ff       	jmp    801061d6 <alltraps>
...
801070a5:	6a 00                	push   $0x0
  pushl $211
801070a7:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801070ac:	e9 25 f1 ff ff       	jmp    801061d6 <alltraps>
...
801070b1:	6a 00                	push   $0x0
  pushl $212
801070b3:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801070b8:	e9 19 f1 ff ff       	jmp    801061d6 <alltraps>
...
801070bd:	6a 00                	push   $0x0
  pushl $213
801070bf:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801070c4:	e9 0d f1 ff ff       	jmp    801061d6 <alltraps>
...
801070c9:	6a 00                	push   $0x0
  pushl $214
801070cb:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801070d0:	e9 01 f1 ff ff       	jmp    801061d6 <alltraps>
...
801070d5:	6a 00                	push   $0x0
  pushl $215
801070d7:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801070dc:	e9 f5 f0 ff ff       	jmp    801061d6 <alltraps>
...
801070e1:	6a 00                	push   $0x0
  pushl $216
801070e3:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801070e8:	e9 e9 f0 ff ff       	jmp    801061d6 <alltraps>
...
801070ed:	6a 00                	push   $0x0
  pushl $217
801070ef:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801070f4:	e9 dd f0 ff ff       	jmp    801061d6 <alltraps>
...
801070f9:	6a 00                	push   $0x0
  pushl $218
801070fb:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107100:	e9 d1 f0 ff ff       	jmp    801061d6 <alltraps>
...
80107105:	6a 00                	push   $0x0
  pushl $219
80107107:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
8010710c:	e9 c5 f0 ff ff       	jmp    801061d6 <alltraps>
...
80107111:	6a 00                	push   $0x0
  pushl $220
80107113:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107118:	e9 b9 f0 ff ff       	jmp    801061d6 <alltraps>
...
8010711d:	6a 00                	push   $0x0
  pushl $221
8010711f:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107124:	e9 ad f0 ff ff       	jmp    801061d6 <alltraps>
...
80107129:	6a 00                	push   $0x0
  pushl $222
8010712b:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107130:	e9 a1 f0 ff ff       	jmp    801061d6 <alltraps>
...
80107135:	6a 00                	push   $0x0
  pushl $223
80107137:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
8010713c:	e9 95 f0 ff ff       	jmp    801061d6 <alltraps>
...
80107141:	6a 00                	push   $0x0
  pushl $224
80107143:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107148:	e9 89 f0 ff ff       	jmp    801061d6 <alltraps>
...
8010714d:	6a 00                	push   $0x0
  pushl $225
8010714f:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107154:	e9 7d f0 ff ff       	jmp    801061d6 <alltraps>
...
80107159:	6a 00                	push   $0x0
  pushl $226
8010715b:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107160:	e9 71 f0 ff ff       	jmp    801061d6 <alltraps>
...
80107165:	6a 00                	push   $0x0
  pushl $227
80107167:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
8010716c:	e9 65 f0 ff ff       	jmp    801061d6 <alltraps>
...
80107171:	6a 00                	push   $0x0
  pushl $228
80107173:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107178:	e9 59 f0 ff ff       	jmp    801061d6 <alltraps>
...
8010717d:	6a 00                	push   $0x0
  pushl $229
8010717f:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107184:	e9 4d f0 ff ff       	jmp    801061d6 <alltraps>
...
80107189:	6a 00                	push   $0x0
  pushl $230
8010718b:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107190:	e9 41 f0 ff ff       	jmp    801061d6 <alltraps>
...
80107195:	6a 00                	push   $0x0
  pushl $231
80107197:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
8010719c:	e9 35 f0 ff ff       	jmp    801061d6 <alltraps>
...
801071a1:	6a 00                	push   $0x0
  pushl $232
801071a3:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801071a8:	e9 29 f0 ff ff       	jmp    801061d6 <alltraps>
...
801071ad:	6a 00                	push   $0x0
  pushl $233
801071af:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801071b4:	e9 1d f0 ff ff       	jmp    801061d6 <alltraps>
...
801071b9:	6a 00                	push   $0x0
  pushl $234
801071bb:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801071c0:	e9 11 f0 ff ff       	jmp    801061d6 <alltraps>
...
801071c5:	6a 00                	push   $0x0
  pushl $235
801071c7:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801071cc:	e9 05 f0 ff ff       	jmp    801061d6 <alltraps>
...
801071d1:	6a 00                	push   $0x0
  pushl $236
801071d3:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801071d8:	e9 f9 ef ff ff       	jmp    801061d6 <alltraps>
...
801071dd:	6a 00                	push   $0x0
  pushl $237
801071df:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801071e4:	e9 ed ef ff ff       	jmp    801061d6 <alltraps>
...
801071e9:	6a 00                	push   $0x0
  pushl $238
801071eb:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801071f0:	e9 e1 ef ff ff       	jmp    801061d6 <alltraps>
...
801071f5:	6a 00                	push   $0x0
  pushl $239
801071f7:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801071fc:	e9 d5 ef ff ff       	jmp    801061d6 <alltraps>
...
80107201:	6a 00                	push   $0x0
  pushl $240
80107203:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107208:	e9 c9 ef ff ff       	jmp    801061d6 <alltraps>
...
8010720d:	6a 00                	push   $0x0
  pushl $241
8010720f:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107214:	e9 bd ef ff ff       	jmp    801061d6 <alltraps>
...
80107219:	6a 00                	push   $0x0
  pushl $242
8010721b:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107220:	e9 b1 ef ff ff       	jmp    801061d6 <alltraps>
...
80107225:	6a 00                	push   $0x0
  pushl $243
80107227:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
8010722c:	e9 a5 ef ff ff       	jmp    801061d6 <alltraps>
...
80107231:	6a 00                	push   $0x0
  pushl $244
80107233:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107238:	e9 99 ef ff ff       	jmp    801061d6 <alltraps>
...
8010723d:	6a 00                	push   $0x0
  pushl $245
8010723f:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107244:	e9 8d ef ff ff       	jmp    801061d6 <alltraps>
...
80107249:	6a 00                	push   $0x0
  pushl $246
8010724b:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107250:	e9 81 ef ff ff       	jmp    801061d6 <alltraps>
...
80107255:	6a 00                	push   $0x0
  pushl $247
80107257:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
8010725c:	e9 75 ef ff ff       	jmp    801061d6 <alltraps>
...
80107261:	6a 00                	push   $0x0
  pushl $248
80107263:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107268:	e9 69 ef ff ff       	jmp    801061d6 <alltraps>
...
8010726d:	6a 00                	push   $0x0
  pushl $249
8010726f:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107274:	e9 5d ef ff ff       	jmp    801061d6 <alltraps>
...
80107279:	6a 00                	push   $0x0
  pushl $250
8010727b:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107280:	e9 51 ef ff ff       	jmp    801061d6 <alltraps>
...
80107285:	6a 00                	push   $0x0
  pushl $251
80107287:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
8010728c:	e9 45 ef ff ff       	jmp    801061d6 <alltraps>
...
80107291:	6a 00                	push   $0x0
  pushl $252
80107293:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107298:	e9 39 ef ff ff       	jmp    801061d6 <alltraps>
...
8010729d:	6a 00                	push   $0x0
  pushl $253
8010729f:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801072a4:	e9 2d ef ff ff       	jmp    801061d6 <alltraps>
...
801072a9:	6a 00                	push   $0x0
  pushl $254
801072ab:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801072b0:	e9 21 ef ff ff       	jmp    801061d6 <alltraps>
...
801072b5:	6a 00                	push   $0x0
  pushl $255
801072b7:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801072bc:	e9 15 ef ff ff       	jmp    801061d6 <alltraps>
...
{
801072c1:	55                   	push   %ebp
801072c2:	89 e5                	mov    %esp,%ebp
801072c4:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801072c7:	8b 45 0c             	mov    0xc(%ebp),%eax
801072ca:	83 e8 01             	sub    $0x1,%eax
801072cd:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801072d1:	8b 45 08             	mov    0x8(%ebp),%eax
801072d4:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801072d8:	8b 45 08             	mov    0x8(%ebp),%eax
801072db:	c1 e8 10             	shr    $0x10,%eax
801072de:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
801072e2:	8d 45 fa             	lea    -0x6(%ebp),%eax
801072e5:	0f 01 10             	lgdtl  (%eax)
}
801072e8:	c9                   	leave  
801072e9:	c3                   	ret    
...
801072ed:	83 ec 04             	sub    $0x4,%esp
801072f0:	8b 45 08             	mov    0x8(%ebp),%eax
801072f3:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
801072f7:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801072fb:	0f 00 d8             	ltr    %ax
}
801072fe:	c9                   	leave  
801072ff:	c3                   	ret    
...
80107326:	05 00 00 00 80       	add    $0x80000000,%eax
8010732b:	5d                   	pop    %ebp
8010732c:	c3                   	ret    
...
80107333:	05 00 00 00 80       	add    $0x80000000,%eax
80107338:	5d                   	pop    %ebp
80107339:	c3                   	ret    
...
8010733e:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107341:	e8 01 bb ff ff       	call   80102e47 <cpunum>
80107346:	89 c2                	mov    %eax,%edx
80107348:	89 d0                	mov    %edx,%eax
8010734a:	01 c0                	add    %eax,%eax
8010734c:	01 d0                	add    %edx,%eax
8010734e:	c1 e0 06             	shl    $0x6,%eax
80107351:	05 20 f9 10 80       	add    $0x8010f920,%eax
80107356:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107359:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010735c:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107362:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107365:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
8010736b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010736e:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107372:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107375:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107379:	83 e2 f0             	and    $0xfffffff0,%edx
8010737c:	83 ca 0a             	or     $0xa,%edx
8010737f:	88 50 7d             	mov    %dl,0x7d(%eax)
80107382:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107385:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107389:	83 ca 10             	or     $0x10,%edx
8010738c:	88 50 7d             	mov    %dl,0x7d(%eax)
8010738f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107392:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107396:	83 e2 9f             	and    $0xffffff9f,%edx
80107399:	88 50 7d             	mov    %dl,0x7d(%eax)
8010739c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010739f:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801073a3:	83 ca 80             	or     $0xffffff80,%edx
801073a6:	88 50 7d             	mov    %dl,0x7d(%eax)
801073a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073ac:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801073b0:	83 ca 0f             	or     $0xf,%edx
801073b3:	88 50 7e             	mov    %dl,0x7e(%eax)
801073b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073b9:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801073bd:	83 e2 ef             	and    $0xffffffef,%edx
801073c0:	88 50 7e             	mov    %dl,0x7e(%eax)
801073c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073c6:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801073ca:	83 e2 df             	and    $0xffffffdf,%edx
801073cd:	88 50 7e             	mov    %dl,0x7e(%eax)
801073d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073d3:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801073d7:	83 ca 40             	or     $0x40,%edx
801073da:	88 50 7e             	mov    %dl,0x7e(%eax)
801073dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073e0:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801073e4:	83 ca 80             	or     $0xffffff80,%edx
801073e7:	88 50 7e             	mov    %dl,0x7e(%eax)
801073ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073ed:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801073f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073f4:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
801073fb:	ff ff 
801073fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107400:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107407:	00 00 
80107409:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010740c:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107413:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107416:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010741d:	83 e2 f0             	and    $0xfffffff0,%edx
80107420:	83 ca 02             	or     $0x2,%edx
...
80107446:	83 e2 9f             	and    $0xffffff9f,%edx
80107449:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010744f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107452:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107459:	83 ca 80             	or     $0xffffff80,%edx
8010745c:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107462:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107465:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010746c:	83 ca 0f             	or     $0xf,%edx
...
8010747f:	83 e2 ef             	and    $0xffffffef,%edx
...
80107492:	83 e2 df             	and    $0xffffffdf,%edx
80107495:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010749b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010749e:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801074a5:	83 ca 40             	or     $0x40,%edx
801074a8:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801074ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074b1:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801074b8:	83 ca 80             	or     $0xffffff80,%edx
801074bb:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801074c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074c4:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801074cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074ce:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
801074d5:	ff ff 
801074d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074da:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
801074e1:	00 00 
801074e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074e6:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
801074ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074f0:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801074f7:	83 e2 f0             	and    $0xfffffff0,%edx
801074fa:	83 ca 0a             	or     $0xa,%edx
...
80107559:	83 e2 ef             	and    $0xffffffef,%edx
...
8010756c:	83 e2 df             	and    $0xffffffdf,%edx
...
8010757f:	83 ca 40             	or     $0x40,%edx
80107582:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107588:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010758b:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107592:	83 ca 80             	or     $0xffffff80,%edx
80107595:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
8010759b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010759e:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801075a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075a8:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801075af:	ff ff 
801075b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075b4:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
801075bb:	00 00 
801075bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075c0:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
801075c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075ca:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801075d1:	83 e2 f0             	and    $0xfffffff0,%edx
801075d4:	83 ca 02             	or     $0x2,%edx
...
801075e7:	83 ca 10             	or     $0x10,%edx
801075ea:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801075f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075f3:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801075fa:	83 ca 60             	or     $0x60,%edx
801075fd:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107603:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107606:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010760d:	83 ca 80             	or     $0xffffff80,%edx
80107610:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107616:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107619:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107620:	83 ca 0f             	or     $0xf,%edx
...
80107633:	83 e2 ef             	and    $0xffffffef,%edx
...
80107646:	83 e2 df             	and    $0xffffffdf,%edx
80107649:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010764f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107652:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107659:	83 ca 40             	or     $0x40,%edx
8010765c:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107662:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107665:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010766c:	83 ca 80             	or     $0xffffff80,%edx
8010766f:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107675:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107678:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010767f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107682:	05 b4 00 00 00       	add    $0xb4,%eax
80107687:	89 c3                	mov    %eax,%ebx
80107689:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010768c:	05 b4 00 00 00       	add    $0xb4,%eax
80107691:	c1 e8 10             	shr    $0x10,%eax
80107694:	89 c1                	mov    %eax,%ecx
80107696:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107699:	05 b4 00 00 00       	add    $0xb4,%eax
8010769e:	c1 e8 18             	shr    $0x18,%eax
801076a1:	89 c2                	mov    %eax,%edx
801076a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076a6:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
801076ad:	00 00 
801076af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076b2:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
801076b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076bc:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
801076c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076c5:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801076cc:	83 e1 f0             	and    $0xfffffff0,%ecx
801076cf:	83 c9 02             	or     $0x2,%ecx
...
801076e2:	83 c9 10             	or     $0x10,%ecx
801076e5:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801076eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076ee:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801076f5:	83 e1 9f             	and    $0xffffff9f,%ecx
801076f8:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801076fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107701:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107708:	83 c9 80             	or     $0xffffff80,%ecx
8010770b:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107711:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107714:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010771b:	83 e1 f0             	and    $0xfffffff0,%ecx
...
8010772e:	83 e1 ef             	and    $0xffffffef,%ecx
...
80107741:	83 e1 df             	and    $0xffffffdf,%ecx
80107744:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010774a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010774d:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107754:	83 c9 40             	or     $0x40,%ecx
80107757:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010775d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107760:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107767:	83 c9 80             	or     $0xffffff80,%ecx
8010776a:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107770:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107773:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107779:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010777c:	83 c0 70             	add    $0x70,%eax
8010777f:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107786:	00 
80107787:	89 04 24             	mov    %eax,(%esp)
8010778a:	e8 32 fb ff ff       	call   801072c1 <lgdt>
  loadgs(SEG_KCPU << 3);
8010778f:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107796:	e8 65 fb ff ff       	call   80107300 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
8010779b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010779e:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801077a4:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801077ab:	00 00 00 00 
}
801077af:	83 c4 24             	add    $0x24,%esp
801077b2:	5b                   	pop    %ebx
801077b3:	5d                   	pop    %ebp
801077b4:	c3                   	ret    
...
801077b8:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801077bb:	8b 45 0c             	mov    0xc(%ebp),%eax
801077be:	c1 e8 16             	shr    $0x16,%eax
801077c1:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801077c8:	8b 45 08             	mov    0x8(%ebp),%eax
801077cb:	01 d0                	add    %edx,%eax
801077cd:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
801077d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801077d3:	8b 00                	mov    (%eax),%eax
801077d5:	83 e0 01             	and    $0x1,%eax
801077d8:	85 c0                	test   %eax,%eax
801077da:	74 17                	je     801077f3 <walkpgdir+0x3e>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
801077dc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801077df:	8b 00                	mov    (%eax),%eax
801077e1:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801077e6:	89 04 24             	mov    %eax,(%esp)
801077e9:	e8 3f fb ff ff       	call   8010732d <p2v>
801077ee:	89 45 f4             	mov    %eax,-0xc(%ebp)
801077f1:	eb 4b                	jmp    8010783e <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801077f3:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801077f7:	74 0e                	je     80107807 <walkpgdir+0x52>
801077f9:	e8 d0 b2 ff ff       	call   80102ace <kalloc>
801077fe:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107801:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107805:	75 07                	jne    8010780e <walkpgdir+0x59>
      return 0;
80107807:	b8 00 00 00 00       	mov    $0x0,%eax
8010780c:	eb 47                	jmp    80107855 <walkpgdir+0xa0>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
8010780e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107815:	00 
80107816:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010781d:	00 
8010781e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107821:	89 04 24             	mov    %eax,(%esp)
80107824:	e8 89 d5 ff ff       	call   80104db2 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table 
    // entries, if necessary.
    *pde = v2p(pgtab) | PTE_P | PTE_W | PTE_U;
80107829:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010782c:	89 04 24             	mov    %eax,(%esp)
8010782f:	e8 ec fa ff ff       	call   80107320 <v2p>
80107834:	83 c8 07             	or     $0x7,%eax
80107837:	89 c2                	mov    %eax,%edx
80107839:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010783c:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
8010783e:	8b 45 0c             	mov    0xc(%ebp),%eax
80107841:	c1 e8 0c             	shr    $0xc,%eax
80107844:	25 ff 03 00 00       	and    $0x3ff,%eax
80107849:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107850:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107853:	01 d0                	add    %edx,%eax
}
80107855:	c9                   	leave  
80107856:	c3                   	ret    
...
8010785a:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
  
  a = (char*)PGROUNDDOWN((uint)va);
8010785d:	8b 45 0c             	mov    0xc(%ebp),%eax
80107860:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107865:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107868:	8b 55 0c             	mov    0xc(%ebp),%edx
8010786b:	8b 45 10             	mov    0x10(%ebp),%eax
8010786e:	01 d0                	add    %edx,%eax
80107870:	83 e8 01             	sub    $0x1,%eax
80107873:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107878:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010787b:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107882:	00 
80107883:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107886:	89 44 24 04          	mov    %eax,0x4(%esp)
8010788a:	8b 45 08             	mov    0x8(%ebp),%eax
8010788d:	89 04 24             	mov    %eax,(%esp)
80107890:	e8 20 ff ff ff       	call   801077b5 <walkpgdir>
80107895:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107898:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010789c:	75 07                	jne    801078a5 <mappages+0x4e>
      return -1;
8010789e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801078a3:	eb 48                	jmp    801078ed <mappages+0x96>
    if(*pte & PTE_P)
801078a5:	8b 45 ec             	mov    -0x14(%ebp),%eax
801078a8:	8b 00                	mov    (%eax),%eax
801078aa:	83 e0 01             	and    $0x1,%eax
801078ad:	85 c0                	test   %eax,%eax
801078af:	74 0c                	je     801078bd <mappages+0x66>
      panic("remap");
801078b1:	c7 04 24 18 89 10 80 	movl   $0x80108918,(%esp)
801078b8:	e8 7d 8c ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
801078bd:	8b 45 18             	mov    0x18(%ebp),%eax
801078c0:	0b 45 14             	or     0x14(%ebp),%eax
801078c3:	83 c8 01             	or     $0x1,%eax
801078c6:	89 c2                	mov    %eax,%edx
801078c8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801078cb:	89 10                	mov    %edx,(%eax)
    if(a == last)
801078cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078d0:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801078d3:	75 08                	jne    801078dd <mappages+0x86>
      break;
801078d5:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
  ...
  return 0;
801078d6:	b8 00 00 00 00       	mov    $0x0,%eax
801078db:	eb 10                	jmp    801078ed <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
      break;
    a += PGSIZE;
801078dd:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
801078e4:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
801078eb:	eb 8e                	jmp    8010787b <mappages+0x24>
  return 0;
}
801078ed:	c9                   	leave  
801078ee:	c3                   	ret    
...
801078f2:	83 ec 48             	sub    $0x48,%esp
...
801078fb:	8b 55 0c             	mov    0xc(%ebp),%edx
801078fe:	8b 45 10             	mov    0x10(%ebp),%eax
80107901:	01 d0                	add    %edx,%eax
80107903:	85 c0                	test   %eax,%eax
80107905:	79 0a                	jns    80107911 <shmmanip+0x22>
    return -1;
80107907:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010790c:	e9 1a 02 00 00       	jmp    80107b2b <shmmanip+0x23c>

  a = PGROUNDUP(a);
80107911:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107914:	05 ff 0f 00 00       	add    $0xfff,%eax
80107919:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010791e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if (size == 0) {
80107921:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107925:	0f 85 1d 01 00 00    	jne    80107a48 <shmmanip+0x159>
    struct proc *owner = (void*) 0;
8010792b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)

    if ((owner = shmemowner(token)) == 0) {
80107932:	8b 45 08             	mov    0x8(%ebp),%eax
80107935:	89 04 24             	mov    %eax,(%esp)
80107938:	e8 bb ca ff ff       	call   801043f8 <shmemowner>
8010793d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107940:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107944:	75 16                	jne    8010795c <shmmanip+0x6d>
      cprintf ("Token not found!");
80107946:	c7 04 24 1e 89 10 80 	movl   $0x8010891e,(%esp)
8010794d:	e8 4e 8a ff ff       	call   801003a0 <cprintf>
      return -1;
80107952:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107957:	e9 cf 01 00 00       	jmp    80107b2b <shmmanip+0x23c>
...
8010795f:	8b 40 04             	mov    0x4(%eax),%eax
80107962:	89 45 e8             	mov    %eax,-0x18(%ebp)
    pte_t *pte;
    uint pa;
    uint i = (uint) proc->parent->startaddr;
80107965:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010796b:	8b 40 14             	mov    0x14(%eax),%eax
8010796e:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
...
8010797d:	8b 40 14             	mov    0x14(%eax),%eax
80107980:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80107986:	89 c2                	mov    %eax,%edx
80107988:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010798e:	8b 40 14             	mov    0x14(%eax),%eax
80107991:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
80107997:	01 d0                	add    %edx,%eax
80107999:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(; i < end; i += PGSIZE, a+=PGSIZE){
8010799c:	e9 91 00 00 00       	jmp    80107a32 <shmmanip+0x143>
      if((pte = walkpgdir(ppgdir, (void *) i, 0)) == 0)
801079a1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801079a4:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801079ab:	00 
801079ac:	89 44 24 04          	mov    %eax,0x4(%esp)
801079b0:	8b 45 e8             	mov    -0x18(%ebp),%eax
801079b3:	89 04 24             	mov    %eax,(%esp)
801079b6:	e8 fa fd ff ff       	call   801077b5 <walkpgdir>
801079bb:	89 45 e0             	mov    %eax,-0x20(%ebp)
801079be:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801079c2:	75 0c                	jne    801079d0 <shmmanip+0xe1>
        panic("shmget: pte should exist");
801079c4:	c7 04 24 2f 89 10 80 	movl   $0x8010892f,(%esp)
801079cb:	e8 6a 8b ff ff       	call   8010053a <panic>
      if(!(*pte & PTE_P))
801079d0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801079d3:	8b 00                	mov    (%eax),%eax
801079d5:	83 e0 01             	and    $0x1,%eax
801079d8:	85 c0                	test   %eax,%eax
801079da:	75 0c                	jne    801079e8 <shmmanip+0xf9>
        panic("shmget: page not present");
801079dc:	c7 04 24 48 89 10 80 	movl   $0x80108948,(%esp)
801079e3:	e8 52 8b ff ff       	call   8010053a <panic>
      pa = PTE_ADDR(*pte);
...
801079f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
801079f8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801079fe:	8b 40 04             	mov    0x4(%eax),%eax
80107a01:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107a08:	00 
80107a09:	8b 4d dc             	mov    -0x24(%ebp),%ecx
80107a0c:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80107a10:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107a17:	00 
80107a18:	89 54 24 04          	mov    %edx,0x4(%esp)
80107a1c:	89 04 24             	mov    %eax,(%esp)
80107a1f:	e8 33 fe ff ff       	call   80107857 <mappages>
    pde_t *ppgdir = owner->pgdir;
    pte_t *pte;
    uint pa;
    uint i = (uint) proc->parent->startaddr;
    uint end = ((uint) proc->parent->startaddr + proc->parent->shmem_size);
    for(; i < end; i += PGSIZE, a+=PGSIZE){
80107a24:	81 45 f0 00 10 00 00 	addl   $0x1000,-0x10(%ebp)
80107a2b:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107a32:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a35:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
80107a38:	0f 82 63 ff ff ff    	jb     801079a1 <shmmanip+0xb2>
      if(!(*pte & PTE_P))
        panic("shmget: page not present");
      pa = PTE_ADDR(*pte);
      mappages(proc->pgdir, (char*) a, PGSIZE, pa, PTE_W|PTE_U);
    ...
    return 0;
80107a3e:	b8 00 00 00 00       	mov    $0x0,%eax
80107a43:	e9 e3 00 00 00       	jmp    80107b2b <shmmanip+0x23c>
  }

  proc->startaddr = (void*) 0;
80107a48:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107a4e:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
80107a55:	00 00 00 
  for (; a < (uint)addr + size; a += PGSIZE) {
80107a58:	e9 9d 00 00 00       	jmp    80107afa <shmmanip+0x20b>
    mem = kalloc();
80107a5d:	e8 6c b0 ff ff       	call   80102ace <kalloc>
80107a62:	89 45 d8             	mov    %eax,-0x28(%ebp)
    if (mem == 0) {
80107a65:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
80107a69:	75 16                	jne    80107a81 <shmmanip+0x192>
      cprintf("shmget out of memory\n");
80107a6b:	c7 04 24 61 89 10 80 	movl   $0x80108961,(%esp)
80107a72:	e8 29 89 ff ff       	call   801003a0 <cprintf>
      return -1;
80107a77:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107a7c:	e9 aa 00 00 00       	jmp    80107b2b <shmmanip+0x23c>
    }
    memset(mem, 0, PGSIZE);
80107a81:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107a88:	00 
80107a89:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107a90:	00 
80107a91:	8b 45 d8             	mov    -0x28(%ebp),%eax
80107a94:	89 04 24             	mov    %eax,(%esp)
80107a97:	e8 16 d3 ff ff       	call   80104db2 <memset>
    mappages(proc->pgdir, (char*) a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107a9c:	8b 45 d8             	mov    -0x28(%ebp),%eax
80107a9f:	89 04 24             	mov    %eax,(%esp)
80107aa2:	e8 79 f8 ff ff       	call   80107320 <v2p>
80107aa7:	8b 4d f4             	mov    -0xc(%ebp),%ecx
80107aaa:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107ab1:	8b 52 04             	mov    0x4(%edx),%edx
...
80107ac7:	00 
80107ac8:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80107acc:	89 14 24             	mov    %edx,(%esp)
80107acf:	e8 83 fd ff ff       	call   80107857 <mappages>
    if (proc->startaddr == 0) {
80107ad4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107ada:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80107ae0:	85 c0                	test   %eax,%eax
80107ae2:	75 0f                	jne    80107af3 <shmmanip+0x204>
      proc->startaddr = (char*)a;
80107ae4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107aea:	8b 55 f4             	mov    -0xc(%ebp),%edx
80107aed:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
    }
    return 0;
  }
  ...
  proc->startaddr = (void*) 0;
  for (; a < (uint)addr + size; a += PGSIZE) {
80107af3:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107afa:	8b 55 0c             	mov    0xc(%ebp),%edx
80107afd:	8b 45 10             	mov    0x10(%ebp),%eax
80107b00:	01 d0                	add    %edx,%eax
80107b02:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80107b05:	0f 87 52 ff ff ff    	ja     80107a5d <shmmanip+0x16e>
    if (proc->startaddr == 0) {
      proc->startaddr = (char*)a;
    }
  }
...
80107b0b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107b11:	8b 55 08             	mov    0x8(%ebp),%edx
80107b14:	89 50 7c             	mov    %edx,0x7c(%eax)
  proc->shmem_size = size;
80107b17:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107b1d:	8b 55 10             	mov    0x10(%ebp),%edx
80107b20:	89 90 84 00 00 00    	mov    %edx,0x84(%eax)
  return 0;
...
80107b30:	53                   	push   %ebx
80107b31:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107b34:	e8 95 af ff ff       	call   80102ace <kalloc>
80107b39:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107b3c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107b40:	75 0a                	jne    80107b4c <setupkvm+0x1f>
    return 0;
80107b42:	b8 00 00 00 00       	mov    $0x0,%eax
80107b47:	e9 98 00 00 00       	jmp    80107be4 <setupkvm+0xb7>
...
80107b62:	e8 4b d2 ff ff       	call   80104db2 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107b67:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107b6e:	e8 ba f7 ff ff       	call   8010732d <p2v>
80107b73:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107b78:	76 0c                	jbe    80107b86 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107b7a:	c7 04 24 77 89 10 80 	movl   $0x80108977,(%esp)
80107b81:	e8 b4 89 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107b86:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107b8d:	eb 49                	jmp    80107bd8 <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107b8f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b92:	8b 48 0c             	mov    0xc(%eax),%ecx
80107b95:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b98:	8b 50 04             	mov    0x4(%eax),%edx
80107b9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b9e:	8b 58 08             	mov    0x8(%eax),%ebx
80107ba1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ba4:	8b 40 04             	mov    0x4(%eax),%eax
80107ba7:	29 c3                	sub    %eax,%ebx
80107ba9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bac:	8b 00                	mov    (%eax),%eax
80107bae:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107bb2:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107bb6:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107bba:	89 44 24 04          	mov    %eax,0x4(%esp)
80107bbe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107bc1:	89 04 24             	mov    %eax,(%esp)
80107bc4:	e8 8e fc ff ff       	call   80107857 <mappages>
80107bc9:	85 c0                	test   %eax,%eax
80107bcb:	79 07                	jns    80107bd4 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107bcd:	b8 00 00 00 00       	mov    $0x0,%eax
80107bd2:	eb 10                	jmp    80107be4 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107bd4:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107bd8:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107bdf:	72 ae                	jb     80107b8f <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107be4:	83 c4 34             	add    $0x34,%esp
80107be7:	5b                   	pop    %ebx
80107be8:	5d                   	pop    %ebp
80107be9:	c3                   	ret    
...
80107bed:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107bf0:	e8 38 ff ff ff       	call   80107b2d <setupkvm>
80107bf5:	a3 18 2b 11 80       	mov    %eax,0x80112b18
  switchkvm();
80107bfa:	e8 02 00 00 00       	call   80107c01 <switchkvm>
}
80107bff:	c9                   	leave  
80107c00:	c3                   	ret    
...
80107c04:	83 ec 04             	sub    $0x4,%esp
  lcr3(v2p(kpgdir));   // switch to the kernel page table
80107c07:	a1 18 2b 11 80       	mov    0x80112b18,%eax
80107c0c:	89 04 24             	mov    %eax,(%esp)
80107c0f:	e8 0c f7 ff ff       	call   80107320 <v2p>
80107c14:	89 04 24             	mov    %eax,(%esp)
80107c17:	e8 f9 f6 ff ff       	call   80107315 <lcr3>
}
80107c1c:	c9                   	leave  
80107c1d:	c3                   	ret    
...
80107c21:	53                   	push   %ebx
80107c22:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107c25:	e8 88 d0 ff ff       	call   80104cb2 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107c2a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107c30:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107c37:	83 c2 08             	add    $0x8,%edx
80107c3a:	89 d3                	mov    %edx,%ebx
80107c3c:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107c43:	83 c2 08             	add    $0x8,%edx
80107c46:	c1 ea 10             	shr    $0x10,%edx
80107c49:	89 d1                	mov    %edx,%ecx
80107c4b:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107c52:	83 c2 08             	add    $0x8,%edx
80107c55:	c1 ea 18             	shr    $0x18,%edx
80107c58:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107c5f:	67 00 
80107c61:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107c68:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107c6e:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107c75:	83 e1 f0             	and    $0xfffffff0,%ecx
80107c78:	83 c9 09             	or     $0x9,%ecx
80107c7b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107c81:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107c88:	83 c9 10             	or     $0x10,%ecx
80107c8b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107c91:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107c98:	83 e1 9f             	and    $0xffffff9f,%ecx
80107c9b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107ca1:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107ca8:	83 c9 80             	or     $0xffffff80,%ecx
80107cab:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107cb1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107cb8:	83 e1 f0             	and    $0xfffffff0,%ecx
80107cbb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107cc1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107cc8:	83 e1 ef             	and    $0xffffffef,%ecx
80107ccb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107cd1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107cd8:	83 e1 df             	and    $0xffffffdf,%ecx
80107cdb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ce1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107ce8:	83 c9 40             	or     $0x40,%ecx
80107ceb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107cf1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107cf8:	83 e1 7f             	and    $0x7f,%ecx
80107cfb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d01:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107d07:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d0d:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80107d14:	83 e2 ef             	and    $0xffffffef,%edx
80107d17:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107d1d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d23:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107d29:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d2f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107d36:	8b 52 08             	mov    0x8(%edx),%edx
80107d39:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107d3f:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107d42:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107d49:	e8 9c f5 ff ff       	call   801072ea <ltr>
  if(p->pgdir == 0)
80107d4e:	8b 45 08             	mov    0x8(%ebp),%eax
80107d51:	8b 40 04             	mov    0x4(%eax),%eax
80107d54:	85 c0                	test   %eax,%eax
80107d56:	75 0c                	jne    80107d64 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107d58:	c7 04 24 88 89 10 80 	movl   $0x80108988,(%esp)
80107d5f:	e8 d6 87 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107d64:	8b 45 08             	mov    0x8(%ebp),%eax
80107d67:	8b 40 04             	mov    0x4(%eax),%eax
80107d6a:	89 04 24             	mov    %eax,(%esp)
80107d6d:	e8 ae f5 ff ff       	call   80107320 <v2p>
80107d72:	89 04 24             	mov    %eax,(%esp)
80107d75:	e8 9b f5 ff ff       	call   80107315 <lcr3>
  popcli();
80107d7a:	e8 77 cf ff ff       	call   80104cf6 <popcli>
}
80107d7f:	83 c4 14             	add    $0x14,%esp
80107d82:	5b                   	pop    %ebx
80107d83:	5d                   	pop    %ebp
80107d84:	c3                   	ret    
...
80107d88:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107d8b:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107d92:	76 0c                	jbe    80107da0 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107d94:	c7 04 24 9c 89 10 80 	movl   $0x8010899c,(%esp)
80107d9b:	e8 9a 87 ff ff       	call   8010053a <panic>
  mem = kalloc();
80107da0:	e8 29 ad ff ff       	call   80102ace <kalloc>
80107da5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80107da8:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107daf:	00 
80107db0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107db7:	00 
80107db8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dbb:	89 04 24             	mov    %eax,(%esp)
80107dbe:	e8 ef cf ff ff       	call   80104db2 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107dc3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc6:	89 04 24             	mov    %eax,(%esp)
80107dc9:	e8 52 f5 ff ff       	call   80107320 <v2p>
80107dce:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107dd5:	00 
80107dd6:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107dda:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107de1:	00 
80107de2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107de9:	00 
80107dea:	8b 45 08             	mov    0x8(%ebp),%eax
80107ded:	89 04 24             	mov    %eax,(%esp)
80107df0:	e8 62 fa ff ff       	call   80107857 <mappages>
  memmove(mem, init, sz);
80107df5:	8b 45 10             	mov    0x10(%ebp),%eax
80107df8:	89 44 24 08          	mov    %eax,0x8(%esp)
80107dfc:	8b 45 0c             	mov    0xc(%ebp),%eax
80107dff:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e06:	89 04 24             	mov    %eax,(%esp)
80107e09:	e8 73 d0 ff ff       	call   80104e81 <memmove>
}
80107e0e:	c9                   	leave  
80107e0f:	c3                   	ret    
...
80107e14:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107e17:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e1a:	25 ff 0f 00 00       	and    $0xfff,%eax
80107e1f:	85 c0                	test   %eax,%eax
80107e21:	74 0c                	je     80107e2f <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80107e23:	c7 04 24 b8 89 10 80 	movl   $0x801089b8,(%esp)
80107e2a:	e8 0b 87 ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107e2f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107e36:	e9 a9 00 00 00       	jmp    80107ee4 <loaduvm+0xd4>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107e3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e3e:	8b 55 0c             	mov    0xc(%ebp),%edx
80107e41:	01 d0                	add    %edx,%eax
80107e43:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107e4a:	00 
80107e4b:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e4f:	8b 45 08             	mov    0x8(%ebp),%eax
80107e52:	89 04 24             	mov    %eax,(%esp)
80107e55:	e8 5b f9 ff ff       	call   801077b5 <walkpgdir>
80107e5a:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107e5d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107e61:	75 0c                	jne    80107e6f <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80107e63:	c7 04 24 db 89 10 80 	movl   $0x801089db,(%esp)
...
80107e7f:	8b 55 18             	mov    0x18(%ebp),%edx
80107e82:	29 c2                	sub    %eax,%edx
80107e84:	89 d0                	mov    %edx,%eax
80107e86:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107e8b:	77 0f                	ja     80107e9c <loaduvm+0x8c>
      n = sz - i;
80107e8d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e90:	8b 55 18             	mov    0x18(%ebp),%edx
80107e93:	29 c2                	sub    %eax,%edx
80107e95:	89 d0                	mov    %edx,%eax
80107e97:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107e9a:	eb 07                	jmp    80107ea3 <loaduvm+0x93>
    else
      n = PGSIZE;
80107e9c:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80107ea3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ea6:	8b 55 14             	mov    0x14(%ebp),%edx
80107ea9:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80107eac:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107eaf:	89 04 24             	mov    %eax,(%esp)
80107eb2:	e8 76 f4 ff ff       	call   8010732d <p2v>
80107eb7:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107eba:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107ebe:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107ec2:	89 44 24 04          	mov    %eax,0x4(%esp)
80107ec6:	8b 45 10             	mov    0x10(%ebp),%eax
80107ec9:	89 04 24             	mov    %eax,(%esp)
80107ecc:	e8 83 9e ff ff       	call   80101d54 <readi>
80107ed1:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107ed4:	74 07                	je     80107edd <loaduvm+0xcd>
      return -1;
80107ed6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107edb:	eb 18                	jmp    80107ef5 <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
...
80107eea:	0f 82 4b ff ff ff    	jb     80107e3b <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80107ef5:	83 c4 24             	add    $0x24,%esp
80107ef8:	5b                   	pop    %ebx
80107ef9:	5d                   	pop    %ebp
80107efa:	c3                   	ret    
...
80107efe:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107f06:	79 0a                	jns    80107f12 <allocuvm+0x17>
    return 0;
80107f08:	b8 00 00 00 00       	mov    $0x0,%eax
80107f0d:	e9 c1 00 00 00       	jmp    80107fd3 <allocuvm+0xd8>
  if(newsz < oldsz)
80107f12:	8b 45 10             	mov    0x10(%ebp),%eax
80107f15:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107f18:	73 08                	jae    80107f22 <allocuvm+0x27>
    return oldsz;
80107f1a:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f1d:	e9 b1 00 00 00       	jmp    80107fd3 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80107f22:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f25:	05 ff 0f 00 00       	add    $0xfff,%eax
80107f2a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107f2f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80107f32:	e9 8d 00 00 00       	jmp    80107fc4 <allocuvm+0xc9>
    mem = kalloc();
80107f37:	e8 92 ab ff ff       	call   80102ace <kalloc>
80107f3c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107f3f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107f43:	75 2c                	jne    80107f71 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80107f45:	c7 04 24 f9 89 10 80 	movl   $0x801089f9,(%esp)
80107f4c:	e8 4f 84 ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107f51:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f54:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107f65:	e8 6b 00 00 00       	call   80107fd5 <deallocuvm>
      return 0;
80107f6a:	b8 00 00 00 00       	mov    $0x0,%eax
80107f6f:	eb 62                	jmp    80107fd3 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
...
80107f87:	e8 26 ce ff ff       	call   80104db2 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107f8c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107f8f:	89 04 24             	mov    %eax,(%esp)
80107f92:	e8 89 f3 ff ff       	call   80107320 <v2p>
...
80107fad:	00 
80107fae:	89 54 24 04          	mov    %edx,0x4(%esp)
80107fb2:	8b 45 08             	mov    0x8(%ebp),%eax
80107fb5:	89 04 24             	mov    %eax,(%esp)
80107fb8:	e8 9a f8 ff ff       	call   80107857 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80107fc7:	3b 45 10             	cmp    0x10(%ebp),%eax
80107fca:	0f 82 67 ff ff ff    	jb     80107f37 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80107fd8:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80107fdb:	8b 45 10             	mov    0x10(%ebp),%eax
80107fde:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107fe1:	72 08                	jb     80107feb <deallocuvm+0x16>
    return oldsz;
80107fe3:	8b 45 0c             	mov    0xc(%ebp),%eax
80107fe6:	e9 a4 00 00 00       	jmp    8010808f <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80107feb:	8b 45 10             	mov    0x10(%ebp),%eax
80107fee:	05 ff 0f 00 00       	add    $0xfff,%eax
80107ff3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107ff8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107ffb:	e9 80 00 00 00       	jmp    80108080 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108000:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108003:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010800a:	00 
8010800b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010800f:	8b 45 08             	mov    0x8(%ebp),%eax
80108012:	89 04 24             	mov    %eax,(%esp)
80108015:	e8 9b f7 ff ff       	call   801077b5 <walkpgdir>
8010801a:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
8010801d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108021:	75 09                	jne    8010802c <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80108023:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
8010802a:	eb 4d                	jmp    80108079 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
8010802c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010802f:	8b 00                	mov    (%eax),%eax
80108031:	83 e0 01             	and    $0x1,%eax
80108034:	85 c0                	test   %eax,%eax
80108036:	74 41                	je     80108079 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
80108049:	75 0c                	jne    80108057 <deallocuvm+0x82>
        panic("kfree");
8010804b:	c7 04 24 11 8a 10 80 	movl   $0x80108a11,(%esp)
80108052:	e8 e3 84 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
80108057:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010805a:	89 04 24             	mov    %eax,(%esp)
8010805d:	e8 cb f2 ff ff       	call   8010732d <p2v>
80108062:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108065:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108068:	89 04 24             	mov    %eax,(%esp)
8010806b:	e8 c5 a9 ff ff       	call   80102a35 <kfree>
      *pte = 0;
80108070:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108073:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
80108083:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108086:	0f 82 74 ff ff ff    	jb     80108000 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
  ...
  return newsz;
8010808c:	8b 45 10             	mov    0x10(%ebp),%eax
}
8010808f:	c9                   	leave  
80108090:	c3                   	ret    
...
80108094:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
80108097:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010809b:	75 0c                	jne    801080a9 <freevm+0x18>
    panic("freevm: no pgdir");
8010809d:	c7 04 24 17 8a 10 80 	movl   $0x80108a17,(%esp)
801080a4:	e8 91 84 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
801080a9:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801080b0:	00 
801080b1:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801080b8:	80 
801080b9:	8b 45 08             	mov    0x8(%ebp),%eax
801080bc:	89 04 24             	mov    %eax,(%esp)
801080bf:	e8 11 ff ff ff       	call   80107fd5 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801080c4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801080cb:	eb 48                	jmp    80108115 <freevm+0x84>
    if(pgdir[i] & PTE_P){
801080cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080d0:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801080d7:	8b 45 08             	mov    0x8(%ebp),%eax
801080da:	01 d0                	add    %edx,%eax
801080dc:	8b 00                	mov    (%eax),%eax
801080de:	83 e0 01             	and    $0x1,%eax
801080e1:	85 c0                	test   %eax,%eax
801080e3:	74 2c                	je     80108111 <freevm+0x80>
      char * v = p2v(PTE_ADDR(pgdir[i]));
801080e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080e8:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
801080fe:	e8 2a f2 ff ff       	call   8010732d <p2v>
80108103:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80108106:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108109:	89 04 24             	mov    %eax,(%esp)
8010810c:	e8 24 a9 ff ff       	call   80102a35 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108111:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108115:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
8010811c:	76 af                	jbe    801080cd <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80108124:	e8 0c a9 ff ff       	call   80102a35 <kfree>
}
80108129:	c9                   	leave  
8010812a:	c3                   	ret    
...
8010812e:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108131:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108138:	00 
...
80108146:	e8 6a f6 ff ff       	call   801077b5 <walkpgdir>
8010814b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
8010814e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108152:	75 0c                	jne    80108160 <clearpteu+0x35>
    panic("clearpteu");
80108154:	c7 04 24 28 8a 10 80 	movl   $0x80108a28,(%esp)
8010815b:	e8 da 83 ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
80108160:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108163:	8b 00                	mov    (%eax),%eax
80108165:	83 e0 fb             	and    $0xfffffffb,%eax
80108168:	89 c2                	mov    %eax,%edx
8010816a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010816d:	89 10                	mov    %edx,(%eax)
}
8010816f:	c9                   	leave  
80108170:	c3                   	ret    
...
80108174:	53                   	push   %ebx
80108175:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108178:	e8 b0 f9 ff ff       	call   80107b2d <setupkvm>
8010817d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108180:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108184:	75 0a                	jne    80108190 <copyuvm+0x1f>
    return 0;
80108186:	b8 00 00 00 00       	mov    $0x0,%eax
8010818b:	e9 fd 00 00 00       	jmp    8010828d <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108190:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108197:	e9 d0 00 00 00       	jmp    8010826c <copyuvm+0xfb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010819c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801081a6:	00 
801081a7:	89 44 24 04          	mov    %eax,0x4(%esp)
801081ab:	8b 45 08             	mov    0x8(%ebp),%eax
801081ae:	89 04 24             	mov    %eax,(%esp)
801081b1:	e8 ff f5 ff ff       	call   801077b5 <walkpgdir>
801081b6:	89 45 ec             	mov    %eax,-0x14(%ebp)
801081b9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801081bd:	75 0c                	jne    801081cb <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
801081bf:	c7 04 24 32 8a 10 80 	movl   $0x80108a32,(%esp)
801081c6:	e8 6f 83 ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
801081cb:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081ce:	8b 00                	mov    (%eax),%eax
801081d0:	83 e0 01             	and    $0x1,%eax
801081d3:	85 c0                	test   %eax,%eax
801081d5:	75 0c                	jne    801081e3 <copyuvm+0x72>
      panic("copyuvm: page not present");
801081d7:	c7 04 24 4c 8a 10 80 	movl   $0x80108a4c,(%esp)
801081de:	e8 57 83 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
801081e3:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081e6:	8b 00                	mov    (%eax),%eax
801081e8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801081ed:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
801081f0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081f3:	8b 00                	mov    (%eax),%eax
801081f5:	25 ff 0f 00 00       	and    $0xfff,%eax
801081fa:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    /*     mem = p2v(pa); */
    /*     done = 1; */
    /*   } */
    /* } */
    /* if (done == 0)  { */
    if((mem = kalloc()) == 0)
801081fd:	e8 cc a8 ff ff       	call   80102ace <kalloc>
80108202:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108205:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108209:	75 02                	jne    8010820d <copyuvm+0x9c>
      goto bad;
8010820b:	eb 70                	jmp    8010827d <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
8010820d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108210:	89 04 24             	mov    %eax,(%esp)
80108213:	e8 15 f1 ff ff       	call   8010732d <p2v>
80108218:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010821f:	00 
80108220:	89 44 24 04          	mov    %eax,0x4(%esp)
80108224:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108227:	89 04 24             	mov    %eax,(%esp)
8010822a:	e8 52 cc ff ff       	call   80104e81 <memmove>
    //}
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
8010822f:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108232:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108235:	89 04 24             	mov    %eax,(%esp)
80108238:	e8 e3 f0 ff ff       	call   80107320 <v2p>
8010823d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108240:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108244:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108248:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010824f:	00 
80108250:	89 54 24 04          	mov    %edx,0x4(%esp)
80108254:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108257:	89 04 24             	mov    %eax,(%esp)
8010825a:	e8 f8 f5 ff ff       	call   80107857 <mappages>
8010825f:	85 c0                	test   %eax,%eax
80108261:	79 02                	jns    80108265 <copyuvm+0xf4>
      goto bad;
80108263:	eb 18                	jmp    8010827d <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108265:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010826c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010826f:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108272:	0f 82 24 ff ff ff    	jb     8010819c <copyuvm+0x2b>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    //}
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
8010827b:	eb 10                	jmp    8010828d <copyuvm+0x11c>

bad:
  freevm(d);
8010827d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108280:	89 04 24             	mov    %eax,(%esp)
80108283:	e8 09 fe ff ff       	call   80108091 <freevm>
  return 0;
80108288:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010828d:	83 c4 44             	add    $0x44,%esp
80108290:	5b                   	pop    %ebx
80108291:	5d                   	pop    %ebp
80108292:	c3                   	ret    
...
801082ae:	e8 02 f5 ff ff       	call   801077b5 <walkpgdir>
...
801082c0:	75 07                	jne    801082c9 <uva2ka+0x36>
    return 0;
801082c2:	b8 00 00 00 00       	mov    $0x0,%eax
801082c7:	eb 25                	jmp    801082ee <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
801082c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082cc:	8b 00                	mov    (%eax),%eax
801082ce:	83 e0 04             	and    $0x4,%eax
801082d1:	85 c0                	test   %eax,%eax
801082d3:	75 07                	jne    801082dc <uva2ka+0x49>
    return 0;
801082d5:	b8 00 00 00 00       	mov    $0x0,%eax
801082da:	eb 12                	jmp    801082ee <uva2ka+0x5b>
...
801082e9:	e8 3f f0 ff ff       	call   8010732d <p2v>
}
801082ee:	c9                   	leave  
801082ef:	c3                   	ret    
...
801082f9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801082fc:	e9 87 00 00 00       	jmp    80108388 <copyout+0x98>
...
80108319:	e8 75 ff ff ff       	call   80108293 <uva2ka>
8010831e:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108321:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108325:	75 07                	jne    8010832e <copyout+0x3e>
      return -1;
80108327:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010832c:	eb 69                	jmp    80108397 <copyout+0xa7>
    n = PGSIZE - (va - va0);
8010832e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108331:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108334:	29 c2                	sub    %eax,%edx
80108336:	89 d0                	mov    %edx,%eax
80108338:	05 00 10 00 00       	add    $0x1000,%eax
8010833d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108340:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108343:	3b 45 14             	cmp    0x14(%ebp),%eax
80108346:	76 06                	jbe    8010834e <copyout+0x5e>
      n = len;
80108348:	8b 45 14             	mov    0x14(%ebp),%eax
8010834b:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
8010834e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108351:	8b 55 0c             	mov    0xc(%ebp),%edx
80108354:	29 c2                	sub    %eax,%edx
80108356:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108359:	01 c2                	add    %eax,%edx
8010835b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010835e:	89 44 24 08          	mov    %eax,0x8(%esp)
80108362:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108365:	89 44 24 04          	mov    %eax,0x4(%esp)
80108369:	89 14 24             	mov    %edx,(%esp)
8010836c:	e8 10 cb ff ff       	call   80104e81 <memmove>
    len -= n;
...
8010838c:	0f 85 6f ff ff ff    	jne    80108301 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
