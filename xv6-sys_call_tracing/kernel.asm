...
80100382:	c7 04 24 2d 6d 10 80 	movl   $0x80106d2d,(%esp)
...
80100398:	e8 b3 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
8010039d:	c7 04 24 26 72 10 80 	movl   $0x80107226,(%esp)
...
801003bd:	c7 04 24 49 6d 10 80 	movl   $0x80106d49,(%esp)
...
80100525:	e9 59 ff ff ff       	jmp    80100483 <consputc+0xa3>
  ...
  if(pos < 0 || pos > 25*80)
    panic("pos under/overflow");
8010052a:	c7 04 24 4d 6d 10 80 	movl   $0x80106d4d,(%esp)
...
80100599:	0f b6 92 78 6d 10 80 	movzbl -0x7fef9288(%edx),%edx
  }while((x /= base) != 0);
...
8010075d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        s = "(null)";
80100760:	b8 60 6d 10 80       	mov    $0x80106d60,%eax
...
8010079c:	e9 c8 fe ff ff       	jmp    80100669 <cprintf+0x19>
  ...
  if (fmt == 0)
    panic("null fmt");
801007a1:	c7 04 24 67 6d 10 80 	movl   $0x80106d67,(%esp)
...
80100956:	c7 44 24 04 70 6d 10 	movl   $0x80106d70,0x4(%esp)
8010095d:	80 
...
80100a2a:	75 d5                	jne    80100a01 <exec+0x51>
  ...
  if((pgdir = setupkvm()) == 0)
80100a2c:	e8 af 5c 00 00       	call   801066e0 <setupkvm>
...
80100b69:	e8 12 5e 00 00       	call   80106980 <allocuvm>
...
80100b81:	e8 0a 5f 00 00       	call   80106a90 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
...
80100baa:	e8 61 5f 00 00       	call   80106b10 <clearpteu>
  sp = sz;
...
80100c11:	e8 5a 60 00 00       	call   80106c70 <copyout>
...
80100c7c:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c82:	e8 e9 5f 00 00       	call   80106c70 <copyout>
...
80100d07:	e8 94 5a 00 00       	call   801067a0 <switchuvm>
  freevm(oldpgdir);
80100d0c:	89 34 24             	mov    %esi,(%esp)
80100d0f:	e8 7c 5d 00 00       	call   80106a90 <freevm>
  return 0;
...
80100d46:	c7 44 24 04 89 6d 10 	movl   $0x80106d89,0x4(%esp)
80100d4d:	80 
...
filedup(struct file *f)
{
  ...
  if(f->ref < 1)
    panic("filedup");
80100e07:	c7 04 24 90 6d 10 80 	movl   $0x80106d90,(%esp)
...
80100ec7:	e9 24 1d 00 00       	jmp    80102bf0 <end_op>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
80100ecc:	c7 04 24 98 6d 10 80 	movl   $0x80106d98,(%esp)
...
80100fb5:	eb d8                	jmp    80100f8f <fileread+0x5f>
  ...
  panic("fileread");
80100fb7:	c7 04 24 a2 6d 10 80 	movl   $0x80106da2,(%esp)
...
801010cc:	e9 5f 23 00 00       	jmp    80103430 <pipewrite>
      ...
      if(r != n1)
        panic("short filewrite");
801010d1:	c7 04 24 ab 6d 10 80 	movl   $0x80106dab,(%esp)
801010d8:	e8 83 f2 ff ff       	call   80100360 <panic>
  ...
  panic("filewrite");
801010dd:	c7 04 24 b1 6d 10 80 	movl   $0x80106db1,(%esp)
...
80101195:	c7 04 24 bb 6d 10 80 	movl   $0x80106dbb,(%esp)
...
801012bc:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
801012bd:	c7 04 24 d1 6d 10 80 	movl   $0x80106dd1,(%esp)
...
80101375:	eb 93                	jmp    8010130a <bmap+0x3a>
  ...
  panic("bmap: out of range");
80101377:	c7 04 24 e1 6d 10 80 	movl   $0x80106de1,(%esp)
...
80101458:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101459:	c7 04 24 f4 6d 10 80 	movl   $0x80106df4,(%esp)
...
8010147c:	c7 44 24 04 07 6e 10 	movl   $0x80106e07,0x4(%esp)
80101483:	80 
...
80101499:	c7 44 24 04 0e 6e 10 	movl   $0x80106e0e,0x4(%esp)
801014a0:	80 
...
801014c6:	c7 04 24 64 6e 10 80 	movl   $0x80106e64,(%esp)
...
801015dc:	e9 2f fc ff ff       	jmp    80101210 <iget>
  ...
  panic("ialloc: no inodes");
801015e1:	c7 04 24 14 6e 10 80 	movl   $0x80106e14,(%esp)
...
80101761:	0f 85 78 ff ff ff    	jne    801016df <ilock+0x2f>
      panic("ilock: no type");
80101767:	c7 04 24 2c 6e 10 80 	movl   $0x80106e2c,(%esp)
8010176e:	e8 ed eb ff ff       	call   80100360 <panic>
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
80101773:	c7 04 24 26 6e 10 80 	movl   $0x80106e26,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    panic("iunlock");
801017b3:	c7 04 24 3b 6e 10 80 	movl   $0x80106e3b,(%esp)
...
80101c41:	c3                   	ret    
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101c42:	c7 04 24 55 6e 10 80 	movl   $0x80106e55,(%esp)
80101c49:	e8 12 e7 ff ff       	call   80100360 <panic>
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
80101c4e:	c7 04 24 43 6e 10 80 	movl   $0x80106e43,(%esp)
...
80101ec3:	eb e9                	jmp    80101eae <dirlink+0xae>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101ec5:	c7 04 24 55 6e 10 80 	movl   $0x80106e55,(%esp)
80101ecc:	e8 8f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101ed1:	c7 04 24 de 74 10 80 	movl   $0x801074de,(%esp)
...
80101fbf:	c7 04 24 c0 6e 10 80 	movl   $0x80106ec0,(%esp)
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
80101fcb:	c7 04 24 b7 6e 10 80 	movl   $0x80106eb7,(%esp)
...
80101fe6:	c7 44 24 04 d2 6e 10 	movl   $0x80106ed2,0x4(%esp)
80101fed:	80 
...
iderw(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    panic("iderw: buf not locked");
801021cb:	c7 04 24 d6 6e 10 80 	movl   $0x80106ed6,(%esp)
801021d2:	e8 89 e1 ff ff       	call   80100360 <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
    panic("iderw: ide disk 1 not present");
801021d7:	c7 04 24 01 6f 10 80 	movl   $0x80106f01,(%esp)
801021de:	e8 7d e1 ff ff       	call   80100360 <panic>
  ...
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
801021e3:	c7 04 24 ec 6e 10 80 	movl   $0x80106eec,(%esp)
...
80102245:	c7 04 24 20 6f 10 80 	movl   $0x80106f20,(%esp)
...
kfree(char *v)
{
  ...
  if((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP)
    panic("kfree");
8010236e:	c7 04 24 52 6f 10 80 	movl   $0x80106f52,(%esp)
...
801023db:	c7 44 24 04 58 6f 10 	movl   $0x80106f58,0x4(%esp)
801023e2:	80 
...
80102524:	0f b6 81 80 70 10 80 	movzbl -0x7fef8f80(%ecx),%eax
...
80102558:	0f b6 91 80 70 10 80 	movzbl -0x7fef8f80(%ecx),%edx
  shift ^= togglecode[data];
8010255f:	0f b6 81 80 6f 10 80 	movzbl -0x7fef9080(%ecx),%eax
    // Last character was an E0 escape; or with 0x80
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
8010256f:	8b 04 85 60 6f 10 80 	mov    -0x7fef90a0(,%eax,4),%eax
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
801027be:	c7 04 24 80 71 10 80 	movl   $0x80107180,(%esp)
...
801027df:	c3                   	ret    
  ...
  panic("unknown apicid\n");
801027e0:	c7 04 24 ac 71 10 80 	movl   $0x801071ac,(%esp)
...
80102aeb:	c7 44 24 04 bc 71 10 	movl   $0x801071bc,0x4(%esp)
80102af2:	80 
...
80102d12:	c3                   	ret    
  ...
  if(log.committing)
    panic("log.committing");
80102d13:	c7 04 24 c0 71 10 80 	movl   $0x801071c0,(%esp)
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
80102dd0:	c7 04 24 cf 71 10 80 	movl   $0x801071cf,(%esp)
80102dd7:	e8 84 d5 ff ff       	call   80100360 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102ddc:	c7 04 24 e5 71 10 80 	movl   $0x801071e5,(%esp)
...
80102dfb:	c7 04 24 00 72 10 80 	movl   $0x80107200,(%esp)
80102e02:	89 44 24 04          	mov    %eax,0x4(%esp)
80102e06:	e8 45 d8 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80102e0b:	e8 80 27 00 00       	call   80105590 <idtinit>
...
80102e33:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e36:	e8 45 39 00 00       	call   80106780 <switchkvm>
  seginit();
80102e3b:	e8 60 37 00 00       	call   801065a0 <seginit>
  lapicinit();
...
80102e6e:	e8 ed 38 00 00       	call   80106760 <kvmalloc>
...
80102e80:	e8 1b 37 00 00       	call   801065a0 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpunum());
80102e85:	e8 c6 f8 ff ff       	call   80102750 <cpunum>
80102e8a:	c7 04 24 11 72 10 80 	movl   $0x80107211,(%esp)
...
80102ea9:	e8 02 2a 00 00       	call   801058b0 <uartinit>
80102eae:	66 90                	xchg   %ax,%ax
  pinit();         // process table
80102eb0:	e8 9b 08 00 00       	call   80103750 <pinit>
  tvinit();        // trap vectors
80102eb5:	e8 36 26 00 00       	call   801054f0 <tvinit>
  binit();         // buffer cache
...
80102f9c:	e8 4f fe ff ff       	call   80102df0 <mpmain>
  ...
  if(!ismp)
    timerinit();   // uniprocessor timer
80102fa1:	e8 ea 24 00 00       	call   80105490 <timerinit>
...
80102fcf:	00 
80102fd0:	c7 44 24 04 28 72 10 	movl   $0x80107228,0x4(%esp)
80102fd7:	80 
...
8010308a:	00 
8010308b:	c7 44 24 04 2d 72 10 	movl   $0x8010722d,0x4(%esp)
80103092:	80 
...
80103118:	ff 24 95 34 72 10 80 	jmp    *-0x7fef8dcc(,%edx,4)
8010311f:	90                   	nop
...
8010331f:	c7 44 24 04 48 72 10 	movl   $0x80107248,0x4(%esp)
80103326:	80 
...
8010369d:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
801036a0:	c7 40 14 dd 54 10 80 	movl   $0x801054dd,0x14(%eax)
...
80103756:	c7 44 24 04 4d 72 10 	movl   $0x8010724d,0x4(%esp)
8010375d:	80 
...
80103783:	e8 58 2f 00 00       	call   801066e0 <setupkvm>
...
801037a5:	80 
801037a6:	e8 95 30 00 00       	call   80106840 <inituvm>
  p->sz = PGSIZE;
...
80103822:	00 
80103823:	c7 44 24 04 6d 72 10 	movl   $0x8010726d,0x4(%esp)
8010382a:	80 
8010382b:	89 04 24             	mov    %eax,(%esp)
8010382e:	e8 dd 0c 00 00       	call   80104510 <safestrcpy>
  p->cwd = namei("/");
80103833:	c7 04 24 76 72 10 80 	movl   $0x80107276,(%esp)
...
80103866:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
80103867:	c7 04 24 54 72 10 80 	movl   $0x80107254,(%esp)
...
801038a7:	e8 d4 30 00 00       	call   80106980 <allocuvm>
...
801038c2:	e8 d9 2e 00 00       	call   801067a0 <switchuvm>
  return 0;
...
801038e2:	e8 89 31 00 00       	call   80106a70 <deallocuvm>
...
8010392a:	e8 11 32 00 00       	call   80106b40 <copyuvm>
...
80103a5b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      proc = p;
      switchuvm(p);
80103a5e:	e8 3d 2d 00 00       	call   801067a0 <switchuvm>
      p->state = RUNNING;
...
80103a7d:	e8 e9 0a 00 00       	call   8010456b <swtch>
      switchkvm();
80103a82:	e8 f9 2c 00 00       	call   80106780 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
sched(void)
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103b24:	c7 04 24 78 72 10 80 	movl   $0x80107278,(%esp)
80103b2b:	e8 30 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103b30:	c7 04 24 a4 72 10 80 	movl   $0x801072a4,(%esp)
80103b37:	e8 24 c8 ff ff       	call   80100360 <panic>
  ...
  if(proc->state == RUNNING)
    panic("sched running");
80103b3c:	c7 04 24 96 72 10 80 	movl   $0x80107296,(%esp)
80103b43:	e8 18 c8 ff ff       	call   80100360 <panic>
  ...
  if(cpu->ncli != 1)
    panic("sched locks");
80103b48:	c7 04 24 8a 72 10 80 	movl   $0x8010728a,(%esp)
...
80103c6d:	e8 4e fe ff ff       	call   80103ac0 <sched>
  panic("zombie exit");
80103c72:	c7 04 24 c5 72 10 80 	movl   $0x801072c5,(%esp)
80103c79:	e8 e2 c6 ff ff       	call   80100360 <panic>
{
  ...
  if(proc == initproc)
    panic("init exiting");
80103c7e:	c7 04 24 b8 72 10 80 	movl   $0x801072b8,(%esp)
...
80103d6b:	c7 04 24 d7 72 10 80 	movl   $0x801072d7,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  if(proc == 0)
    panic("sleep");
80103d77:	c7 04 24 d1 72 10 80 	movl   $0x801072d1,(%esp)
...
80103e18:	e8 73 2c 00 00       	call   80106a90 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103f64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f68:	c7 04 24 26 72 10 80 	movl   $0x80107226,(%esp)
...
80103f8a:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103f8d:	ba e8 72 10 80       	mov    $0x801072e8,%edx
  uint pc[10];
...
80103f94:	8b 14 85 20 73 10 80 	mov    -0x7fef8ce0(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103f9b:	b8 e8 72 10 80       	mov    $0x801072e8,%eax
...
80103fb0:	c7 04 24 ec 72 10 80 	movl   $0x801072ec,(%esp)
...
80103ff9:	c7 04 24 49 6d 10 80 	movl   $0x80106d49,(%esp)
...
8010402a:	c7 44 24 04 38 73 10 	movl   $0x80107338,0x4(%esp)
80104031:	80 
...
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
8010422a:	c7 04 24 43 73 10 80 	movl   $0x80107343,(%esp)
...
popcli(void)
{
  ...
  if(--cpu->ncli < 0)
    panic("popcli");
801042c5:	c7 04 24 62 73 10 80 	movl   $0x80107362,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
801042d1:	c7 04 24 4b 73 10 80 	movl   $0x8010734b,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
801042fb:	c7 04 24 69 73 10 80 	movl   $0x80107369,(%esp)
...
80104662:	73 1e                	jae    80104682 <argptr+0x42>
80104664:	8d 59 08             	lea    0x8(%ecx),%ebx
80104667:	39 da                	cmp    %ebx,%edx
80104669:	72 17                	jb     80104682 <argptr+0x42>
    return -1;
  *ip = *(int*)(addr);
8010466b:	8b 49 04             	mov    0x4(%ecx),%ecx
{
  int i;
...
8010466e:	39 d1                	cmp    %edx,%ecx
80104670:	73 10                	jae    80104682 <argptr+0x42>
80104672:	8b 5d 10             	mov    0x10(%ebp),%ebx
80104675:	01 cb                	add    %ecx,%ebx
80104677:	39 d3                	cmp    %edx,%ebx
80104679:	77 07                	ja     80104682 <argptr+0x42>
    return -1;
  *pp = (char*)i;
8010467b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010467e:	89 08                	mov    %ecx,(%eax)
  return 0;
...
8010471e:	8b 70 18             	mov    0x18(%eax),%esi
80104721:	8b 5e 1c             	mov    0x1c(%esi),%ebx
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104724:	8d 53 ff             	lea    -0x1(%ebx),%edx
80104727:	83 fa 14             	cmp    $0x14,%edx
8010472a:	77 44                	ja     80104770 <syscall+0x60>
8010472c:	8b 14 9d 60 74 10 80 	mov    -0x7fef8ba0(,%ebx,4),%edx
80104733:	85 d2                	test   %edx,%edx
80104735:	74 39                	je     80104770 <syscall+0x60>
    proc->tf->eax = syscalls[num]();
80104737:	ff d2                	call   *%edx
80104739:	89 46 1c             	mov    %eax,0x1c(%esi)
    cprintf("%s -> %d\n",syscallnames[num],proc->tf->eax);
8010473c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104742:	8b 40 18             	mov    0x18(%eax),%eax
80104745:	8b 40 1c             	mov    0x1c(%eax),%eax
80104748:	c7 04 24 71 73 10 80 	movl   $0x80107371,(%esp)
8010474f:	89 44 24 08          	mov    %eax,0x8(%esp)
80104753:	8b 04 9d 00 74 10 80 	mov    -0x7fef8c00(,%ebx,4),%eax
8010475a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010475e:	e8 ed be ff ff       	call   80100650 <cprintf>
  } else {
...
8010476a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80104770:	8d 50 6c             	lea    0x6c(%eax),%edx
  num = proc->tf->eax;
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    proc->tf->eax = syscalls[num]();
    cprintf("%s -> %d\n",syscallnames[num],proc->tf->eax);
    ...
    cprintf("%d %s: unknown sys call %d\n",
80104773:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
            proc->pid, proc->name, num);
80104777:	89 54 24 08          	mov    %edx,0x8(%esp)
  num = proc->tf->eax;
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    proc->tf->eax = syscalls[num]();
    cprintf("%s -> %d\n",syscallnames[num],proc->tf->eax);
...
8010477e:	c7 04 24 7b 73 10 80 	movl   $0x8010737b,(%esp)
80104785:	89 44 24 04          	mov    %eax,0x4(%esp)
80104789:	e8 c2 be ff ff       	call   80100650 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
8010478e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104794:	8b 40 18             	mov    0x18(%eax),%eax
80104797:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
801048d0:	c7 44 24 04 d4 74 10 	movl   $0x801074d4,0x4(%esp)
801048d7:	80 
...
801048eb:	c7 44 24 04 d3 74 10 	movl   $0x801074d3,0x4(%esp)
801048f2:	80 
...
80104901:	79 89                	jns    8010488c <create+0xdc>
      panic("create dots");
80104903:	c7 04 24 c7 74 10 80 	movl   $0x801074c7,(%esp)
8010490a:	e8 51 ba ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
8010490f:	c7 04 24 d6 74 10 80 	movl   $0x801074d6,(%esp)
80104916:	e8 45 ba ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
8010491b:	c7 04 24 b8 74 10 80 	movl   $0x801074b8,(%esp)
...
8010494a:	e8 b1 fc ff ff       	call   80104600 <argint>
...
80104a12:	e8 e9 fb ff ff       	call   80104600 <argint>
...
80104a30:	e8 0b fc ff ff       	call   80104640 <argptr>
...
80104a82:	e8 79 fb ff ff       	call   80104600 <argint>
...
80104aa0:	e8 9b fb ff ff       	call   80104640 <argptr>
...
80104b3a:	e8 01 fb ff ff       	call   80104640 <argptr>
...
80104b77:	e8 14 fb ff ff       	call   80104690 <argstr>
...
80104b92:	e8 f9 fa ff ff       	call   80104690 <argstr>
...
80104c97:	e8 f4 f9 ff ff       	call   80104690 <argstr>
...
80104cd1:	c7 44 24 04 d4 74 10 	movl   $0x801074d4,0x4(%esp)
80104cd8:	80 
...
80104ce9:	c7 44 24 04 d3 74 10 	movl   $0x801074d3,0x4(%esp)
80104cf0:	80 
...
80104d4e:	e8 dd f5 ff ff       	call   80104330 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104e38:	e9 48 ff ff ff       	jmp    80104d85 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104e3d:	c7 04 24 f8 74 10 80 	movl   $0x801074f8,(%esp)
80104e44:	e8 17 b5 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104e49:	c7 04 24 0a 75 10 80 	movl   $0x8010750a,(%esp)
80104e50:	e8 0b b5 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104e55:	c7 04 24 e6 74 10 80 	movl   $0x801074e6,(%esp)
...
80104e87:	e8 04 f8 ff ff       	call   80104690 <argstr>
...
80104ea2:	e8 59 f7 ff ff       	call   80104600 <argint>
...
80104fb9:	e8 d2 f6 ff ff       	call   80104690 <argstr>
...
80105019:	e8 72 f6 ff ff       	call   80104690 <argstr>
...
80105030:	e8 cb f5 ff ff       	call   80104600 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
80105047:	e8 b4 f5 ff ff       	call   80104600 <argint>
  char *path;
  int major, minor;
...
801050aa:	e8 e1 f5 ff ff       	call   80104690 <argstr>
...
8010513d:	e8 4e f5 ff ff       	call   80104690 <argstr>
...
8010515b:	e8 a0 f4 ff ff       	call   80104600 <argint>
...
8010518b:	e8 a0 f1 ff ff       	call   80104330 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv))
      return -1;
...
801051a0:	e8 db f3 ff ff       	call   80104580 <fetchint>
...
801051ba:	e8 f1 f3 ff ff       	call   801045b0 <fetchstr>
...
8010522f:	e8 0c f4 ff ff       	call   80104640 <argptr>
...
801052f3:	83 ec 08             	sub    $0x8,%esp
  exit();
801052f6:	e8 65 e8 ff ff       	call   80103b60 <exit>
...
{
  return wait();
80105304:	e9 87 ea ff ff       	jmp    80103d90 <wait>
...
80105324:	e8 d7 f2 ff ff       	call   80104600 <argint>
...
80105333:	e8 98 eb ff ff       	call   80103ed0 <kill>
}
80105338:	c9                   	leave  
80105339:	c3                   	ret    
...
{
  return proc->pid;
8010535a:	8b 40 10             	mov    0x10(%eax),%eax
}
8010535d:	c3                   	ret    
...
80105375:	e8 86 f2 ff ff       	call   80104600 <argint>
...
80105384:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = proc->sz;
80105387:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105389:	89 14 24             	mov    %edx,(%esp)
8010538c:	e8 ef e4 ff ff       	call   80103880 <growproc>
80105391:	85 c0                	test   %eax,%eax
80105393:	78 0b                	js     801053a0 <sys_sbrk+0x40>
    return -1;
  return addr;
80105395:	89 d8                	mov    %ebx,%eax
}
80105397:	83 c4 24             	add    $0x24,%esp
8010539a:	5b                   	pop    %ebx
8010539b:	5d                   	pop    %ebp
8010539c:	c3                   	ret    
...
801053a5:	eb f0                	jmp    80105397 <sys_sbrk+0x37>
...
801053c5:	e8 36 f2 ff ff       	call   80104600 <argint>
801053ca:	85 c0                	test   %eax,%eax
801053cc:	78 7e                	js     8010544c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
801053ce:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
801053d5:	e8 d6 ed ff ff       	call   801041b0 <acquire>
  ticks0 = ticks;
...
801053da:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
801053dd:	8b 1d 20 55 11 80    	mov    0x80115520,%ebx
  while(ticks - ticks0 < n){
...
801053f0:	c7 44 24 04 e0 4c 11 	movl   $0x80114ce0,0x4(%esp)
801053f7:	80 
801053f8:	c7 04 24 20 55 11 80 	movl   $0x80115520,(%esp)
801053ff:	e8 cc e8 ff ff       	call   80103cd0 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105404:	a1 20 55 11 80       	mov    0x80115520,%eax
...
80105416:	8b 40 24             	mov    0x24(%eax),%eax
80105419:	85 c0                	test   %eax,%eax
8010541b:	74 d3                	je     801053f0 <sys_sleep+0x40>
      release(&tickslock);
8010541d:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
80105424:	e8 b7 ee ff ff       	call   801042e0 <release>
      return -1;
...
8010542e:	83 c4 24             	add    $0x24,%esp
80105431:	5b                   	pop    %ebx
80105432:	5d                   	pop    %ebp
80105433:	c3                   	ret    
80105434:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
80105438:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
...
80105451:	eb db                	jmp    8010542e <sys_sleep+0x7e>
...
80105464:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105467:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
8010546e:	e8 3d ed ff ff       	call   801041b0 <acquire>
  xticks = ticks;
80105473:	8b 1d 20 55 11 80    	mov    0x80115520,%ebx
  release(&tickslock);
80105479:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105491:	ba 43 00 00 00       	mov    $0x43,%edx
80105496:	89 e5                	mov    %esp,%ebp
80105498:	b8 34 00 00 00       	mov    $0x34,%eax
8010549d:	83 ec 18             	sub    $0x18,%esp
801054a0:	ee                   	out    %al,(%dx)
801054a1:	b8 9c ff ff ff       	mov    $0xffffff9c,%eax
801054a6:	b2 40                	mov    $0x40,%dl
801054a8:	ee                   	out    %al,(%dx)
801054a9:	b8 2e 00 00 00       	mov    $0x2e,%eax
801054ae:	ee                   	out    %al,(%dx)
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
  picenable(IRQ_TIMER);
801054af:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801054b6:	e8 35 dd ff ff       	call   801031f0 <picenable>
}
801054bb:	c9                   	leave  
801054bc:	c3                   	ret    
...
801054be:	06                   	push   %es
  pushl %fs
801054bf:	0f a0                	push   %fs
  pushl %gs
801054c1:	0f a8                	push   %gs
  pushal
801054c3:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801054c4:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801054c8:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801054ca:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801054cc:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801054d0:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801054d2:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801054d4:	54                   	push   %esp
  call trap
801054d5:	e8 e6 00 00 00       	call   801055c0 <trap>
  addl $4, %esp
801054da:	83 c4 04             	add    $0x4,%esp
...
801054dd:	61                   	popa   
  popl %gs
801054de:	0f a9                	pop    %gs
  popl %fs
801054e0:	0f a1                	pop    %fs
  popl %es
801054e2:	07                   	pop    %es
  popl %ds
801054e3:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801054e4:	83 c4 08             	add    $0x8,%esp
  iret
801054e7:	cf                   	iret   
...
801054f8:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
801054ff:	b9 08 00 00 00       	mov    $0x8,%ecx
80105504:	66 89 0c c5 22 4d 11 	mov    %cx,-0x7feeb2de(,%eax,8)
8010550b:	80 
8010550c:	c6 04 c5 24 4d 11 80 	movb   $0x0,-0x7feeb2dc(,%eax,8)
80105513:	00 
80105514:	c6 04 c5 25 4d 11 80 	movb   $0x8e,-0x7feeb2db(,%eax,8)
8010551b:	8e 
8010551c:	66 89 14 c5 20 4d 11 	mov    %dx,-0x7feeb2e0(,%eax,8)
80105523:	80 
80105524:	c1 ea 10             	shr    $0x10,%edx
80105527:	66 89 14 c5 26 4d 11 	mov    %dx,-0x7feeb2da(,%eax,8)
8010552e:	80 
void
tvinit(void)
{
...
80105532:	3d 00 01 00 00       	cmp    $0x100,%eax
80105537:	75 bf                	jne    801054f8 <tvinit+0x8>
...
8010553a:	ba 08 00 00 00       	mov    $0x8,%edx
struct spinlock tickslock;
uint ticks;
...
80105541:	83 ec 18             	sub    $0x18,%esp
  int i;

  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105544:	a1 0c a1 10 80       	mov    0x8010a10c,%eax

  initlock(&tickslock, "time");
80105549:	c7 44 24 04 c5 73 10 	movl   $0x801073c5,0x4(%esp)
80105550:	80 
80105551:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105558:	66 89 15 22 4f 11 80 	mov    %dx,0x80114f22
8010555f:	66 a3 20 4f 11 80    	mov    %ax,0x80114f20
80105565:	c1 e8 10             	shr    $0x10,%eax
80105568:	c6 05 24 4f 11 80 00 	movb   $0x0,0x80114f24
8010556f:	c6 05 25 4f 11 80 ef 	movb   $0xef,0x80114f25
80105576:	66 a3 26 4f 11 80    	mov    %ax,0x80114f26

  initlock(&tickslock, "time");
8010557c:	e8 af eb ff ff       	call   80104130 <initlock>
}
80105581:	c9                   	leave  
80105582:	c3                   	ret    
...
lidt(struct gatedesc *p, int size)
{
  ...
  pd[0] = size-1;
80105591:	b8 ff 07 00 00       	mov    $0x7ff,%eax
80105596:	89 e5                	mov    %esp,%ebp
80105598:	83 ec 10             	sub    $0x10,%esp
8010559b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010559f:	b8 20 4d 11 80       	mov    $0x80114d20,%eax
801055a4:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801055a8:	c1 e8 10             	shr    $0x10,%eax
801055ab:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
801055af:	8d 45 fa             	lea    -0x6(%ebp),%eax
801055b2:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
801055b5:	c9                   	leave  
801055b6:	c3                   	ret    
...
801055cc:	8b 43 30             	mov    0x30(%ebx),%eax
801055cf:	83 f8 40             	cmp    $0x40,%eax
801055d2:	0f 84 00 01 00 00    	je     801056d8 <trap+0x118>
    if(proc->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
801055d8:	83 e8 20             	sub    $0x20,%eax
801055db:	83 f8 1f             	cmp    $0x1f,%eax
801055de:	77 60                	ja     80105640 <trap+0x80>
801055e0:	ff 24 85 bc 75 10 80 	jmp    *-0x7fef8a44(,%eax,4)
801055e7:	90                   	nop
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
801055e8:	e8 63 d1 ff ff       	call   80102750 <cpunum>
801055ed:	85 c0                	test   %eax,%eax
801055ef:	90                   	nop
801055f0:	0f 84 d2 01 00 00    	je     801057c8 <trap+0x208>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
801055f6:	e8 f5 d1 ff ff       	call   801027f0 <lapiceoi>
...
80105603:	74 2d                	je     80105632 <trap+0x72>
80105605:	8b 50 24             	mov    0x24(%eax),%edx
80105608:	85 d2                	test   %edx,%edx
8010560a:	0f 85 9c 00 00 00    	jne    801056ac <trap+0xec>
    exit();
...
80105614:	0f 84 86 01 00 00    	je     801057a0 <trap+0x1e0>
    yield();

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
8010561a:	8b 40 24             	mov    0x24(%eax),%eax
8010561d:	85 c0                	test   %eax,%eax
8010561f:	74 11                	je     80105632 <trap+0x72>
80105621:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105625:	83 e0 03             	and    $0x3,%eax
80105628:	66 83 f8 03          	cmp    $0x3,%ax
8010562c:	0f 84 d0 00 00 00    	je     80105702 <trap+0x142>
    exit();
}
80105632:	83 c4 2c             	add    $0x2c,%esp
80105635:	5b                   	pop    %ebx
80105636:	5e                   	pop    %esi
80105637:	5f                   	pop    %edi
80105638:	5d                   	pop    %ebp
...
8010563a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
80105640:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80105647:	85 c9                	test   %ecx,%ecx
80105649:	0f 84 a9 01 00 00    	je     801057f8 <trap+0x238>
8010564f:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105653:	0f 84 9f 01 00 00    	je     801057f8 <trap+0x238>
...
8010565c:	8b 73 38             	mov    0x38(%ebx),%esi
8010565f:	e8 ec d0 ff ff       	call   80102750 <cpunum>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
80105664:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010566b:	89 7c 24 1c          	mov    %edi,0x1c(%esp)
8010566f:	89 74 24 18          	mov    %esi,0x18(%esp)
80105673:	89 44 24 14          	mov    %eax,0x14(%esp)
80105677:	8b 43 34             	mov    0x34(%ebx),%eax
8010567a:	89 44 24 10          	mov    %eax,0x10(%esp)
8010567e:	8b 43 30             	mov    0x30(%ebx),%eax
80105681:	89 44 24 0c          	mov    %eax,0xc(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
80105685:	8d 42 6c             	lea    0x6c(%edx),%eax
80105688:	89 44 24 08          	mov    %eax,0x8(%esp)
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010568c:	8b 42 10             	mov    0x10(%edx),%eax
8010568f:	c7 04 24 78 75 10 80 	movl   $0x80107578,(%esp)
80105696:	89 44 24 04          	mov    %eax,0x4(%esp)
8010569a:	e8 b1 af ff ff       	call   80100650 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
            rcr2());
    proc->killed = 1;
8010569f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801056a5:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
  ...
  // until it gets to the regular system call return.)
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
801056ac:	0f b7 53 3c          	movzwl 0x3c(%ebx),%edx
801056b0:	83 e2 03             	and    $0x3,%edx
801056b3:	66 83 fa 03          	cmp    $0x3,%dx
801056b7:	0f 85 53 ff ff ff    	jne    80105610 <trap+0x50>
    exit();
801056bd:	e8 9e e4 ff ff       	call   80103b60 <exit>
...
801056ca:	0f 85 40 ff ff ff    	jne    80105610 <trap+0x50>
801056d0:	e9 5d ff ff ff       	jmp    80105632 <trap+0x72>
...
801056de:	8b 70 24             	mov    0x24(%eax),%esi
801056e1:	85 f6                	test   %esi,%esi
801056e3:	0f 85 a7 00 00 00    	jne    80105790 <trap+0x1d0>
      exit();
    proc->tf = tf;
801056e9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801056ec:	e8 1f f0 ff ff       	call   80104710 <syscall>
    if(proc->killed)
801056f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801056f7:	8b 58 24             	mov    0x24(%eax),%ebx
801056fa:	85 db                	test   %ebx,%ebx
801056fc:	0f 84 30 ff ff ff    	je     80105632 <trap+0x72>
    yield();
...
80105702:	83 c4 2c             	add    $0x2c,%esp
80105705:	5b                   	pop    %ebx
80105706:	5e                   	pop    %esi
80105707:	5f                   	pop    %edi
80105708:	5d                   	pop    %ebp
    ...
    if(proc->killed)
      exit();
80105709:	e9 52 e4 ff ff       	jmp    80103b60 <exit>
8010570e:	66 90                	xchg   %ax,%ax
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105710:	e8 ab ce ff ff       	call   801025c0 <kbdintr>
    lapiceoi();
80105715:	e8 d6 d0 ff ff       	call   801027f0 <lapiceoi>
8010571a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
80105720:	e9 dc fe ff ff       	jmp    80105601 <trap+0x41>
80105725:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105728:	e8 43 c9 ff ff       	call   80102070 <ideintr>
    lapiceoi();
8010572d:	e8 be d0 ff ff       	call   801027f0 <lapiceoi>
80105732:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
80105738:	e9 c4 fe ff ff       	jmp    80105601 <trap+0x41>
...
8010574a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
80105750:	e9 ac fe ff ff       	jmp    80105601 <trap+0x41>
80105755:	8d 76 00             	lea    0x0(%esi),%esi
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105758:	8b 7b 38             	mov    0x38(%ebx),%edi
8010575b:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
8010575f:	e8 ec cf ff ff       	call   80102750 <cpunum>
80105764:	c7 04 24 20 75 10 80 	movl   $0x80107520,(%esp)
8010576b:	89 7c 24 0c          	mov    %edi,0xc(%esp)
8010576f:	89 74 24 08          	mov    %esi,0x8(%esp)
80105773:	89 44 24 04          	mov    %eax,0x4(%esp)
80105777:	e8 d4 ae ff ff       	call   80100650 <cprintf>
            cpunum(), tf->cs, tf->eip);
    lapiceoi();
8010577c:	e8 6f d0 ff ff       	call   801027f0 <lapiceoi>
80105781:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
80105787:	e9 75 fe ff ff       	jmp    80105601 <trap+0x41>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(proc->killed)
      exit();
80105790:	e8 cb e3 ff ff       	call   80103b60 <exit>
80105795:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010579b:	e9 49 ff ff ff       	jmp    801056e9 <trap+0x129>
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
    exit();
...
801057a4:	0f 85 70 fe ff ff    	jne    8010561a <trap+0x5a>
    yield();
801057aa:	e8 e1 e4 ff ff       	call   80103c90 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
801057af:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057b5:	85 c0                	test   %eax,%eax
801057b7:	0f 85 5d fe ff ff    	jne    8010561a <trap+0x5a>
801057bd:	e9 70 fe ff ff       	jmp    80105632 <trap+0x72>
801057c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
      acquire(&tickslock);
801057c8:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
801057cf:	e8 dc e9 ff ff       	call   801041b0 <acquire>
      ticks++;
      wakeup(&ticks);
801057d4:	c7 04 24 20 55 11 80 	movl   $0x80115520,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
      acquire(&tickslock);
      ticks++;
801057db:	83 05 20 55 11 80 01 	addl   $0x1,0x80115520
      wakeup(&ticks);
801057e2:	e8 89 e6 ff ff       	call   80103e70 <wakeup>
      release(&tickslock);
801057e7:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
801057ee:	e8 ed ea ff ff       	call   801042e0 <release>
801057f3:	e9 fe fd ff ff       	jmp    801055f6 <trap+0x36>
...
801057fe:	e8 4d cf ff ff       	call   80102750 <cpunum>
...
80105812:	c7 04 24 44 75 10 80 	movl   $0x80107544,(%esp)
80105819:	89 44 24 04          	mov    %eax,0x4(%esp)
8010581d:	e8 2e ae ff ff       	call   80100650 <cprintf>
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
80105822:	c7 04 24 19 75 10 80 	movl   $0x80107519,(%esp)
...
uartputc(int c)
{
  ...
  if(!uart)
80105860:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
...
80105887:	e8 84 cf ff ff       	call   80102810 <microdelay>
{
  int i;
...
801058fe:	74 52                	je     80105952 <uartinit+0xa2>
    return;
  uart = 1;
80105900:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105907:	00 00 00 
...
8010590f:	ec                   	in     (%dx),%al
  ...
  inb(COM1+0);
  picenable(IRQ_COM1);
80105910:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  ioapicenable(IRQ_COM1, 0);

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80105917:	bb 3c 76 10 80       	mov    $0x8010763c,%ebx
  ...
  inb(COM1+0);
  picenable(IRQ_COM1);
8010591c:	e8 cf d8 ff ff       	call   801031f0 <picenable>
  ioapicenable(IRQ_COM1, 0);
80105921:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105928:	00 
80105929:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105930:	e8 6b c9 ff ff       	call   801022a0 <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80105935:	b8 78 00 00 00       	mov    $0x78,%eax
...
80105943:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80105946:	e8 15 ff ff ff       	call   80105860 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80105950:	75 ee                	jne    80105940 <uartinit+0x90>
    uartputc(*p);
}
...
80105966:	c7 04 24 30 58 10 80 	movl   $0x80105830,(%esp)
...
80105976:	6a 00                	push   $0x0
  jmp alltraps
80105978:	e9 40 fb ff ff       	jmp    801054bd <alltraps>
...
8010597f:	6a 01                	push   $0x1
  jmp alltraps
80105981:	e9 37 fb ff ff       	jmp    801054bd <alltraps>
...
80105988:	6a 02                	push   $0x2
  jmp alltraps
8010598a:	e9 2e fb ff ff       	jmp    801054bd <alltraps>
...
80105991:	6a 03                	push   $0x3
  jmp alltraps
80105993:	e9 25 fb ff ff       	jmp    801054bd <alltraps>
...
8010599a:	6a 04                	push   $0x4
  jmp alltraps
8010599c:	e9 1c fb ff ff       	jmp    801054bd <alltraps>
...
801059a3:	6a 05                	push   $0x5
  jmp alltraps
801059a5:	e9 13 fb ff ff       	jmp    801054bd <alltraps>
...
801059ac:	6a 06                	push   $0x6
  jmp alltraps
801059ae:	e9 0a fb ff ff       	jmp    801054bd <alltraps>
...
801059b5:	6a 07                	push   $0x7
  jmp alltraps
801059b7:	e9 01 fb ff ff       	jmp    801054bd <alltraps>
...
801059bc:	6a 08                	push   $0x8
  jmp alltraps
801059be:	e9 fa fa ff ff       	jmp    801054bd <alltraps>
...
801059c5:	6a 09                	push   $0x9
  jmp alltraps
801059c7:	e9 f1 fa ff ff       	jmp    801054bd <alltraps>
...
801059cc:	6a 0a                	push   $0xa
  jmp alltraps
801059ce:	e9 ea fa ff ff       	jmp    801054bd <alltraps>
...
801059d3:	6a 0b                	push   $0xb
  jmp alltraps
801059d5:	e9 e3 fa ff ff       	jmp    801054bd <alltraps>
...
801059da:	6a 0c                	push   $0xc
  jmp alltraps
801059dc:	e9 dc fa ff ff       	jmp    801054bd <alltraps>
...
801059e1:	6a 0d                	push   $0xd
  jmp alltraps
801059e3:	e9 d5 fa ff ff       	jmp    801054bd <alltraps>
...
801059e8:	6a 0e                	push   $0xe
  jmp alltraps
801059ea:	e9 ce fa ff ff       	jmp    801054bd <alltraps>
...
801059f1:	6a 0f                	push   $0xf
  jmp alltraps
801059f3:	e9 c5 fa ff ff       	jmp    801054bd <alltraps>
...
801059fa:	6a 10                	push   $0x10
  jmp alltraps
801059fc:	e9 bc fa ff ff       	jmp    801054bd <alltraps>
...
80105a01:	6a 11                	push   $0x11
  jmp alltraps
80105a03:	e9 b5 fa ff ff       	jmp    801054bd <alltraps>
...
80105a0a:	6a 12                	push   $0x12
  jmp alltraps
80105a0c:	e9 ac fa ff ff       	jmp    801054bd <alltraps>
...
80105a13:	6a 13                	push   $0x13
  jmp alltraps
80105a15:	e9 a3 fa ff ff       	jmp    801054bd <alltraps>
...
80105a1c:	6a 14                	push   $0x14
  jmp alltraps
80105a1e:	e9 9a fa ff ff       	jmp    801054bd <alltraps>
...
80105a25:	6a 15                	push   $0x15
  jmp alltraps
80105a27:	e9 91 fa ff ff       	jmp    801054bd <alltraps>
...
80105a2e:	6a 16                	push   $0x16
  jmp alltraps
80105a30:	e9 88 fa ff ff       	jmp    801054bd <alltraps>
...
80105a37:	6a 17                	push   $0x17
  jmp alltraps
80105a39:	e9 7f fa ff ff       	jmp    801054bd <alltraps>
...
80105a40:	6a 18                	push   $0x18
  jmp alltraps
80105a42:	e9 76 fa ff ff       	jmp    801054bd <alltraps>
...
80105a49:	6a 19                	push   $0x19
  jmp alltraps
80105a4b:	e9 6d fa ff ff       	jmp    801054bd <alltraps>
...
80105a52:	6a 1a                	push   $0x1a
  jmp alltraps
80105a54:	e9 64 fa ff ff       	jmp    801054bd <alltraps>
...
80105a5b:	6a 1b                	push   $0x1b
  jmp alltraps
80105a5d:	e9 5b fa ff ff       	jmp    801054bd <alltraps>
...
80105a64:	6a 1c                	push   $0x1c
  jmp alltraps
80105a66:	e9 52 fa ff ff       	jmp    801054bd <alltraps>
...
80105a6d:	6a 1d                	push   $0x1d
  jmp alltraps
80105a6f:	e9 49 fa ff ff       	jmp    801054bd <alltraps>
...
80105a76:	6a 1e                	push   $0x1e
  jmp alltraps
80105a78:	e9 40 fa ff ff       	jmp    801054bd <alltraps>
...
80105a7f:	6a 1f                	push   $0x1f
  jmp alltraps
80105a81:	e9 37 fa ff ff       	jmp    801054bd <alltraps>
...
80105a88:	6a 20                	push   $0x20
  jmp alltraps
80105a8a:	e9 2e fa ff ff       	jmp    801054bd <alltraps>
...
80105a91:	6a 21                	push   $0x21
  jmp alltraps
80105a93:	e9 25 fa ff ff       	jmp    801054bd <alltraps>
...
80105a9a:	6a 22                	push   $0x22
  jmp alltraps
80105a9c:	e9 1c fa ff ff       	jmp    801054bd <alltraps>
...
80105aa3:	6a 23                	push   $0x23
  jmp alltraps
80105aa5:	e9 13 fa ff ff       	jmp    801054bd <alltraps>
...
80105aac:	6a 24                	push   $0x24
  jmp alltraps
80105aae:	e9 0a fa ff ff       	jmp    801054bd <alltraps>
...
80105ab5:	6a 25                	push   $0x25
  jmp alltraps
80105ab7:	e9 01 fa ff ff       	jmp    801054bd <alltraps>
...
80105abe:	6a 26                	push   $0x26
  jmp alltraps
80105ac0:	e9 f8 f9 ff ff       	jmp    801054bd <alltraps>
...
80105ac7:	6a 27                	push   $0x27
  jmp alltraps
80105ac9:	e9 ef f9 ff ff       	jmp    801054bd <alltraps>
...
80105ad0:	6a 28                	push   $0x28
  jmp alltraps
80105ad2:	e9 e6 f9 ff ff       	jmp    801054bd <alltraps>
...
80105ad9:	6a 29                	push   $0x29
  jmp alltraps
80105adb:	e9 dd f9 ff ff       	jmp    801054bd <alltraps>
...
80105ae2:	6a 2a                	push   $0x2a
  jmp alltraps
80105ae4:	e9 d4 f9 ff ff       	jmp    801054bd <alltraps>
...
80105aeb:	6a 2b                	push   $0x2b
  jmp alltraps
80105aed:	e9 cb f9 ff ff       	jmp    801054bd <alltraps>
...
80105af4:	6a 2c                	push   $0x2c
  jmp alltraps
80105af6:	e9 c2 f9 ff ff       	jmp    801054bd <alltraps>
...
80105afd:	6a 2d                	push   $0x2d
  jmp alltraps
80105aff:	e9 b9 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b06:	6a 2e                	push   $0x2e
  jmp alltraps
80105b08:	e9 b0 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b0f:	6a 2f                	push   $0x2f
  jmp alltraps
80105b11:	e9 a7 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b18:	6a 30                	push   $0x30
  jmp alltraps
80105b1a:	e9 9e f9 ff ff       	jmp    801054bd <alltraps>
...
80105b21:	6a 31                	push   $0x31
  jmp alltraps
80105b23:	e9 95 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b2a:	6a 32                	push   $0x32
  jmp alltraps
80105b2c:	e9 8c f9 ff ff       	jmp    801054bd <alltraps>
...
80105b33:	6a 33                	push   $0x33
  jmp alltraps
80105b35:	e9 83 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b3c:	6a 34                	push   $0x34
  jmp alltraps
80105b3e:	e9 7a f9 ff ff       	jmp    801054bd <alltraps>
...
80105b45:	6a 35                	push   $0x35
  jmp alltraps
80105b47:	e9 71 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b4e:	6a 36                	push   $0x36
  jmp alltraps
80105b50:	e9 68 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b57:	6a 37                	push   $0x37
  jmp alltraps
80105b59:	e9 5f f9 ff ff       	jmp    801054bd <alltraps>
...
80105b60:	6a 38                	push   $0x38
  jmp alltraps
80105b62:	e9 56 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b69:	6a 39                	push   $0x39
  jmp alltraps
80105b6b:	e9 4d f9 ff ff       	jmp    801054bd <alltraps>
...
80105b72:	6a 3a                	push   $0x3a
  jmp alltraps
80105b74:	e9 44 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b7b:	6a 3b                	push   $0x3b
  jmp alltraps
80105b7d:	e9 3b f9 ff ff       	jmp    801054bd <alltraps>
...
80105b84:	6a 3c                	push   $0x3c
  jmp alltraps
80105b86:	e9 32 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b8d:	6a 3d                	push   $0x3d
  jmp alltraps
80105b8f:	e9 29 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b96:	6a 3e                	push   $0x3e
  jmp alltraps
80105b98:	e9 20 f9 ff ff       	jmp    801054bd <alltraps>
...
80105b9f:	6a 3f                	push   $0x3f
  jmp alltraps
80105ba1:	e9 17 f9 ff ff       	jmp    801054bd <alltraps>
...
80105ba8:	6a 40                	push   $0x40
  jmp alltraps
80105baa:	e9 0e f9 ff ff       	jmp    801054bd <alltraps>
...
80105bb1:	6a 41                	push   $0x41
  jmp alltraps
80105bb3:	e9 05 f9 ff ff       	jmp    801054bd <alltraps>
...
80105bba:	6a 42                	push   $0x42
  jmp alltraps
80105bbc:	e9 fc f8 ff ff       	jmp    801054bd <alltraps>
...
80105bc3:	6a 43                	push   $0x43
  jmp alltraps
80105bc5:	e9 f3 f8 ff ff       	jmp    801054bd <alltraps>
...
80105bcc:	6a 44                	push   $0x44
  jmp alltraps
80105bce:	e9 ea f8 ff ff       	jmp    801054bd <alltraps>
...
80105bd5:	6a 45                	push   $0x45
  jmp alltraps
80105bd7:	e9 e1 f8 ff ff       	jmp    801054bd <alltraps>
...
80105bde:	6a 46                	push   $0x46
  jmp alltraps
80105be0:	e9 d8 f8 ff ff       	jmp    801054bd <alltraps>
...
80105be7:	6a 47                	push   $0x47
  jmp alltraps
80105be9:	e9 cf f8 ff ff       	jmp    801054bd <alltraps>
...
80105bf0:	6a 48                	push   $0x48
  jmp alltraps
80105bf2:	e9 c6 f8 ff ff       	jmp    801054bd <alltraps>
...
80105bf9:	6a 49                	push   $0x49
  jmp alltraps
80105bfb:	e9 bd f8 ff ff       	jmp    801054bd <alltraps>
...
80105c02:	6a 4a                	push   $0x4a
  jmp alltraps
80105c04:	e9 b4 f8 ff ff       	jmp    801054bd <alltraps>
...
80105c0b:	6a 4b                	push   $0x4b
  jmp alltraps
80105c0d:	e9 ab f8 ff ff       	jmp    801054bd <alltraps>
...
80105c14:	6a 4c                	push   $0x4c
  jmp alltraps
80105c16:	e9 a2 f8 ff ff       	jmp    801054bd <alltraps>
...
80105c1d:	6a 4d                	push   $0x4d
  jmp alltraps
80105c1f:	e9 99 f8 ff ff       	jmp    801054bd <alltraps>
...
80105c26:	6a 4e                	push   $0x4e
  jmp alltraps
80105c28:	e9 90 f8 ff ff       	jmp    801054bd <alltraps>
...
80105c2f:	6a 4f                	push   $0x4f
  jmp alltraps
80105c31:	e9 87 f8 ff ff       	jmp    801054bd <alltraps>
...
80105c38:	6a 50                	push   $0x50
  jmp alltraps
80105c3a:	e9 7e f8 ff ff       	jmp    801054bd <alltraps>
...
80105c41:	6a 51                	push   $0x51
  jmp alltraps
80105c43:	e9 75 f8 ff ff       	jmp    801054bd <alltraps>
...
80105c4a:	6a 52                	push   $0x52
  jmp alltraps
80105c4c:	e9 6c f8 ff ff       	jmp    801054bd <alltraps>
...
80105c53:	6a 53                	push   $0x53
  jmp alltraps
80105c55:	e9 63 f8 ff ff       	jmp    801054bd <alltraps>
...
80105c5c:	6a 54                	push   $0x54
  jmp alltraps
80105c5e:	e9 5a f8 ff ff       	jmp    801054bd <alltraps>
...
80105c65:	6a 55                	push   $0x55
  jmp alltraps
80105c67:	e9 51 f8 ff ff       	jmp    801054bd <alltraps>
...
80105c6e:	6a 56                	push   $0x56
  jmp alltraps
80105c70:	e9 48 f8 ff ff       	jmp    801054bd <alltraps>
...
80105c77:	6a 57                	push   $0x57
  jmp alltraps
80105c79:	e9 3f f8 ff ff       	jmp    801054bd <alltraps>
...
80105c80:	6a 58                	push   $0x58
  jmp alltraps
80105c82:	e9 36 f8 ff ff       	jmp    801054bd <alltraps>
...
80105c89:	6a 59                	push   $0x59
  jmp alltraps
80105c8b:	e9 2d f8 ff ff       	jmp    801054bd <alltraps>
...
80105c92:	6a 5a                	push   $0x5a
  jmp alltraps
80105c94:	e9 24 f8 ff ff       	jmp    801054bd <alltraps>
...
80105c9b:	6a 5b                	push   $0x5b
  jmp alltraps
80105c9d:	e9 1b f8 ff ff       	jmp    801054bd <alltraps>
...
80105ca4:	6a 5c                	push   $0x5c
  jmp alltraps
80105ca6:	e9 12 f8 ff ff       	jmp    801054bd <alltraps>
...
80105cad:	6a 5d                	push   $0x5d
  jmp alltraps
80105caf:	e9 09 f8 ff ff       	jmp    801054bd <alltraps>
...
80105cb6:	6a 5e                	push   $0x5e
  jmp alltraps
80105cb8:	e9 00 f8 ff ff       	jmp    801054bd <alltraps>
...
80105cbf:	6a 5f                	push   $0x5f
  jmp alltraps
80105cc1:	e9 f7 f7 ff ff       	jmp    801054bd <alltraps>
...
80105cc8:	6a 60                	push   $0x60
  jmp alltraps
80105cca:	e9 ee f7 ff ff       	jmp    801054bd <alltraps>
...
80105cd1:	6a 61                	push   $0x61
  jmp alltraps
80105cd3:	e9 e5 f7 ff ff       	jmp    801054bd <alltraps>
...
80105cda:	6a 62                	push   $0x62
  jmp alltraps
80105cdc:	e9 dc f7 ff ff       	jmp    801054bd <alltraps>
...
80105ce3:	6a 63                	push   $0x63
  jmp alltraps
80105ce5:	e9 d3 f7 ff ff       	jmp    801054bd <alltraps>
...
80105cec:	6a 64                	push   $0x64
  jmp alltraps
80105cee:	e9 ca f7 ff ff       	jmp    801054bd <alltraps>
...
80105cf5:	6a 65                	push   $0x65
  jmp alltraps
80105cf7:	e9 c1 f7 ff ff       	jmp    801054bd <alltraps>
...
80105cfe:	6a 66                	push   $0x66
  jmp alltraps
80105d00:	e9 b8 f7 ff ff       	jmp    801054bd <alltraps>
...
80105d07:	6a 67                	push   $0x67
  jmp alltraps
80105d09:	e9 af f7 ff ff       	jmp    801054bd <alltraps>
...
80105d10:	6a 68                	push   $0x68
  jmp alltraps
80105d12:	e9 a6 f7 ff ff       	jmp    801054bd <alltraps>
...
80105d19:	6a 69                	push   $0x69
  jmp alltraps
80105d1b:	e9 9d f7 ff ff       	jmp    801054bd <alltraps>
...
80105d22:	6a 6a                	push   $0x6a
  jmp alltraps
80105d24:	e9 94 f7 ff ff       	jmp    801054bd <alltraps>
...
80105d2b:	6a 6b                	push   $0x6b
  jmp alltraps
80105d2d:	e9 8b f7 ff ff       	jmp    801054bd <alltraps>
...
80105d34:	6a 6c                	push   $0x6c
  jmp alltraps
80105d36:	e9 82 f7 ff ff       	jmp    801054bd <alltraps>
...
80105d3d:	6a 6d                	push   $0x6d
  jmp alltraps
80105d3f:	e9 79 f7 ff ff       	jmp    801054bd <alltraps>
...
80105d46:	6a 6e                	push   $0x6e
  jmp alltraps
80105d48:	e9 70 f7 ff ff       	jmp    801054bd <alltraps>
...
80105d4f:	6a 6f                	push   $0x6f
  jmp alltraps
80105d51:	e9 67 f7 ff ff       	jmp    801054bd <alltraps>
...
80105d58:	6a 70                	push   $0x70
  jmp alltraps
80105d5a:	e9 5e f7 ff ff       	jmp    801054bd <alltraps>
...
80105d61:	6a 71                	push   $0x71
  jmp alltraps
80105d63:	e9 55 f7 ff ff       	jmp    801054bd <alltraps>
...
80105d6a:	6a 72                	push   $0x72
  jmp alltraps
80105d6c:	e9 4c f7 ff ff       	jmp    801054bd <alltraps>
...
80105d73:	6a 73                	push   $0x73
  jmp alltraps
80105d75:	e9 43 f7 ff ff       	jmp    801054bd <alltraps>
...
80105d7c:	6a 74                	push   $0x74
  jmp alltraps
80105d7e:	e9 3a f7 ff ff       	jmp    801054bd <alltraps>
...
80105d85:	6a 75                	push   $0x75
  jmp alltraps
80105d87:	e9 31 f7 ff ff       	jmp    801054bd <alltraps>
...
80105d8e:	6a 76                	push   $0x76
  jmp alltraps
80105d90:	e9 28 f7 ff ff       	jmp    801054bd <alltraps>
...
80105d97:	6a 77                	push   $0x77
  jmp alltraps
80105d99:	e9 1f f7 ff ff       	jmp    801054bd <alltraps>
...
80105da0:	6a 78                	push   $0x78
  jmp alltraps
80105da2:	e9 16 f7 ff ff       	jmp    801054bd <alltraps>
...
80105da9:	6a 79                	push   $0x79
  jmp alltraps
80105dab:	e9 0d f7 ff ff       	jmp    801054bd <alltraps>
...
80105db2:	6a 7a                	push   $0x7a
  jmp alltraps
80105db4:	e9 04 f7 ff ff       	jmp    801054bd <alltraps>
...
80105dbb:	6a 7b                	push   $0x7b
  jmp alltraps
80105dbd:	e9 fb f6 ff ff       	jmp    801054bd <alltraps>
...
80105dc4:	6a 7c                	push   $0x7c
  jmp alltraps
80105dc6:	e9 f2 f6 ff ff       	jmp    801054bd <alltraps>
...
80105dcd:	6a 7d                	push   $0x7d
  jmp alltraps
80105dcf:	e9 e9 f6 ff ff       	jmp    801054bd <alltraps>
...
80105dd6:	6a 7e                	push   $0x7e
  jmp alltraps
80105dd8:	e9 e0 f6 ff ff       	jmp    801054bd <alltraps>
...
80105ddf:	6a 7f                	push   $0x7f
  jmp alltraps
80105de1:	e9 d7 f6 ff ff       	jmp    801054bd <alltraps>
...
80105de8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105ded:	e9 cb f6 ff ff       	jmp    801054bd <alltraps>
...
80105df4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105df9:	e9 bf f6 ff ff       	jmp    801054bd <alltraps>
...
80105e00:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105e05:	e9 b3 f6 ff ff       	jmp    801054bd <alltraps>
...
80105e0c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105e11:	e9 a7 f6 ff ff       	jmp    801054bd <alltraps>
...
80105e18:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105e1d:	e9 9b f6 ff ff       	jmp    801054bd <alltraps>
...
80105e24:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105e29:	e9 8f f6 ff ff       	jmp    801054bd <alltraps>
...
80105e30:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105e35:	e9 83 f6 ff ff       	jmp    801054bd <alltraps>
...
80105e3c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105e41:	e9 77 f6 ff ff       	jmp    801054bd <alltraps>
...
80105e48:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105e4d:	e9 6b f6 ff ff       	jmp    801054bd <alltraps>
...
80105e54:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105e59:	e9 5f f6 ff ff       	jmp    801054bd <alltraps>
...
80105e60:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105e65:	e9 53 f6 ff ff       	jmp    801054bd <alltraps>
...
80105e6c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105e71:	e9 47 f6 ff ff       	jmp    801054bd <alltraps>
...
80105e78:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105e7d:	e9 3b f6 ff ff       	jmp    801054bd <alltraps>
...
80105e84:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105e89:	e9 2f f6 ff ff       	jmp    801054bd <alltraps>
...
80105e90:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105e95:	e9 23 f6 ff ff       	jmp    801054bd <alltraps>
...
80105e9c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105ea1:	e9 17 f6 ff ff       	jmp    801054bd <alltraps>
...
80105ea8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105ead:	e9 0b f6 ff ff       	jmp    801054bd <alltraps>
...
80105eb4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105eb9:	e9 ff f5 ff ff       	jmp    801054bd <alltraps>
...
80105ec0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105ec5:	e9 f3 f5 ff ff       	jmp    801054bd <alltraps>
...
80105ecc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105ed1:	e9 e7 f5 ff ff       	jmp    801054bd <alltraps>
...
80105ed8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105edd:	e9 db f5 ff ff       	jmp    801054bd <alltraps>
...
80105ee4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105ee9:	e9 cf f5 ff ff       	jmp    801054bd <alltraps>
...
80105ef0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105ef5:	e9 c3 f5 ff ff       	jmp    801054bd <alltraps>
...
80105efc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105f01:	e9 b7 f5 ff ff       	jmp    801054bd <alltraps>
...
80105f08:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105f0d:	e9 ab f5 ff ff       	jmp    801054bd <alltraps>
...
80105f14:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105f19:	e9 9f f5 ff ff       	jmp    801054bd <alltraps>
...
80105f20:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105f25:	e9 93 f5 ff ff       	jmp    801054bd <alltraps>
...
80105f2c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105f31:	e9 87 f5 ff ff       	jmp    801054bd <alltraps>
...
80105f38:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105f3d:	e9 7b f5 ff ff       	jmp    801054bd <alltraps>
...
80105f44:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105f49:	e9 6f f5 ff ff       	jmp    801054bd <alltraps>
...
80105f50:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105f55:	e9 63 f5 ff ff       	jmp    801054bd <alltraps>
...
80105f5c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105f61:	e9 57 f5 ff ff       	jmp    801054bd <alltraps>
...
80105f68:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105f6d:	e9 4b f5 ff ff       	jmp    801054bd <alltraps>
...
80105f74:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105f79:	e9 3f f5 ff ff       	jmp    801054bd <alltraps>
...
80105f80:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105f85:	e9 33 f5 ff ff       	jmp    801054bd <alltraps>
...
80105f8c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105f91:	e9 27 f5 ff ff       	jmp    801054bd <alltraps>
...
80105f98:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105f9d:	e9 1b f5 ff ff       	jmp    801054bd <alltraps>
...
80105fa4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105fa9:	e9 0f f5 ff ff       	jmp    801054bd <alltraps>
...
80105fb0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105fb5:	e9 03 f5 ff ff       	jmp    801054bd <alltraps>
...
80105fbc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105fc1:	e9 f7 f4 ff ff       	jmp    801054bd <alltraps>
...
80105fc8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105fcd:	e9 eb f4 ff ff       	jmp    801054bd <alltraps>
...
80105fd4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105fd9:	e9 df f4 ff ff       	jmp    801054bd <alltraps>
...
80105fe0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105fe5:	e9 d3 f4 ff ff       	jmp    801054bd <alltraps>
...
80105fec:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105ff1:	e9 c7 f4 ff ff       	jmp    801054bd <alltraps>
...
80105ff8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105ffd:	e9 bb f4 ff ff       	jmp    801054bd <alltraps>
...
80106004:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106009:	e9 af f4 ff ff       	jmp    801054bd <alltraps>
...
80106010:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106015:	e9 a3 f4 ff ff       	jmp    801054bd <alltraps>
...
8010601c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106021:	e9 97 f4 ff ff       	jmp    801054bd <alltraps>
...
80106028:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010602d:	e9 8b f4 ff ff       	jmp    801054bd <alltraps>
...
80106034:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106039:	e9 7f f4 ff ff       	jmp    801054bd <alltraps>
...
80106040:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106045:	e9 73 f4 ff ff       	jmp    801054bd <alltraps>
...
8010604c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106051:	e9 67 f4 ff ff       	jmp    801054bd <alltraps>
...
80106058:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010605d:	e9 5b f4 ff ff       	jmp    801054bd <alltraps>
...
80106064:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106069:	e9 4f f4 ff ff       	jmp    801054bd <alltraps>
...
80106070:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106075:	e9 43 f4 ff ff       	jmp    801054bd <alltraps>
...
8010607c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106081:	e9 37 f4 ff ff       	jmp    801054bd <alltraps>
...
80106088:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010608d:	e9 2b f4 ff ff       	jmp    801054bd <alltraps>
...
80106094:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106099:	e9 1f f4 ff ff       	jmp    801054bd <alltraps>
...
801060a0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801060a5:	e9 13 f4 ff ff       	jmp    801054bd <alltraps>
...
801060ac:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801060b1:	e9 07 f4 ff ff       	jmp    801054bd <alltraps>
...
801060b8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801060bd:	e9 fb f3 ff ff       	jmp    801054bd <alltraps>
...
801060c4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801060c9:	e9 ef f3 ff ff       	jmp    801054bd <alltraps>
...
801060d0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801060d5:	e9 e3 f3 ff ff       	jmp    801054bd <alltraps>
...
801060dc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801060e1:	e9 d7 f3 ff ff       	jmp    801054bd <alltraps>
...
801060e8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801060ed:	e9 cb f3 ff ff       	jmp    801054bd <alltraps>
...
801060f4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801060f9:	e9 bf f3 ff ff       	jmp    801054bd <alltraps>
...
80106100:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106105:	e9 b3 f3 ff ff       	jmp    801054bd <alltraps>
...
8010610c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106111:	e9 a7 f3 ff ff       	jmp    801054bd <alltraps>
...
80106118:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010611d:	e9 9b f3 ff ff       	jmp    801054bd <alltraps>
...
80106124:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106129:	e9 8f f3 ff ff       	jmp    801054bd <alltraps>
...
80106130:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106135:	e9 83 f3 ff ff       	jmp    801054bd <alltraps>
...
8010613c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106141:	e9 77 f3 ff ff       	jmp    801054bd <alltraps>
...
80106148:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010614d:	e9 6b f3 ff ff       	jmp    801054bd <alltraps>
...
80106154:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106159:	e9 5f f3 ff ff       	jmp    801054bd <alltraps>
...
80106160:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106165:	e9 53 f3 ff ff       	jmp    801054bd <alltraps>
...
8010616c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106171:	e9 47 f3 ff ff       	jmp    801054bd <alltraps>
...
80106178:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010617d:	e9 3b f3 ff ff       	jmp    801054bd <alltraps>
...
80106184:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106189:	e9 2f f3 ff ff       	jmp    801054bd <alltraps>
...
80106190:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106195:	e9 23 f3 ff ff       	jmp    801054bd <alltraps>
...
8010619c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801061a1:	e9 17 f3 ff ff       	jmp    801054bd <alltraps>
...
801061a8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801061ad:	e9 0b f3 ff ff       	jmp    801054bd <alltraps>
...
801061b4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801061b9:	e9 ff f2 ff ff       	jmp    801054bd <alltraps>
...
801061c0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801061c5:	e9 f3 f2 ff ff       	jmp    801054bd <alltraps>
...
801061cc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801061d1:	e9 e7 f2 ff ff       	jmp    801054bd <alltraps>
...
801061d8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801061dd:	e9 db f2 ff ff       	jmp    801054bd <alltraps>
...
801061e4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801061e9:	e9 cf f2 ff ff       	jmp    801054bd <alltraps>
...
801061f0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801061f5:	e9 c3 f2 ff ff       	jmp    801054bd <alltraps>
...
801061fc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106201:	e9 b7 f2 ff ff       	jmp    801054bd <alltraps>
...
80106208:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010620d:	e9 ab f2 ff ff       	jmp    801054bd <alltraps>
...
80106214:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106219:	e9 9f f2 ff ff       	jmp    801054bd <alltraps>
...
80106220:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106225:	e9 93 f2 ff ff       	jmp    801054bd <alltraps>
...
8010622c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106231:	e9 87 f2 ff ff       	jmp    801054bd <alltraps>
...
80106238:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010623d:	e9 7b f2 ff ff       	jmp    801054bd <alltraps>
...
80106244:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106249:	e9 6f f2 ff ff       	jmp    801054bd <alltraps>
...
80106250:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106255:	e9 63 f2 ff ff       	jmp    801054bd <alltraps>
...
8010625c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106261:	e9 57 f2 ff ff       	jmp    801054bd <alltraps>
...
80106268:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010626d:	e9 4b f2 ff ff       	jmp    801054bd <alltraps>
...
80106274:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106279:	e9 3f f2 ff ff       	jmp    801054bd <alltraps>
...
80106280:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106285:	e9 33 f2 ff ff       	jmp    801054bd <alltraps>
...
8010628c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106291:	e9 27 f2 ff ff       	jmp    801054bd <alltraps>
...
80106298:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010629d:	e9 1b f2 ff ff       	jmp    801054bd <alltraps>
...
801062a4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801062a9:	e9 0f f2 ff ff       	jmp    801054bd <alltraps>
...
801062b0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801062b5:	e9 03 f2 ff ff       	jmp    801054bd <alltraps>
...
801062bc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801062c1:	e9 f7 f1 ff ff       	jmp    801054bd <alltraps>
...
801062c8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801062cd:	e9 eb f1 ff ff       	jmp    801054bd <alltraps>
...
801062d4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801062d9:	e9 df f1 ff ff       	jmp    801054bd <alltraps>
...
801062e0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801062e5:	e9 d3 f1 ff ff       	jmp    801054bd <alltraps>
...
801062ec:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801062f1:	e9 c7 f1 ff ff       	jmp    801054bd <alltraps>
...
801062f8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801062fd:	e9 bb f1 ff ff       	jmp    801054bd <alltraps>
...
80106304:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106309:	e9 af f1 ff ff       	jmp    801054bd <alltraps>
...
80106310:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106315:	e9 a3 f1 ff ff       	jmp    801054bd <alltraps>
...
8010631c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106321:	e9 97 f1 ff ff       	jmp    801054bd <alltraps>
...
80106328:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010632d:	e9 8b f1 ff ff       	jmp    801054bd <alltraps>
...
80106334:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106339:	e9 7f f1 ff ff       	jmp    801054bd <alltraps>
...
80106340:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106345:	e9 73 f1 ff ff       	jmp    801054bd <alltraps>
...
8010634c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106351:	e9 67 f1 ff ff       	jmp    801054bd <alltraps>
...
80106358:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010635d:	e9 5b f1 ff ff       	jmp    801054bd <alltraps>
...
80106364:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106369:	e9 4f f1 ff ff       	jmp    801054bd <alltraps>
...
80106370:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106375:	e9 43 f1 ff ff       	jmp    801054bd <alltraps>
...
8010637c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106381:	e9 37 f1 ff ff       	jmp    801054bd <alltraps>
...
80106388:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010638d:	e9 2b f1 ff ff       	jmp    801054bd <alltraps>
...
80106394:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106399:	e9 1f f1 ff ff       	jmp    801054bd <alltraps>
...
801063a0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801063a5:	e9 13 f1 ff ff       	jmp    801054bd <alltraps>
...
801063ac:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801063b1:	e9 07 f1 ff ff       	jmp    801054bd <alltraps>
...
801063b8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801063bd:	e9 fb f0 ff ff       	jmp    801054bd <alltraps>
...
801063c4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801063c9:	e9 ef f0 ff ff       	jmp    801054bd <alltraps>
...
801063d0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801063d5:	e9 e3 f0 ff ff       	jmp    801054bd <alltraps>
...
801063dc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801063e1:	e9 d7 f0 ff ff       	jmp    801054bd <alltraps>
...
80106434:	e8 57 c0 ff ff       	call   80102490 <kalloc>
...
80106452:	e8 d9 de ff ff       	call   80104330 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801064f1:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
801064f2:	c7 04 24 44 76 10 80 	movl   $0x80107644,(%esp)
...
80106543:	e8 98 bd ff ff       	call   801022e0 <kfree>
      *pte = 0;
...
80106568:	75 be                	jne    80106528 <deallocuvm.part.0+0x28>
      a += (NPTENTRIES - 1) * PGSIZE;
8010656a:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80106570:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106576:	39 f3                	cmp    %esi,%ebx
80106578:	72 e1                	jb     8010655b <deallocuvm.part.0+0x5b>
...
8010658a:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
8010658b:	c7 04 24 52 6f 10 80 	movl   $0x80106f52,(%esp)
...
801065a3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpunum()];
801065a6:	e8 a5 c1 ff ff       	call   80102750 <cpunum>
...
801065ad:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
801065b2:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801065b8:	05 a0 27 11 80       	add    $0x801127a0,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
...
801065c1:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801065c6:	66 89 48 7a          	mov    %cx,0x7a(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801065ca:	31 c9                	xor    %ecx,%ecx
801065cc:	66 89 90 80 00 00 00 	mov    %dx,0x80(%eax)
...
801065d3:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801065d8:	66 89 88 82 00 00 00 	mov    %cx,0x82(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801065df:	31 c9                	xor    %ecx,%ecx
801065e1:	66 89 90 90 00 00 00 	mov    %dx,0x90(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801065e8:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801065ed:	66 89 88 92 00 00 00 	mov    %cx,0x92(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801065f4:	31 c9                	xor    %ecx,%ecx
801065f6:	66 89 90 98 00 00 00 	mov    %dx,0x98(%eax)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801065fd:	8d 90 b4 00 00 00    	lea    0xb4(%eax),%edx
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106603:	66 89 88 9a 00 00 00 	mov    %cx,0x9a(%eax)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010660a:	31 c9                	xor    %ecx,%ecx
8010660c:	66 89 88 88 00 00 00 	mov    %cx,0x88(%eax)
80106613:	89 d1                	mov    %edx,%ecx
80106615:	c1 e9 10             	shr    $0x10,%ecx
80106618:	66 89 90 8a 00 00 00 	mov    %dx,0x8a(%eax)
8010661f:	c1 ea 18             	shr    $0x18,%edx
80106622:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
80106628:	b9 37 00 00 00       	mov    $0x37,%ecx
8010662d:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80106633:	8d 50 70             	lea    0x70(%eax),%edx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106636:	c6 40 7d 9a          	movb   $0x9a,0x7d(%eax)
8010663a:	c6 40 7e cf          	movb   $0xcf,0x7e(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010663e:	c6 80 85 00 00 00 92 	movb   $0x92,0x85(%eax)
80106645:	c6 80 86 00 00 00 cf 	movb   $0xcf,0x86(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010664c:	c6 80 95 00 00 00 fa 	movb   $0xfa,0x95(%eax)
80106653:	c6 80 96 00 00 00 cf 	movb   $0xcf,0x96(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010665a:	c6 80 9d 00 00 00 f2 	movb   $0xf2,0x9d(%eax)
80106661:	c6 80 9e 00 00 00 cf 	movb   $0xcf,0x9e(%eax)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80106668:	c6 80 8d 00 00 00 92 	movb   $0x92,0x8d(%eax)
8010666f:	c6 80 8e 00 00 00 c0 	movb   $0xc0,0x8e(%eax)
80106676:	66 89 4d f2          	mov    %cx,-0xe(%ebp)
  pd[1] = (uint)p;
8010667a:	66 89 55 f4          	mov    %dx,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
8010667e:	c1 ea 10             	shr    $0x10,%edx
80106681:	66 89 55 f6          	mov    %dx,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80106685:	8d 55 f2             	lea    -0xe(%ebp),%edx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106688:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
8010668c:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106690:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80106697:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010669e:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
801066a5:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801066ac:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
801066b3:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)
801066ba:	0f 01 12             	lgdtl  (%edx)
}
...
801066bd:	ba 18 00 00 00       	mov    $0x18,%edx
801066c2:	8e ea                	mov    %edx,%gs
  lgdt(c->gdt, sizeof(c->gdt));
  loadgs(SEG_KCPU << 3);
  ...
  cpu = c;
  proc = 0;
801066c4:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801066cb:	00 00 00 00 
  ...
  // Initialize cpu-local storage.
  cpu = c;
801066cf:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
}
801066d5:	c9                   	leave  
801066d6:	c3                   	ret    
...
801066e8:	e8 a3 bd ff ff       	call   80102490 <kalloc>
801066ed:	85 c0                	test   %eax,%eax
801066ef:	89 c6                	mov    %eax,%esi
801066f1:	74 55                	je     80106748 <setupkvm+0x68>
    return 0;
  memset(pgdir, 0, PGSIZE);
801066f3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801066fa:	00 
...
8010670b:	e8 20 dc ff ff       	call   80104330 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106710:	8b 53 0c             	mov    0xc(%ebx),%edx
80106713:	8b 43 04             	mov    0x4(%ebx),%eax
80106716:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106719:	89 54 24 04          	mov    %edx,0x4(%esp)
8010671d:	8b 13                	mov    (%ebx),%edx
8010671f:	89 04 24             	mov    %eax,(%esp)
80106722:	29 c1                	sub    %eax,%ecx
80106724:	89 f0                	mov    %esi,%eax
80106726:	e8 55 fd ff ff       	call   80106480 <mappages>
8010672b:	85 c0                	test   %eax,%eax
8010672d:	78 19                	js     80106748 <setupkvm+0x68>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010672f:	83 c3 10             	add    $0x10,%ebx
80106732:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106738:	72 d6                	jb     80106710 <setupkvm+0x30>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
...
8010674f:	5d                   	pop    %ebp
80106750:	c3                   	ret    
80106751:	eb 0d                	jmp    80106760 <kvmalloc>
80106753:	90                   	nop
80106754:	90                   	nop
80106755:	90                   	nop
80106756:	90                   	nop
...
80106763:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106766:	e8 75 ff ff ff       	call   801066e0 <setupkvm>
8010676b:	a3 24 55 11 80       	mov    %eax,0x80115524
...
{
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80106780:	a1 24 55 11 80       	mov    0x80115524,%eax
...
801067a4:	83 ec 14             	sub    $0x14,%esp
801067a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801067aa:	e8 b1 da ff ff       	call   80104260 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801067af:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801067b5:	b9 67 00 00 00       	mov    $0x67,%ecx
801067ba:	8d 50 08             	lea    0x8(%eax),%edx
801067bd:	66 89 88 a0 00 00 00 	mov    %cx,0xa0(%eax)
801067c4:	89 d1                	mov    %edx,%ecx
801067c6:	66 89 90 a2 00 00 00 	mov    %dx,0xa2(%eax)
801067cd:	c1 ea 18             	shr    $0x18,%edx
801067d0:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
801067d6:	ba 10 00 00 00       	mov    $0x10,%edx
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801067db:	c6 80 a6 00 00 00 40 	movb   $0x40,0xa6(%eax)
801067e2:	c1 e9 10             	shr    $0x10,%ecx
  cpu->gdt[SEG_TSS].s = 0;
801067e5:	c6 80 a5 00 00 00 89 	movb   $0x89,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
801067ec:	66 89 50 10          	mov    %dx,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
801067f0:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801067f7:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
...
801067fd:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106802:	8b 52 08             	mov    0x8(%edx),%edx
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
80106805:	66 89 48 6e          	mov    %cx,0x6e(%eax)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106809:	81 c2 00 10 00 00    	add    $0x1000,%edx
8010680f:	89 50 0c             	mov    %edx,0xc(%eax)
}
...
80106812:	b8 30 00 00 00       	mov    $0x30,%eax
80106817:	0f 00 d8             	ltr    %ax
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
  ltr(SEG_TSS << 3);
  if(p->pgdir == 0)
8010681a:	8b 43 04             	mov    0x4(%ebx),%eax
8010681d:	85 c0                	test   %eax,%eax
8010681f:	74 12                	je     80106833 <switchuvm+0x93>
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106826:	0f 22 d8             	mov    %eax,%cr3
  popcli();
}
80106829:	83 c4 14             	add    $0x14,%esp
8010682c:	5b                   	pop    %ebx
8010682d:	5d                   	pop    %ebp
  cpu->ts.iomb = (ushort) 0xFFFF;
  ltr(SEG_TSS << 3);
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010682e:	e9 5d da ff ff       	jmp    80104290 <popcli>
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
  ltr(SEG_TSS << 3);
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
80106833:	c7 04 24 4a 76 10 80 	movl   $0x8010764a,(%esp)
8010683a:	e8 21 9b ff ff       	call   80100360 <panic>
8010683f:	90                   	nop
...
8010685b:	77 54                	ja     801068b1 <inituvm+0x71>
  ...
  mem = kalloc();
8010685d:	e8 2e bc ff ff       	call   80102490 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106877:	e8 b4 da ff ff       	call   80104330 <memset>
...
80106896:	00 
80106897:	e8 e4 fb ff ff       	call   80106480 <mappages>
  memmove(mem, init, sz);
...
801068ab:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
801068ac:	e9 1f db ff ff       	jmp    801043d0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
801068b1:	c7 04 24 5e 76 10 80 	movl   $0x8010765e,(%esp)
...
80106903:	e8 e8 fa ff ff       	call   801063f0 <walkpgdir>
...
8010693d:	e8 fe af ff ff       	call   80101940 <readi>
...
80106961:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106962:	c7 04 24 78 76 10 80 	movl   $0x80107678,(%esp)
80106969:	e8 f2 99 ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
8010696e:	c7 04 24 1c 77 10 80 	movl   $0x8010771c,(%esp)
...
801069c3:	e8 68 d9 ff ff       	call   80104330 <memset>
...
801069e2:	00 
801069e3:	e8 98 fa ff ff       	call   80106480 <mappages>
...
801069f4:	76 2a                	jbe    80106a20 <allocuvm+0xa0>
    mem = kalloc();
801069f6:	e8 95 ba ff ff       	call   80102490 <kalloc>
    if(mem == 0){
...
801069ff:	75 af                	jne    801069b0 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106a01:	c7 04 24 96 76 10 80 	movl   $0x80107696,(%esp)
...
80106a2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106a30:	c7 04 24 ae 76 10 80 	movl   $0x801076ae,(%esp)
...
80106a49:	e8 b2 fa ff ff       	call   80106500 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106a51:	e8 8a b8 ff ff       	call   801022e0 <kfree>
      return 0;
...
80106a62:	e8 99 fa ff ff       	call   80106500 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106a80:	5d                   	pop    %ebp
80106a81:	e9 7a fa ff ff       	jmp    80106500 <deallocuvm.part.0>
...
80106aaa:	e8 51 fa ff ff       	call   80106500 <deallocuvm.part.0>
...
80106add:	e8 fe b7 ff ff       	call   801022e0 <kfree>
  uint i;
...
80106af2:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106af3:	e9 e8 b7 ff ff       	jmp    801022e0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106af8:	c7 04 24 ca 76 10 80 	movl   $0x801076ca,(%esp)
...
80106b2b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106b2c:	c7 04 24 db 76 10 80 	movl   $0x801076db,(%esp)
...
80106b46:	83 ec 2c             	sub    $0x2c,%esp
  ...
  if((d = setupkvm()) == 0)
80106b49:	e8 92 fb ff ff       	call   801066e0 <setupkvm>
...
80106b7d:	e8 4e d8 ff ff       	call   801043d0 <memmove>
...
80106bd5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106bdb:	e8 b0 b8 ff ff       	call   80102490 <kalloc>
...
80106bec:	e8 9f fe ff ff       	call   80106a90 <freevm>
  return 0;
...
80106c0d:	eb e4                	jmp    80106bf3 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    ...
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106c0f:	c7 04 24 ff 76 10 80 	movl   $0x801076ff,(%esp)
80106c16:	e8 45 97 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106c1b:	c7 04 24 e5 76 10 80 	movl   $0x801076e5,(%esp)
...
80106cac:	e8 1f d7 ff ff       	call   801043d0 <memmove>
    len -= n;
    buf += n;
